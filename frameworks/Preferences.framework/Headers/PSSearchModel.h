...
@property(nonatomic) BOOL showSectionInDetailText; // @synthesize showSectionInDetailText=_showSectionInDetailText;
@property(retain) PSSearchOperation *activeSearchOperation; // @synthesize activeSearchOperation=_activeSearchOperation;
@property(nonatomic) BOOL waitUntilFinished; // @synthesize waitUntilFinished=_waitUntilFinished;
