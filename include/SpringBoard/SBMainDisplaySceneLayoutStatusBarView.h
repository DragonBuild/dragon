...
- (void)_animateHidden:(BOOL)arg1 withAnimation:(long long)arg2 transitionHandler:(id /* CDUnknownBlockType */)arg3 applyHandler:(id /* CDUnknownBlockType */)arg4;
- (int)_effectiveStatusBarStyleOverridesToSuppress;
- (void)_enumerateValidStatusBarPartIdentifiersForSceneWithIdentifier:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
