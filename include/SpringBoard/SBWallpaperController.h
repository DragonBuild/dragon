...
- (void)wallpaperServer:(id)arg1 restoreDefaultWallpaperWithCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)wallpaperServer:(id)arg1 setWallpaperGradient:(id)arg2 forVariants:(long long)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)wallpaperServer:(id)arg1 setWallpaperColorName:(id)arg2 forVariants:(long long)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)wallpaperServer:(id)arg1 setWallpaperVideoWithWallpaperMode:(id)arg2 cropRect:(CGRect)arg3 wallpaperMode:(long long)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)wallpaperServer:(id)arg1 fetchThumbnailDataForVariant:(long long)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_reloadWallpaperAndFlushCaches:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_updateWallpaperForLocations:(long long)arg1 options:(NSUInteger)arg2 wallpaperMode:(long long)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)_updateWallpaperForLocations:(long long)arg1 options:(NSUInteger)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)setVariant:(long long)arg1 withOutAnimationFactory:(id)arg2 inAnimationFactory:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
