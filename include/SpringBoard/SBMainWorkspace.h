...
// - (void).cxx_destruct;
- (BOOL)presentTransientOverlayViewController:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (BOOL)dismissTransientOverlayViewController:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)systemService:(id)arg1 handleActions:(id)arg2 origin:(id)arg3 withResult:(id /* CDUnknownBlockType */)arg4;
- (void)systemService:(id)arg1 isPasscodeLockedOrBlockedWithResult:(id /* CDUnknownBlockType */)arg2;
- (void)_attemptUnlockToApplication:(id)arg1 showPasscode:(BOOL)arg2 origin:(id)arg3 givenOrigin:(id)arg4 options:(id)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)_handleUserActionRequest:(id)arg1 options:(id)arg2 activationSettings:(id)arg3 origin:(id)arg4 withResult:(id /* CDUnknownBlockType */)arg5;
- (void)_handleUntrustedOpenRequestForApplication:(id)arg1 options:(id)arg2 activationSettings:(id)arg3 origin:(id)arg4 withResult:(id /* CDUnknownBlockType */)arg5;
- (void)_handleTrustedOpenRequestForApplication:(id)arg1 options:(id)arg2 activationSettings:(id)arg3 origin:(id)arg4 withResult:(id /* CDUnknownBlockType */)arg5;
- (BOOL)_isApplicationRunningAsViewService:(id)arg1;
- (void)_handleOpenApplicationRequest:(id)arg1 options:(id)arg2 activationSettings:(id)arg3 origin:(id)arg4 withResult:(id /* CDUnknownBlockType */)arg5;
...
- (void)systemService:(id)arg1 handleOpenApplicationRequest:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)systemService:(id)arg1 canActivateApplication:(id)arg2 withResult:(id /* CDUnknownBlockType */)arg3;
...
- (void)_removeApplicationEntities:(id)arg1 withDestroyalIntent:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (id)_selectTransactionForAppActivationUnderMainScreenLock:(id)arg1 withResult:(id /* CDUnknownBlockType */)arg2;
- (id)_selectTransactionForReturningToTheLockScreenWithRequest:(id)arg1 fromApp:(id)arg2;
- (id)_selectTransactionForReturningToTheLockScreenFromApp:(id)arg1 animated:(BOOL)arg2 forceToBuddy:(BOOL)arg3 withResult:(id /* CDUnknownBlockType */)arg4;
- (id)_selectTransactionForTransientOverlayPresentationRequest:(id)arg1;
- (void)_addRequestCompletionBlock:(id /* CDUnknownBlockType */)arg1 toTransaction:(id)arg2;
- (BOOL)_setCurrentTransactionForRequest:(id)arg1 fallbackProvider:(id /* CDUnknownBlockType */)arg2;
...
- (void)dismissPowerDownTransientOverlayWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_dismissPresentedControlCenterModule:(id /* CDUnknownBlockType */)arg1;
- (void)presentModuleWithIdentifier:(id)arg1 options:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
