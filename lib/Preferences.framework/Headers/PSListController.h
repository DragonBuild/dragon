...
@interface PSListController : PSViewController <UIAppearance, UITableViewDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching, UIAlertViewDelegate, UIPopoverPresentationControllerDelegate, PSSpecifierObserver, PSViewControllerOffsetProtocol, PSURLControllerHandlerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _urlHandlingCompletion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ urlHandlingCompletion; // @synthesize urlHandlingCompletion=_urlHandlingCompletion;
...
- (void)_moveSpecifierAtIndex:(NSUInteger)arg1 toIndex:(NSUInteger)arg2 animated:(BOOL)arg3;
...
- (BOOL)_isEmptyGroup:(NSUInteger)arg1;
