...
@interface _PSKNNModel : NSObject
{
    ...
    NSUInteger __PSKnnTopKShares;
    NSUInteger __PSKnnMessagesZkwTopNFilter;
    NSUInteger __PSKnnModelRecencyMarginToPromoteShares;
    NSUInteger __PSKnnModelRecencyMarginToPromoteSharesMatchingBundleId;
    NSUInteger __PSKnnModelRecencyMarginToRetainShares;
}

@property(nonatomic) NSUInteger _PSKnnModelRecencyMarginToRetainShares; // @synthesize _PSKnnModelRecencyMarginToRetainShares=__PSKnnModelRecencyMarginToRetainShares;
@property(nonatomic) NSUInteger _PSKnnModelRecencyMarginToPromoteSharesMatchingBundleId; // @synthesize _PSKnnModelRecencyMarginToPromoteSharesMatchingBundleId=__PSKnnModelRecencyMarginToPromoteSharesMatchingBundleId;
@property(nonatomic) NSUInteger _PSKnnModelRecencyMarginToPromoteShares; // @synthesize _PSKnnModelRecencyMarginToPromoteShares=__PSKnnModelRecencyMarginToPromoteShares;
@property(nonatomic) NSUInteger _PSKnnMessagesZkwTopNFilter; // @synthesize _PSKnnMessagesZkwTopNFilter=__PSKnnMessagesZkwTopNFilter;
@property(nonatomic) NSUInteger _PSKnnTopKShares; // @synthesize _PSKnnTopKShares=__PSKnnTopKShares;
