...
- (void)_displayItemsForGenericMedicalRecord:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_displayItemsForObservation:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_displayItemsForRecord:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
