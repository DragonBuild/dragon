...
- (void)_displayItemsForUnknownRecord:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_displayItemsForPanel:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_displayItemsForObservation:(id)arg1 previous:(id)arg2 next:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (id)_displayItemsForGenericRecord:(id)arg1 previous:(id)arg2 next:(id)arg3;
- (void)_displayItemsForRecord:(id)arg1 previous:(id)arg2 next:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
