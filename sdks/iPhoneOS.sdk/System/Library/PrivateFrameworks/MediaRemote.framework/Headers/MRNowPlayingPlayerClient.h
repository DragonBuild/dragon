...
- (id)debugDescription;
- (id)description;
- (void)_handePlaybackSessionMigrateRequest:(id)arg1 request:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)flushPendingPlaybackSessionMigrateEvents:(id /* CDUnknownBlockType */)arg1;
