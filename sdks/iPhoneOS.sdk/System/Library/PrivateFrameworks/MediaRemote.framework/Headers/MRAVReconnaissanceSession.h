...
- (void)cancelSearch;
- (void)beginSearchWithTimeout:(double)arg1 endpointsCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)beginSearchWithTimeout:(double)arg1 completion:(id /* CDUnknownBlockType */)arg2;
