...
- (id)_authContext;
- (void)_resourceLoadDelegate:(id /* CDUnknownBlockType */)arg1;
...
- (id)_accountStore;
- (id)_account;
- (void)renewCredentialsWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)_urlEndpointForEventType:(id)arg1;
- (void)_urlForEventType:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)requestForContext:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)addPayload:(id)arg1 toRequest:(id)arg2;
- (void)addFresnoPayloadToRequest:(id)arg1 additionalPayload:(id)arg2;
- (void)pushTokenWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)addFresnoHeadersToRequest:(id)arg1;
- (void)addFresnoHeadersToRequest:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
