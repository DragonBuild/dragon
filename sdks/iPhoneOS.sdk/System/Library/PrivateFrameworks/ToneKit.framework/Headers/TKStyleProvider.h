...
- (id)_cachedResizableImageForPropertyWithSelector:(SEL)arg1 capInsets:(UIEdgeInsets)arg2 size:(CGSize)arg3 imageRenderingMode:(long long)arg4 withDrawingActions:(id /* CDUnknownBlockType */)arg5;
