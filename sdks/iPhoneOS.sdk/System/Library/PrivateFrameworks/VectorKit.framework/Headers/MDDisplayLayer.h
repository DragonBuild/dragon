...
- (void)drawToTexture:(struct Texture )arg1 withRenderQueue:(struct RenderQueue )arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)drawToTexture:(struct Texture )arg1 withRenderQueue:(struct RenderQueue )arg2;
- (struct RenderQueue )_renderQueueForTimestamp:(double)arg1 prepareHandler:(id /* CDUnknownBlockType */)arg2;
