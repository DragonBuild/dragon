...
- (void)animateCameraWithDuration:(float)arg1 fromFrame:(const CameraFrame_406dbd31 )arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)startWithPounce:(BOOL)arg1 startLocation:(CDStruct_c3b9c2ee)arg2 startCourse:(double)arg3 pounceCompletionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)dealloc;
