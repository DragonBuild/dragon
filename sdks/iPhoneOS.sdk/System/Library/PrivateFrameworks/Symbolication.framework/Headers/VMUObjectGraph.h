...
- (unsigned int)enumerateObjectsContainedInCollection:(unsigned int)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (unsigned int)nodeReferencedFromSourceNode:(unsigned int)arg1 byIvarWithName:(id)arg2;
- (unsigned int)enumerateReferencesOfNode:(unsigned int)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
...
- (unsigned int)enumerateObjectsOfGroupNode:(unsigned int)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
...
- (id)initWithNodeCount:(unsigned int)arg1 nodeProvider:(id /* CDUnknownBlockType */)arg2;
...
- (void)stronglyConnectedComponentSearch:(unsigned int)arg1 withRecorder:(id /* CDUnknownBlockType */)arg2;
