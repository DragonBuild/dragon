...
- (void)pairSetupSession:(id)arg1 didReceiveSetupCodeRequestWithCompletionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)controlOutputStream:(id)arg1 didReceiveRequestToSendControlPacket:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_sendProtocolInfoServiceExchangeData:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_sendData:(id)arg1 toCharacteristic:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_sendControlPacket:(id)arg1 forRequest:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (NSUInteger)_maximumControlWriteLengthForRequest:(id)arg1;
- (void)_reallySendRequest:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_sendPairingRequestData:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_handlePairingSetupCodeRequestWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_getPairingFeaturesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_checkForAuthPrompt:(BOOL)arg1;
- (void)startPairingWithConsentRequired:(BOOL)arg1 config:(id)arg2 ownershipToken:(id)arg3;
- (void)_enableBroadcastEvent:(BOOL)arg1 interval:(NSUInteger)arg2 forCharacteristic:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_configureCharacteristics:(id)arg1 queue:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)configureCharacteristics:(id)arg1 queue:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_configureBroadcastKeyGeneration:(unsigned char)arg1 service:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_generateBroadcastKey:(unsigned char)arg1 queue:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_enableEvent:(BOOL)arg1 toCharacteristic:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_performEnableEvent:(BOOL)arg1 toCharacteristic:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_performTimedWriteExecuteForCharacteristic:(id)arg1 value:(id)arg2 options:(long long)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_performTimedWritePrepareWithValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_performTimedWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_performWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_writeValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)_readValueForCharacteristic:(id)arg1 options:(long long)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_readCharacteristicValues:(id)arg1 queue:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_discoverWithType:(long long)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
