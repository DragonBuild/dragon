...
- (void)removePairingForCurrentControllerWithCompletionQueue:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)writeCharacteristicValue:(id)arg1 timeout:(double)arg2 completionQueue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)readValueForCharacteristic:(id)arg1 timeout:(double)arg2 completionQueue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_verifyServiceSignature:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_verifyCharacteristicSignature:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)verify;
