...
+ (id /* CDUnknownBlockType */)contentPropertySubstitutor;
...
+ (id)itemFromSerializedItem:(id)arg1 withItemClass:(Class)arg2 forType:(id)arg3 nameIfKnown:(id)arg4 sourceName:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
+ (void)getContentItemFromSerializedItem:(id)arg1 sourceName:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)forceCoerceToItemClasses:(id)arg1 options:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)generateSubItemsForItemClasses:(id)arg1 options:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)generateFirstLevelSubItemsForItemClass:(Class)arg1 options:(id)arg2 error:(id )arg3;
- (void)generateFirstLevelSubItemsForItemClass:(Class)arg1 options:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)generateRepresentationsForType:(id)arg1 options:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)getRepresentationsForType:(id)arg1 options:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)dealloc;
...
- (void)coerceToItemClasses:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)coerceToItemClass:(Class)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
