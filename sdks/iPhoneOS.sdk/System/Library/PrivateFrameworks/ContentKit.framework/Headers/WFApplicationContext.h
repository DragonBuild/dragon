...
- (void)openURL:(id)arg1 withBundleIdentifier:(id)arg2 userInterface:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)openURL:(id)arg1 userInterface:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
