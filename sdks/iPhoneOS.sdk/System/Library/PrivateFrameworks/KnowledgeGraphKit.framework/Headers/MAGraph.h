...
// - (void).cxx_destruct;
- (void)waitUntilQuiescentUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)readUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)writeUsingBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)enumerateEdgesInDomain:(unsigned short)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateEdgesWithLabel:(id)arg1 domain:(unsigned short)arg2 properties:(id)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)enumerateNodesInDomain:(unsigned short)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateNodesWithLabel:(id)arg1 domain:(unsigned short)arg2 properties:(id)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)savePersistentStoreWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (id)databaseURL;
- (id)initWithPersistentStoreURL:(id)arg1 options:(long long)arg2 cacheMode:(long long)arg3 progressBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)breadthFirstSearchFromNode:(id)arg1 directed:(BOOL)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
- (void)depthFirstSearchFromNode:(id)arg1 directed:(BOOL)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
