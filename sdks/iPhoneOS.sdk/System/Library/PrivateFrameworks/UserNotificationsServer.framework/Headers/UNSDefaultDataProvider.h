...
- (void)_handleBulletinActionResponse:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)handleBulletinActionResponse:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
