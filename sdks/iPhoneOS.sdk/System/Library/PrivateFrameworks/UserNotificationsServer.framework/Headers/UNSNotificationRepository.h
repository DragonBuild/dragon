...
- (void)_queue_setBadgeValue:(id)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_queue_setBadgeString:(id)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_queue_setBadgeNumber:(id)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_queue_removeNotificationRecordsPassingTest:(id /* CDUnknownBlockType */)arg1 forBundleIdentifier:(id)arg2;
...
- (void)removeNotificationRecordsPassingTest:(id /* CDUnknownBlockType */)arg1 forBundleIdentifier:(id)arg2;
...
- (void)saveNotificationRecord:(id)arg1 shouldRepost:(BOOL)arg2 forBundleIdentifier:(id)arg3 withCompletionHandler:(id /* CDUnknownBlockType */)arg4;
