...
- (void)service:(id)arg1 didSwitchActivePairedDevice:(id)arg2 acknowledgementBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)_handleIncomingStreamDataWithIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_handleProtobuf:(id)arg1 ofType:(unsigned short)arg2 identifier:(id)arg3 isResponse:(BOOL)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (void)_consumeRemainingStreamDataWithIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)_shouldTreatAsSessionEnd:(id)arg1;
- (void)_recordLastSeqNo:(id)arg1;
- (void)_readNextProtobuf:(id /* CDUnknownBlockType */)arg1;
...
- (void)_reallyHandleSessionRestart:(id)arg1 priority:(long long)arg2 options:(id)arg3 userContext:(id)arg4 callback:(id /* CDUnknownBlockType */)arg5;
- (void)_handleSessionRestart:(id)arg1 priority:(long long)arg2 options:(id)arg3 userContext:(id)arg4 callback:(id /* CDUnknownBlockType */)arg5;
...
- (void)_enqueueSingleMessage:(id)arg1 withMessageID:(unsigned short)arg2 priority:(long long)arg3 options:(id)arg4 userContext:(id)arg5 callback:(id /* CDUnknownBlockType */)arg6;
