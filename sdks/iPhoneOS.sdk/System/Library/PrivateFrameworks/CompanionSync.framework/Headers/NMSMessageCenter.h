...
- (void)addResponseHandler:(unsigned short)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)addErrorHandlerForMessageID:(unsigned short)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)addRequestHandlerForMessageID:(unsigned short)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
