...
- (void)jobConstraintsObserver:(id)arg1 constraintsDidChange:(id)arg2 mask:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (id)_inq_runningJobs;
- (void)_dispatchTransactionAsyncWithName:(const char )arg1 block:(id /* CDUnknownBlockType */)arg2;
