...
- (id)generateSuggestionsWithProfile:(unsigned char)arg1 options:(id)arg2 progress:(id /* CDUnknownBlockType */)arg3;
- (id)generateSharingSuggestionsWithOptions:(id)arg1 progress:(id /* CDUnknownBlockType */)arg2;
- (id)generateSingleAssetSuggestionsWithOptions:(id)arg1 progress:(id /* CDUnknownBlockType */)arg2;
