...
- (void)_configureGraphManagerWithProgressBlock:(id /* CDUnknownBlockType */)arg1;
- (void)suspendGraphUpdateAndPerformBlock:(id /* CDUnknownBlockType */)arg1;
- (void)unloadGraph;
- (void)_performRebuildFullRebuild:(BOOL)arg1 withProgressBlock:(id /* CDUnknownBlockType */)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)performLightWeightRebuildWithProgressBlock:(id /* CDUnknownBlockType */)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)performFullRebuildWithProgressBlock:(id /* CDUnknownBlockType */)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (id)loadGraphWithProgressBlock:(id /* CDUnknownBlockType */)arg1;
- (void)multicasterHasNoReceivers:(id)arg1 invalidateBlock:(id /* CDUnknownBlockType */)arg2;
- (void)unregisterGraphClient:(id)arg1;
- (id)registerGraphClient:(id)arg1 progressBlock:(id /* CDUnknownBlockType */)arg2;
