...
- (void)setJobProcessingConstraintsWithValues:(id)arg1 mask:(id)arg2 context:(id)arg3 reply:(id /* CDUnknownBlockType */)arg4;
- (void)scheduleAssetForOnDemandAnalysisWithUUID:(id)arg1 workerType:(short)arg2 workerFlags:(int)arg3 context:(id)arg4 reply:(id /* CDUnknownBlockType */)arg5;
...
- (void)runCurationWithItems:(id)arg1 options:(id)arg2 context:(id)arg3 reply:(id /* CDUnknownBlockType */)arg4;
...
- (void)requestSearchableAssetUUIDsBySocialGroupForAssetCollectionUUIDs:(id)arg1 ofType:(NSUInteger)arg2 isFullAnalysis:(BOOL)arg3 withOptions:(id)arg4 context:(id)arg5 reply:(id /* CDUnknownBlockType */)arg6;
- (void)requestAssetSearchKeywordsForAssetCollectionUUIDs:(id)arg1 ofType:(NSUInteger)arg2 withOptions:(id)arg3 context:(id)arg4 reply:(id /* CDUnknownBlockType */)arg5;
- (void)requestSearchIndexKeywordsForAssetCollectionUUIDs:(id)arg1 ofType:(NSUInteger)arg2 withOptions:(id)arg3 context:(id)arg4 reply:(id /* CDUnknownBlockType */)arg5;
- (void)requestLocalizedSceneAncestryInformationWithContext:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)requestGraphSearchMetadataWithOptions:(id)arg1 context:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
- (void)requestSynonymsDictionariesWithContext:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)requestZeroKeywordsWithOptions:(id)arg1 context:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
...
- (void)generateQuestionsWithOptions:(id)arg1 context:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
- (void)generateSuggestionsWithOptions:(id)arg1 context:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
...
- (void)requestAssetCollectionsRelatedToAssetWithLocalIdentifier:(id)arg1 options:(id)arg2 context:(id)arg3 reply:(id /* CDUnknownBlockType */)arg4;
...
- (void)cancelOperationsWithIdentifiers:(id)arg1 context:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
- (void)writeQALog:(id)arg1;
- (void)dumpAnalysisStatusWithContext:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)unloadGraphWithContext:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)loadGraphWithContext:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
