...
+ (void)cumulativeNormalDistributionWithData:(id)arg1 sigmaFactor:(double)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
+ (void)probabilityDensityNormalDistributionWithData:(id)arg1 sigmaFactor:(double)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
...
- (id)_graphOrderedPersonsWithPersons:(id)arg1 withAllPersons:(id)arg2 updateBlock:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_updateSuggestedMeIdentifierWithPersons:(id)arg1 updateBlock:(id /* CDUnknownBlockType */)arg2;
- (BOOL)_promoteInterestingPersons:(id)arg1 updateBlock:(id /* CDUnknownBlockType */)arg2;
- (id)_interestingPersonsFromVerifiedPersons:(id)arg1 unverifiedPersons:(id)arg2 updateBlock:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_personClusterShouldBeVerified:(id)arg1;
- (id)_sortedUnverifiedPersonsToDedupForVerifiedPersons:(id)arg1 updateBlock:(id /* CDUnknownBlockType */)arg2;
- (id)_verifiedPersonsToProcess;
- (id)_newPersonDeduperWithVerifiedPersons:(id)arg1;
- (id)interestingPersonsFromPersons:(id)arg1 updateBlock:(id /* CDUnknownBlockType */)arg2;
- (double)_personTimespan:(id)arg1;
- (id)advancedStatus;
- (BOOL)promoteUnverifiedPersonsWithUpdateBlock:(id /* CDUnknownBlockType */)arg1;
