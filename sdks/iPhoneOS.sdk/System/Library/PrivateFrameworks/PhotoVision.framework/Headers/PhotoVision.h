...
+ (void)setAlgorithmRevisionForRequest:(id)arg1 algorithmUmbrellaVersion:(unsigned int)arg2 algorithmCollectionType:(NSUInteger)arg3;
+ (NSUInteger)faceprintAnalysisOptionsForFaceAlgorithmUmbrellaVersion:(unsigned int)arg1;
+ (NSUInteger)defaultFaceAnalysisOptionsForFaceAlgorithmUmbrellaVersion:(unsigned int)arg1;
...
- (id)requestSuggestionsForFaceClusterSequenceNumbers:(id)arg1 withClusteringFlags:(id)arg2 updateHandler:(id /* CDUnknownBlockType */)arg3 error:(id )arg4;
- (id)clusteringStatus;
- (void)cancelFaceClustering;
- (void)performFaceClusteringWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)stop;
- (void)startAndSyncClusterCacheWithLibrary:(BOOL)arg1 reply:(id /* CDUnknownBlockType */)arg2;
...
- (BOOL)buildPersonsWithCanceler:(id)arg1 keyFaceUpdateBlock:(id /* CDUnknownBlockType */)arg2 extendTimeoutBlock:(id /* CDUnknownBlockType */)arg3 error:(id )arg4;
- (id)context;
- (void)resetClusterer;
