...
- (float)distanceBetweenPerson:(id)arg1 andPerson:(id)arg2 useCommonMoments:(BOOL)arg3 minAgeType:(unsigned short )arg4 updateBlock:(id /* CDUnknownBlockType */)arg5 error:(id )arg6;
- (float)distanceWithOverlapCheckBetweenPerson:(id)arg1 andPerson:(id)arg2 useCommonMoments:(BOOL)arg3 minAgeType:(unsigned short )arg4 updateBlock:(id /* CDUnknownBlockType */)arg5 error:(id )arg6;
