...
- (BOOL)addPotentialMergeCandidateForPerson:(id)arg1 withOtherPerson:(id)arg2 updateBlock:(id /* CDUnknownBlockType */)arg3;
- (id)mergeCandidatePersonsWithUpdateBlock:(id /* CDUnknownBlockType */)arg1;
- (id)_resolveMergeCandidate:(id)arg1 forPerson:(id)arg2;
- (BOOL)shouldStopWithUpdateBlock:(id /* CDUnknownBlockType */)arg1;
