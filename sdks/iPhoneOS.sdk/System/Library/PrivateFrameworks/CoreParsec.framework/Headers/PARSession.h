...
- (void)sendCustomFeedback:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (BOOL)loadMoreResults:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (id)taskWithRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)awaitBag;
