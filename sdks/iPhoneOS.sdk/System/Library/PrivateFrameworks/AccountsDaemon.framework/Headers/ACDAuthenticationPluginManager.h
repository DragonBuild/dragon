...
- (void)discoverPropertiesForAccount:(id)arg1 accountStore:(id)arg2 options:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)renewCredentialsForAccount:(id)arg1 accountStore:(id)arg2 options:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)verifyCredentialsForAccount:(id)arg1 accountStore:(id)arg2 options:(id)arg3 handler:(id /* CDUnknownBlockType */)arg4;
- (void)credentialForAccount:(id)arg1 client:(id)arg2 store:(id)arg3 handler:(id /* CDUnknownBlockType */)arg4;
