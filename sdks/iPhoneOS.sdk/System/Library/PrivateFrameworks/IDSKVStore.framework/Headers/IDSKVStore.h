...
// - (void).cxx_destruct;
- (void)_onIvarQueue_performBlock:(id /* CDUnknownBlockType */)arg1 initializeStore:(BOOL)arg2 waitUntilDone:(BOOL)arg3;
- (void)_onIvarQueue_performBlock:(id /* CDUnknownBlockType */)arg1 initializeStore:(BOOL)arg2;
- (void)deleteDatabase;
...
- (id)datasUpToLimit:(NSUInteger)arg1 deleteContext:(id )arg2 error:(id )arg3;
...
- (void)_onIvarQueue_deleteUpToRowID:(NSUInteger)arg1 valueType:(BOOL)arg2;
- (id)_onIvarQueue_serializedValuesUpToLimit:(NSUInteger)arg1 valueType:(BOOL)arg2 deleteContext:(id )arg3;
