...
- (void)enumerateMemoryEntitiesWithProperties:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateMemoryEntitiesUsingBlock:(id /* CDUnknownBlockType */)arg1;
