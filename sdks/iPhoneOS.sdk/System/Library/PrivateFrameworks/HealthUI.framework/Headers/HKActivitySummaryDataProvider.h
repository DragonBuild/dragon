...
- (void)_hourActivitySummariesForDateRange:(id)arg1 pageHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_monthActivitySummariesForCachedData:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (id)_queriesForTimeScope:(long long)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (id)_fetchOperationForTimeScope:(long long)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
