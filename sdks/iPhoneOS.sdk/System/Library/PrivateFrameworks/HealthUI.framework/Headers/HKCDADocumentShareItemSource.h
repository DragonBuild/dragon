...
// - (void).cxx_destruct;
- (id)item;
- (void)_loadShareDataWithHealthStore:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_generatePDFforCDA:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_buildZipArchiveWithCDA:(id)arg1 generatedPDF:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
