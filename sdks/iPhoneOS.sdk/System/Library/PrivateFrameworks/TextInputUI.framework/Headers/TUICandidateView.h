...
- (void)setState:(id)arg1 animated:(BOOL)arg2 force:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)setState:(id)arg1 animated:(BOOL)arg2 animator:(id)arg3 options:(NSUInteger)arg4 force:(BOOL)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (void)setState:(id)arg1 animated:(BOOL)arg2 options:(NSUInteger)arg3 force:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)finalizeLayoutChange;
- (void)updatePrimaryGridRowTypeWithOptions:(NSUInteger)arg1 animated:(BOOL)arg2 animator:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
