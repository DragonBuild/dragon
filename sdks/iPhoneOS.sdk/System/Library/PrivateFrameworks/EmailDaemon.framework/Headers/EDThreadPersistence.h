...
// - (void).cxx_destruct;
- (BOOL)threadScopeManager:(id)arg1 evictThreadScopesWithDatabaseIDs:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)threadScopeManager:(id)arg1 gatherStatisticsForThreadScopes:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
- (void)threadScopeManager:(id)arg1 populateThreadScopesWithBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)_iterateWrappedMessagesByConversationForPersistedMessages:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)_iterateWrappedMessagesByConversationForPersistedMessages:(id)arg1 writeBlock:(id /* CDUnknownBlockType */)arg2;
...
- (id /* CDUnknownBlockType */)threadScopeMatcherForActivatedAccount:(id)arg1;
...
- (BOOL)_enumerateThreadObjectIDsForThreadScope:(id)arg1 filterClause:(id)arg2 sortDescriptors:(id)arg3 batchBlock:(id /* CDUnknownBlockType */)arg4;
- (void)threadObjectIDsForThreadScope:(id)arg1 sortDescriptors:(id)arg2 initialBatchSize:(NSUInteger)arg3 journaledObjectIDs:(id)arg4 batchBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)_enumerateThreadScopesUsingBlock:(id /* CDUnknownBlockType */)arg1;
