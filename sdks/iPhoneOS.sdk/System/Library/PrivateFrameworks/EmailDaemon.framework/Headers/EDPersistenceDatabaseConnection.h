...
- (BOOL)performUsingTransaction:(BOOL)arg1 isWriter:(BOOL)arg2 transactionError:(id )arg3 block:(id /* CDUnknownBlockType */)arg4;
...
- (BOOL)_executePreparedStatement:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2 description:(id)arg3 error:(id )arg4;
...
- (BOOL)executeSelectStatement:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2 error:(id )arg3;
