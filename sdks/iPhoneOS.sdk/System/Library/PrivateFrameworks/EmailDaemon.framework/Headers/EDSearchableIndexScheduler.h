...
- (void)_registerActivityForType:(id)arg1 builder:(id /* CDUnknownBlockType */)arg2 runner:(id /* CDUnknownBlockType */)arg3;
- (void)_startScheduling;
- (id /* CDUnknownBlockType */)_xpcCriteriaBuilderBlockForActivityType:(id)arg1;
