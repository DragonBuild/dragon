...
- (void)predictMailboxForMovingMessages:(id)arg1 withObserver:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)getCachedMetadataJSONForKey:(id)arg1 messageID:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)performMessageChangeAction:(id)arg1 requestID:(NSUInteger)arg2 returnUndoAction:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)messageListItemsForObjectIDs:(id)arg1 requestID:(NSUInteger)arg2 observationIdentifier:(id)arg3 loadSummaryForAdditionalObjectIDs:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_enumerateThreadsByThreadObjectIDsByScope:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (id)_partitionObjectIDs:(id)arg1;
- (void)cancelAllHandlers;
- (void)startCountingQuery:(id)arg1 includingServerCountsForMailboxScope:(id)arg2 withObserver:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_triggerMigrationWithThreadScopesMatcher:(id /* CDUnknownBlockType */)arg1;
...
- (void)_performQuery:(id)arg1 withObserver:(id)arg2 observationIdentifier:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)performQuery:(id)arg1 withObserver:(id)arg2 observationIdentifier:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
