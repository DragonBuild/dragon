...
+ (void)processAccountChangesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
// - (void).cxx_destruct;
- (id)asyncDaemonWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)synchronizationWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
