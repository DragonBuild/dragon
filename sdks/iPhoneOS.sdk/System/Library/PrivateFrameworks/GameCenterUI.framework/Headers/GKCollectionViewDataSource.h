...
- (void)notifyBatchUpdate:(id /* CDUnknownBlockType */)arg1 complete:(id /* CDUnknownBlockType */)arg2;
- (void)notifyBatchUpdate:(id /* CDUnknownBlockType */)arg1;
...
- (void)updateSupplementaryMetricsForKey:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)enumerateItemsAndIndexPathsUsingBlock:(id /* CDUnknownBlockType */)arg1;
