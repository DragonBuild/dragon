...
- (void)enumerateSectionsIndexesOverlappingYOffset:(double)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (void)finalizeGlobalPresentationDataWithSectionRange:(_NSRange)arg1;
