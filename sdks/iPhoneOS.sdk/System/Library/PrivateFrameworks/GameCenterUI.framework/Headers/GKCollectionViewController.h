...
- (void)showPlaceholderWithTitle:(id)arg1 message:(id)arg2 buttonTitle:(id)arg3 animated:(BOOL)arg4 block:(id /* CDUnknownBlockType */)arg5;
- (void)addPlaceholderViewToView:(id)arg1;
- (void)slideInContents;
- (void)completeWhenReadyToDisplayData:(id /* CDUnknownBlockType */)arg1;
...
- (void)dataSource:(id)arg1 performBatchUpdate:(id /* CDUnknownBlockType */)arg2 complete:(id /* CDUnknownBlockType */)arg3;
...
- (void)_loadDataWithCompletionHandlerAndError:(id /* CDUnknownBlockType */)arg1;
- (void)refreshContentsForDataType:(unsigned int)arg1 userInfo:(id)arg2 updateNotifier:(id)arg3;
- (void)_applyUpdates:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_finishUpdates:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
