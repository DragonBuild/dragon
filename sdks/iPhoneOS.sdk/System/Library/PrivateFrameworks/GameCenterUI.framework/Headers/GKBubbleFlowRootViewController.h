...
- (void)showInterstitialViewAnimated:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_updateViewAlpha:(double)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
