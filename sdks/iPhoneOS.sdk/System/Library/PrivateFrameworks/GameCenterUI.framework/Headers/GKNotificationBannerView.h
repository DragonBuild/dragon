...
// - (void).cxx_destruct;
- (void)fadeOutQuickly:(BOOL)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fadeInWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)callCompletionHandler;
- (void)_wasTouched:(id)arg1;
- (void)hideBanner;
- (void)showWithTouchHandler:(id /* CDUnknownBlockType */)arg1;
- (void)showWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)showPlayerAvatarAnimationWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)layoutSubviews;
- (void)dealloc;
