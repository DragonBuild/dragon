...
- (void)askForUserSpecificationOfMissingRouteWithRoutePicker:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)findInvokingHomePodEndpointWithRoutePicker:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (id)localEndpoint;
