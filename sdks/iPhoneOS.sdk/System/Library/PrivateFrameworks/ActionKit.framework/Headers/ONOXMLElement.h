...
- (void)enumerateElementsWithCSS:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateElementsWithCSS:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (id)CSS:(id)arg1;
- (id)firstChildWithXPath:(id)arg1;
- (void)enumerateElementsWithXPath:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateElementsWithXPath:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (id)indexesOfChildrenPassingTest:(id /* CDUnknownBlockType */)arg1;
