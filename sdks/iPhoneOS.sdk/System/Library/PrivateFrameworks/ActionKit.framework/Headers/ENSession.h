...
- (void)downloadThumbnailForNote:(id)arg1 maxDimension:(NSUInteger)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)downloadNote:(id)arg1 progress:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)findNotesWithSearch:(id)arg1 inNotebook:(id)arg2 orScope:(NSUInteger)arg3 sortOrder:(NSUInteger)arg4 maxResults:(NSUInteger)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (void)deleteNote:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)shareNote:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)uploadNote:(id)arg1 policy:(long long)arg2 toNotebook:(id)arg3 orReplaceNote:(id)arg4 progress:(id /* CDUnknownBlockType */)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (void)uploadNote:(id)arg1 notebook:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)listWritableNotebooksWithCompletion:(id /* CDUnknownBlockType */)arg1;
