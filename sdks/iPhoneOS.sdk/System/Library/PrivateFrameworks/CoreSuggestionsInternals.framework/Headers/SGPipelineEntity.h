...
@interface SGPipelineEntity : SGEntity
{
    ...
    _NSRange _plainTextSigRange;
}

+ (id)socialProfile:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(BOOL)arg4 context:(id)arg5 contextRangeOfInterest:(_NSRange)arg6 extractionInfo:(id)arg7;
+ (id)instantMessageAddress:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(BOOL)arg4 context:(id)arg5 contextRangeOfInterest:(_NSRange)arg6 extractionInfo:(id)arg7;
+ (id)birthday:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(BOOL)arg4 context:(id)arg5 contextRangeOfInterest:(_NSRange)arg6 extractionInfo:(id)arg7;
+ (id)emailAddress:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(BOOL)arg4 context:(id)arg5 contextRangeOfInterest:(_NSRange)arg6 extractionInfo:(id)arg7;
+ (id)phoneNumber:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(BOOL)arg4 context:(id)arg5 contextRangeOfInterest:(_NSRange)arg6 extractionInfo:(id)arg7;
+ (id)address:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(BOOL)arg4 context:(id)arg5 contextRangeOfInterest:(_NSRange)arg6 extractionInfo:(id)arg7;
...
@property(nonatomic) _NSRange plainTextSigRange; // @synthesize plainTextSigRange=_plainTextSigRange;
...
// - (void).cxx_destruct;
- (void)runWithDissectorLock:(id /* CDUnknownBlockType */)arg1;
...
- (void)enumeratePlainTextLines:(id /* CDUnknownBlockType */)arg1;
- (void)setPlainTextLines:(id)arg1 utf8Offsets:(id)arg2 isAscii:(BOOL)arg3;
- (void)enumeratePeople:(id /* CDUnknownBlockType */)arg1;
- (BOOL)isPerson;
- (BOOL)isEvent;
...
- (void)addDetectedSocialProfile:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(_NSRange)arg4 extractionInfo:(id)arg5;
- (void)addSocialProfileEnrichment:(id)arg1;
- (void)addDetectedInstantMessageAddress:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(_NSRange)arg4 extractionInfo:(id)arg5;
- (void)addInstantMessageAddressEnrichment:(id)arg1;
- (void)addCuratedBirthday:(id)arg1;
- (void)addDetectedBirthday:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(_NSRange)arg4 extractionInfo:(id)arg5;
- (void)addUnrecognizedLookupEmailAddress:(id)arg1;
- (void)addCuratedEmailAddress:(id)arg1;
- (void)addDetectedEmailAddress:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(_NSRange)arg4 extractionInfo:(id)arg5;
...
- (void)addDetectedPhoneNumber:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(_NSRange)arg4 extractionInfo:(id)arg5;
- (void)addCuratedPostalAddress:(id)arg1;
- (void)addDetectedPostalAddress:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(_NSRange)arg4 extractionInfo:(id)arg5;
...
- (void)dealloc;
- (id)initWithContactDetailWithKey:(id)arg1 type:(NSUInteger)arg2 extractionInfo:(id)arg3 curated:(BOOL)arg4 parent:(id)arg5 value:(id)arg6 context:(id)arg7 contextRangeOfInterest:(_NSRange)arg8;
