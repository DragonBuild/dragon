...
+ (id)withFullNameMapping:(id)arg1 firstNameMapping:(id)arg2 lastNameMapping:(id)arg3 minimumConfidence:(int)arg4 confidenceMapper:(id /* CDUnknownBlockType */)arg5 tokenToIgnore:(id)arg6 andPossessive:(id)arg7;
...
- (id)initWithNameMappings:(id)arg1 minimumConfidence:(int)arg2 confidenceMapper:(id /* CDUnknownBlockType */)arg3 tokenToIgnore:(id)arg4;
