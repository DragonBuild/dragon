...
- (void)addSessionForTrainingWithSource:(id)arg1 label:(long long)arg2 language:(id)arg3 objective:(NSUInteger)arg4 spotlightRef:(id)arg5 embeddedFeaturizer:(id /* CDUnknownBlockType */)arg6;
- (id)init;
