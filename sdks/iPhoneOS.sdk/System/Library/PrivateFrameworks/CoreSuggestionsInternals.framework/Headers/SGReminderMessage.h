...
+ (BOOL)validObjectCoreIndexRange:(_NSRange)arg1 enrichedTaggedCharacterRanges:(id)arg2;
+ (BOOL)validActionVerbIndexRange:(_NSRange)arg1 enrichedTaggedCharacterRanges:(id)arg2;
