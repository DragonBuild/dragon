...
- (BOOL)drainHarvestQueue:(id)arg1 highPriorityOnly:(BOOL)arg2 continuingWhile:(id /* CDUnknownBlockType */)arg3;
...
- (void)_performHarvestActivity:(id)arg1 callback:(id /* CDUnknownBlockType */)arg2;
