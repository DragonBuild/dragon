...
- (id)debugDescription;
- (BOOL)isEqual:(id)arg1 forKeys:(id)arg2 comparisonBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)modifyAdjustmentWithKey:(id)arg1 modificationBlock:(id /* CDUnknownBlockType */)arg2;
