...
+ (id)_logSettingsWithFormatter:(id /* CDUnknownBlockType */)arg1;
...
- (void)updateHome;
- (void)warmup;
- (void)dispatchNetworkRouterObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchNetworkConfigurationObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchHomeKitSettingsObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchTelevisionObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchUserObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchSymptomsHandlerMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchSoftwareUpdateMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchSoftwareUpdateControllerMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchSymptomFixSessionObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchHomeKitSettingMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchMediaObjectObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchAudioControlObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchMediaSessionObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchCameraObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchAccessoryObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchHomeObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
- (void)dispatchHomeManagerObserverMessage:(id /* CDUnknownBlockType */)arg1 sender:(id)arg2;
