...
// - (void).cxx_destruct;
- (void)enumerateMovesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateChangesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateDeletesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateInsertsUsingBlock:(id /* CDUnknownBlockType */)arg1;
