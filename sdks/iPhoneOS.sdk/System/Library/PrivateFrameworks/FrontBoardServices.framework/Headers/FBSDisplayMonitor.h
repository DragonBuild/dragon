...
// - (void).cxx_destruct;
- (void)_lock_enumerateConnectedWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_lock_enumerateSourcesWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)_sortedSources;
...
- (void)dealloc;
- (id)initWithInitializationCompletion:(id /* CDUnknownBlockType */)arg1;
