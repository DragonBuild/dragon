...
- (void)_notifyForType:(long long)arg1 synchronously:(BOOL)arg2 withCastingBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)_executeOrPendInstallSynchronizationBlock:(id /* CDUnknownBlockType */)arg1;
- (void)synchronize:(id /* CDUnknownBlockType */)arg1;
...
- (id)observeDidChangeNetworkUsageWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)observeDidDemoteApplicationsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)observeDidRemoveApplicationsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)observeDidUpdateApplicationsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)observeDidReplaceApplicationsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)observeDidAddApplicationsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)observeDidCancelPlaceholdersWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)observeDidAddPlaceholdersWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)removeObserverForToken:(id)arg1;
@property(readonly, copy) NSString *description;
- (void)uninstallApplication:(id)arg1 withOptions:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)uninstallApplication:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)placeholderWithBundleIdentifier:(id)arg1;
- (id)allPlaceholders;
- (void)installedApplicationWithBundleIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
