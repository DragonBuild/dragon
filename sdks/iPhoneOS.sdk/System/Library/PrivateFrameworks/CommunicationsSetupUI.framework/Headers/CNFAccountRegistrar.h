...
- (void)registerAccountWithUsername:(id)arg1 password:(id)arg2 service:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)continueRegistrationForAccount:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
