...
- (void)dispatchMessageExcludingSender:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)registerCustomLogSettings:(id)arg1 forSelector:(SEL)arg2 argumentIndex:(NSUInteger)arg3;
- (void)registerCustomHandlerForSelector:(SEL)arg1 handler:(id /* CDUnknownBlockType */)arg2;
