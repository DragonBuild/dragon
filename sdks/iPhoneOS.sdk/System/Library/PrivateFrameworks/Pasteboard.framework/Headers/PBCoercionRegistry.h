...
- (void)loadRepresentationOfObject:(id)arg1 asType:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)registerCoercionFromObjectOfClass:(Class)arg1 toObjectOfClass:(Class)arg2 coercionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_member_registerCoercionFromObjectOfClass:(Class)arg1 toObjectOfClass:(Class)arg2 coercionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)registerCoercionFromRepresentationConformingToType:(id)arg1 toObjectOfClass:(Class)arg2 coercionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_member_registerCoercionFromRepresentationConformingToType:(id)arg1 toObjectOfClass:(Class)arg2 coercionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)registerCoercionFromObjectOfClass:(Class)arg1 toRepresentationOfType:(id)arg2 coercionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_member_registerCoercionFromObjectOfClass:(Class)arg1 toRepresentationOfType:(id)arg2 coercionBlock:(id /* CDUnknownBlockType */)arg3;
- (id)init;
