...
+ (id)candidatePairWithLocalCandidate:(id)arg1 remoteCandidate:(id)arg2 sessionID:(id)arg3 delegate:(id)arg4 sendMsgBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)startSessionGoAwayTimer:(int)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)_handleSessionGoAwayTimer;
- (void)stopSessionConvergenceTimer;
- (void)startSessionConvergenceTimer:(int)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)_handleSessionConvergenceTimer;
- (void)stopSessionConnectedTimer;
- (void)startSessionConnectedTimer:(int)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (void)invalidate;
- (void)dealloc;
- (id)initWithLocalCandidate:(id)arg1 remoteCandidate:(id)arg2 sessionID:(id)arg3 delegate:(id)arg4 sendMsgBlock:(id /* CDUnknownBlockType */)arg5;
