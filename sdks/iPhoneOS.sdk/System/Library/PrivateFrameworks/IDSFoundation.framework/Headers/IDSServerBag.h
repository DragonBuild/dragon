...
- (void)dealloc;
- (id)_initWithURL:(id)arg1 apsEnvironmentName:(id)arg2 allowSelfSignedCertificates:(BOOL)arg3 allowUnsignedBags:(BOOL)arg4 hashAlgorithm:(BOOL)arg5 remoteURLCreationBlock:(id /* CDUnknownBlockType */)arg6 connectionMonitorCreationBlock:(id /* CDUnknownBlockType */)arg7;
