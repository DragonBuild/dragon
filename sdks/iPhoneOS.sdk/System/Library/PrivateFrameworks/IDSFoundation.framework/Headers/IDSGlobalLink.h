...
- (void)_connectWithSessionInfo:(id)arg1 interfaceAddress:(id)arg2 joinSession:(BOOL)arg3 allocbindFailover:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5 withLocalInterfacePreference:(int)arg6;
- (void)connectWithSessionInfo:(id)arg1 interfaceAddress:(id)arg2 joinSession:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4 withLocalInterfacePreference:(int)arg5;
...
- (void)_getNAT64PrefixForInterface:(int)arg1 interfaceName:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
