...
- (void)_updateVisibleFrame:(CGRect)arg1 withReplyHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_updateVisibilityState:(long long)arg1;
- (void)_performUpdateWithReplyHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_requestEncodedLayerTreeAtURL:(id)arg1 withReplyHandler:(id /* CDUnknownBlockType */)arg2;
