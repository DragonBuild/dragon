...
- (void)debugWidgetWithBundleID:(id)arg1 options:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)widgetListEditViewController:(id)arg1 requestsIconForItemWithIdentifier:(id)arg2 withHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)dismissWidgetListEditViewController:(id)arg1 animated:(BOOL)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_requestUnlockWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)dismissWidgetListEditViewControllerAnimated:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)presentWidgetListEditViewControllerFromViewController:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (id)init;
- (id)_widgetViewControllerWithBundleID:(id)arg1 containingBundleID:(id)arg2 didConnect:(id /* CDUnknownBlockType */)arg3 canTearDown:(id /* CDUnknownBlockType */)arg4;
