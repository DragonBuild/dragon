...
- (void)serializeDictionaryIntoDictionary:(id)arg1 withKey:(id)arg2 withValue:(id)arg3 dictSerializer:(id /* CDUnknownBlockType */)arg4 isRequired:(BOOL)arg5 defaultValue:(id)arg6;
- (void)serializeArrayIntoDictionary:(id)arg1 withKey:(id)arg2 withValue:(id)arg3 itemSerializer:(id /* CDUnknownBlockType */)arg4 isRequired:(BOOL)arg5 defaultValue:(id)arg6;
...
- (id)loadArrayFromDictionary:(id)arg1 withKey:(id)arg2 validator:(id /* CDUnknownBlockType */)arg3 isRequired:(BOOL)arg4 defaultValue:(id)arg5 error:(id )arg6;
