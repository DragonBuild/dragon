...
// - (void).cxx_destruct;
- (void)refreshGUID;
- (void)getFTEStringsWithReply:(id /* CDUnknownBlockType */)arg1;
- (void)triggerTaskWhenReady:(id)arg1;
- (void)removeTask:(id)arg1;
- (void)updateFromSession:(id)arg1 bag:(id)arg2 forClient:(id)arg3 error:(id)arg4;
- (void)fetchModifiedResourceFromSession:(id)arg1 resource:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
