...
- (id)axmDescription;
- (void)purgeResources:(id /* CDUnknownBlockType */)arg1;
- (void)prewarmEngine;
- (void)updateEngineConfiguration:(id /* CDUnknownBlockType */)arg1;
...
- (void)_queue_removeResultHandler:(id /* CDUnknownBlockType */)arg1;
- (void)removeResultHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_queue_addResultHandler:(id /* CDUnknownBlockType */)arg1;
