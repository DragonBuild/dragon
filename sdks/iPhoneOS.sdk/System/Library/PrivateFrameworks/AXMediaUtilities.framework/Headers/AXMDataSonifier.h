...
- (void)loadDataAndRenderAudioForXAxis:(double )arg1 yAxis:(double )arg2 numValues:(NSUInteger)arg3 axisMinimumX:(double)arg4 axisMaximumX:(double)arg5 axisMinimumY:(double)arg6 axisMaximumY:(double)arg7 interpolationMode:(int)arg8 trendline:(id /* CDUnknownBlockType */)arg9;
