...
// - (void).cxx_destruct;
- (void)enumerateAggregatedMessagesWithBlock:(id /* CDUnknownBlockType */)arg1 clearStore:(BOOL)arg2;
- (double)_roundToSigFigs:(double)arg1 forRawMessage:(id)arg2;
- (void)enumerateMessagesWithBlock:(id /* CDUnknownBlockType */)arg1 messageGroup:(id)arg2 clearStore:(BOOL)arg3;
- (void)enumerateMessagesWithBlock:(id /* CDUnknownBlockType */)arg1 clearStore:(BOOL)arg2;
- (void)enumerateMessageGroups:(id /* CDUnknownBlockType */)arg1;
