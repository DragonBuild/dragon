...
+ (void)recentInputForIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
+ (void)requestLexiconForRecentInputIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
