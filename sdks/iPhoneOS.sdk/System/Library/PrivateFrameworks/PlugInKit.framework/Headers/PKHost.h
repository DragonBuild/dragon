...
- (void)readyPlugIns:(id)arg1 synchronously:(BOOL)arg2 environment:(id)arg3 ready:(id /* CDUnknownBlockType */)arg4;
- (void)accessPlugIns:(id)arg1 synchronously:(BOOL)arg2 flags:(NSUInteger)arg3 extensions:(id /* CDUnknownBlockType */)arg4;
- (void)cancelPlugInDiscovery:(id)arg1;
- (id)continuouslyDiscoverPlugInsForAttributes:(id)arg1 flags:(NSUInteger)arg2 found:(id /* CDUnknownBlockType */)arg3;
- (id)rewriteDiscoveryAttributes:(id)arg1 flags:(NSUInteger)arg2;
- (void)discoverPlugInsForAttributes:(id)arg1 flags:(NSUInteger)arg2 found:(id /* CDUnknownBlockType */)arg3;
