...
// - (void).cxx_destruct;
- (void)downloadConsistencyProof:(id)arg1 uuid:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)downloadQuery:(id)arg1 uuid:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)downloadPublicKeys:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchQuery:(id)arg1 uuid:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)handleQueryResponse:(id)arg1 fetchError:(id)arg2 application:(id)arg3 error:(id )arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)fetchPublicKeys:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
