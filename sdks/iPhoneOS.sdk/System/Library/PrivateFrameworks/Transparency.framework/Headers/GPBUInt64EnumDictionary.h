...
- (id)initWithValidationFunction:(/* void * /* void * CDUnknownFunctionPointerType */ */)arg1 rawValues:(const int )arg2 forKeys:(const NSUInteger )arg3 count:(NSUInteger)arg4;
