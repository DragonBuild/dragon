...
+ (void)applyMarkupModelData:(id)arg1 attachment:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
+ (void)extractReturnedMarkupURL:(id)arg1 attachment:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
+ (void)embedReturnedMarkupURL:(id)arg1 attachment:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
+ (void)applyReturnedMarkupURL:(id)arg1 attachment:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
