...
+ (void)batchRecordsToSave:(id)arg1 delete:(id)arg2 maxRecordCountPerBatch:(NSUInteger)arg3 maxRecordSizePerBatch:(NSUInteger)arg4 withBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)saveSubscriptionsForDatabase:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchSubscriptionsForDatabase:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)updateSubscriptionsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)subscriptionForDatabase:(id)arg1;
- (void)clearZoneFetchState;
- (void)saveZoneFetchState;
- (void)loadZoneFetchState;
- (void)fetchDatabaseChangesOperation:(id)arg1 finishedWithServerChangeToken:(id)arg2 accountID:(id)arg3 error:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (id)operationToFetchDatabaseChangesForDatabase:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchDatabaseChangesForDatabases:(id)arg1 reason:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)fetchDatabaseChangesWithReason:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)addOperationsToFetchRecordZoneChangesForAccountZoneIDs:(id)arg1 reason:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)fetchRecordZoneChangesForAccountZoneIDs:(id)arg1 reason:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)fetchRecordZoneChangesForZoneIDs:(id)arg1 accountID:(id)arg2 reason:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)fetchRecordZoneChangesWithReason:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)validateAccountZoneIDsNeedingFetchChanges;
- (void)handleNotification:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)handleDatabaseNotification:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_processCloudObjects:(id)arg1 operationQueue:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)processObjectIDs:(id)arg1 operationQueue:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)processAllCloudObjectsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)processPendingCloudObjectsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)processPendingCloudObjects;
- (void)addOperationToProcessObjectsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_addModifyRecordsOperationsWithCloudObjectsToSave:(id)arg1 delete:(id)arg2 accountID:(id)arg3 operationGroupName:(id)arg4 waitForDependencies:(BOOL)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)addModifyRecordsOperationsWithCloudObjectsToSave:(id)arg1 delete:(id)arg2 accountID:(id)arg3 operationGroupName:(id)arg4 waitForDependencies:(BOOL)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)deleteSharesForObjects:(id)arg1 accountID:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)deleteSharesForObjects:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)pushCloudObjects:(id)arg1 operationGroupName:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)addFetchOperationsForRecordIDs:(id)arg1 accountID:(id)arg2 qualityOfService:(long long)arg3 operationGroupName:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)fetchRecordIDs:(id)arg1 accountID:(id)arg2 operationGroupName:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)fetchCloudObjects:(id)arg1 accountID:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)fetchUserRecordWithContainer:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchUserRecordWithAccountID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)updateAccountStatusWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
@property(nonatomic) long long accountStatus;
- (void)pauseCloudSyncWhileSynchronouslyPerformingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)finishOperationsForRecordID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)deleteRecordZonesWithZoneIDs:(id)arg1 accountID:(id)arg2 markZonesAsUserPurged:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)clearPendingActivity;
- (void)cancelEverythingWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_syncWithReason:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)syncWithReason:(id)arg1 onlyIfReachable:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)syncWithReason:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
