...
- (BOOL)writeDataWithBlock:(id /* CDUnknownBlockType */)arg1 error:(id )arg2;
...
- (id)data;
- (void)writeDataFromItemProvider:(id)arg1 checkForMarkupData:(BOOL)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
