...
- (void)startBackgroundDeferralCheckForTime:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_backgroundDeferralCheck:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)taskIsDeferred;
- (BOOL)deferTask;
