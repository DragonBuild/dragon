...
+ (id)onScheduler:(id)arg1 requestID:(NSUInteger)arg2 requestContentForObjectID:(id)arg3 messagePersistence:(id)arg4 legacyMessage:(id)arg5 messageTransformer:(id)arg6 mailDropAttachmentGenerator:(id)arg7 clientIdentifier:(id)arg8 options:(id)arg9 delegate:(id)arg10 completionHandler:(id /* CDUnknownBlockType */)arg11;
+ (id)onScheduler:(id)arg1 requestContentForObjectID:(id)arg2 messagePersistence:(id)arg3 legacyMessage:(id)arg4 messageTransformer:(id)arg5 mailDropAttachmentGenerator:(id)arg6 clientIdentifier:(id)arg7 options:(id)arg8 delegate:(id)arg9 completionHandler:(id /* CDUnknownBlockType */)arg10;
+ (id)log;
...
- (id)_requestContentForAttachment:(id)arg1 manager:(id)arg2 options:(id)arg3 managed:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (id)requestHTMLRepresentationWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)_generateRepresentationForLoadingContext:(id)arg1 existingRepresentation:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)requestRawRepresentationWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)beginRequestWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)delegateWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
- (id)_init;
