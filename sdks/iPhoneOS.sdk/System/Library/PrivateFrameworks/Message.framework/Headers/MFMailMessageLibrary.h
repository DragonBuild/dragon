...
- (void)sendMessagesMatchingCriterion:(id)arg1 to:(id)arg2 options:(unsigned int)arg3 baseTable:(unsigned int)arg4 range:(_NSRange)arg5;
- (void)sendMessagesMatchingCriterion:(id)arg1 to:(id)arg2 options:(unsigned int)arg3 baseTable:(unsigned int)arg4 range:(_NSRange)arg5 success:(BOOL )arg6;
- (id)queryForCriterion:(id)arg1 connection:(id)arg2 options:(unsigned int)arg3;
- (id)queryForCriterion:(id)arg1 connection:(id)arg2 options:(unsigned int)arg3 range:(_NSRange)arg4;
...
- (id)queryForCriterion:(id)arg1 connection:(id)arg2 options:(unsigned int)arg3 baseTable:(unsigned int)arg4 isSubquery:(BOOL)arg5 range:(_NSRange)arg6;
