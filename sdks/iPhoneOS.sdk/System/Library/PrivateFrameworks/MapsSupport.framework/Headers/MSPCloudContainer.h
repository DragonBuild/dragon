...
- (void)mergeLocalChangesFromReplica:(id)arg1 withAppliedRemoteChanges:(id)arg2 group:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)mergeRemoteChanges:(id)arg1 withGroup:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)mergeWithGroup:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)handleMergeError:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)pushChanges:(id)arg1 withGroup:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)batchedOperationsFromRecords:(id)arg1 toDelete:(id)arg2 group:(id)arg3 batchSize:(NSUInteger)arg4 modifyRecordsCompletionBlock:(id /* CDUnknownBlockType */)arg5;
- (id)_modifyRecordsOperationWithRecordsToSave:(id)arg1 toDelete:(id)arg2 group:(id)arg3 modifyRecordsCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)fetchChangesWithGroup:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)subscribeToChangesWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)removeCloudContainerWithGroup:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
