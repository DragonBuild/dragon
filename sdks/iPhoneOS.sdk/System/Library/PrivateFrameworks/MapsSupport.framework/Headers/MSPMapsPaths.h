...
+ (id)mapsApplicationContainerPathsWithInvalidationHandler:(id /* CDUnknownBlockType */)arg1;
// - (void).cxx_destruct;
...
- (void)_invalidate;
- (id)initWithLibraryDirectoryURL:(id)arg1 groupLibraryURL:(id)arg2 invalidationHandler:(id /* CDUnknownBlockType */)arg3;
