...
- (void)persistPublicGlobalUUIDsForAssets:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)launchDupeAnalysisIfNeeded;
- (void)analyzeDupesWithNormalInserts:(id)arg1 cloudInserts:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_analyzeDupes;
...
- (void)_performAnalysisTransaction:(id /* CDUnknownBlockType */)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
