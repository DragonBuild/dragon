...
// - (void).cxx_destruct;
- (void)validateLibraryWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)invalidateHighlightSubtitlesAndRegenerateHighlightTitlesWithForceUpdateLocale:(BOOL)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)invalidateHighlightSubtitlesAndRegenerateHighlightTitlesWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)cleanupEmptyHighlightsWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)updateHighlightTitlesWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)processUnprocessedMomentLocationsWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)processRecentHighlightsWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)rebuildAllHighlightsWithOptions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)rebuildAllMomentsWithOptions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_runIncrementalGenerationPassWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)generateWithIncrementalDataCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)generateWithAssetInsertsAndUpdates:(id)arg1 assetDeletes:(id)arg2 assetUpdatesForHighlights:(id)arg3 momentUpdatesForHighlights:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
