...
// - (void).cxx_destruct;
- (void)_resourcesToPrefetchWithPredicates:(id)arg1 budget:(long long)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_resourcesWithPredicate:(id)arg1 limit:(NSUInteger)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)prefetchResourcesWithPredicates:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
