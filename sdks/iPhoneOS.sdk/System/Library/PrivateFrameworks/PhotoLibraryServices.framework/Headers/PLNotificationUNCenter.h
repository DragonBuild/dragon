...
- (void)enumerateExistingNotificationsUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)findExistingNotificationByIdentifier:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)mergeExistingAndSendNotificationForNotification:(id)arg1 requestIdentifier:(id)arg2 thumbnailHandler:(id /* CDUnknownBlockType */)arg3;
- (void)mergeExistingAndSendNotificationForNotification:(id)arg1 thumbnailHandler:(id /* CDUnknownBlockType */)arg2;
- (void)removeNotificationWithRequestIdentifiers:(id)arg1;
- (void)_findNotificationForRequestIdentifier:(id)arg1 withPendingHandler:(id /* CDUnknownBlockType */)arg2 deliveredHandler:(id /* CDUnknownBlockType */)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
