...
+ (void)bootstrap;
+ (_NSRange)searchTextExtendedRangeForParse:(id)arg1;
+ (id)datedParsesWithParses:(id)arg1;
+ (BOOL)enumerateDatedParsesWithParse:(id)arg1 currentTokenIndex:(NSUInteger)arg2 potentialComboAttributes:(id)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)enumerateParsesWithMode:(NSUInteger)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)cancel;
- (void)runWithResultsHandler:(id /* CDUnknownBlockType */)arg1;
...
- (BOOL)_enumerateImplicitlyTokenizedParsesWithBaseParse:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
