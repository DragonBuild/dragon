...
+ (void)decorateThumbnailInRect:(CGRect)arg1 size:(CGSize)arg2 duration:(id)arg3 inContext:(CGContext )arg4 format:(id)arg5;
+ (void)decorateThumbnail:(id)arg1 inContext:(CGContext )arg2;
...
- (void)saveAssetJob:(id)arg1 imageSurface:(id)arg2 previewImageSurface:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (BOOL)imageWriterJob:(id)arg1 hasValidPathsWithConnection:(id)arg2;
- (void)_processJob:(id)arg1;
- (void)_processSyncedVideoSaveJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processVideoSaveJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processVideoJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_processXPCDaemonJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processDaemonJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processCrashRecoveryJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_processSyncClientSaveJobsJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_processSavePhotoStreamImageToCameraRollJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processReenqueueAssetUUIDsToPhotoStreamJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_enablePhotoStreamJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processDeletePhotoStreamAssetsWithUUIDs:(id)arg1 withReason:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_processDeletePhotoStreamDataJob:(id)arg1 withReason:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_processAutodeleteEmptyAlbumJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processImportImageJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processAvalanchesValidationJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processAvalancheJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_processBatchImageJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_removeInProgressExtendedAttributesForFileAtURL:(id)arg1;
- (void)_processImageJob:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
