...
// - (void).cxx_destruct;
- (void)dispatchOnQueue:(id)arg1 blockWithoutBoost:(id /* CDUnknownBlockType */)arg2;
...
- (void)personPromoterAdvancedStatus:(id /* CDUnknownBlockType */)arg1;
- (void)personPromoterStatus:(id /* CDUnknownBlockType */)arg1;
- (id)requestSuggestedMePersonIdentifierWithError:(id )arg1;
- (void)faceProcessingStatusForUserInterface:(id /* CDUnknownBlockType */)arg1;
...
- (long long)updateKeyFacesOfPersonsWithLocalIdentifiers:(id)arg1 forceUpdate:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)renderFaceTilesForFaceLocalIdentifiers:(id)arg1 inAssetWithLocalIdentifier:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)renderFaceTilesForFaceLocalIdentifiers:(id)arg1 inAssetWithLocalIdentifier:(id)arg2 error:(id )arg3;
- (long long)suggestVerifiedPersonLocalIdentifierForPersonWithLocalIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (long long)suggestVerifiedPersonLocalIdentifierForFaceWithLocalIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (long long)suggestedPersonsForPersonWithLocalIdentifier:(id)arg1 toBeConfirmedPersonSuggestions:(id)arg2 toBeRejectedPersonSuggestions:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)setJobProcessingConstraintsWithValues:(id)arg1 mask:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)scheduleAssetForOnDemandAnalysisWithUUID:(id)arg1 workerType:(short)arg2 workerFlags:(int)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)generateMemoriesRelatedDiagnosticsLogsWithReply:(id /* CDUnknownBlockType */)arg1;
...
- (void)requestSnapshotServiceForRelatedDebugInfoBetweenMomentForLocalIdentifier:(id)arg1 andRelatedResultsForLocalIdentifiers:(id)arg2 precision:(NSUInteger)arg3 relatedType:(NSUInteger)arg4 additionalSnapshotSummaryInfo:(id)arg5 reply:(id /* CDUnknownBlockType */)arg6;
- (void)requestSnapshotServiceForRelatedDebugInfoBetweenAssetForLocalIdentifier:(id)arg1 andRelatedResultsForLocalIdentifiers:(id)arg2 precision:(NSUInteger)arg3 relatedType:(NSUInteger)arg4 reply:(id /* CDUnknownBlockType */)arg5;
- (void)requestSnapshotServiceForRelatedWithAssetLocalIdentifier:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)requestSnapshotServiceForRelatedWithMomentLocalIdentifier:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (BOOL)requestInvalidatePersistentCaches:(id )arg1;
- (BOOL)requestInvalidateTransientCaches:(id )arg1;
- (void)requestGraphRebuildFractionCompletedWithReply:(id /* CDUnknownBlockType */)arg1;
- (id)requestGraphPerformQuery:(id)arg1 error:(id )arg2;
- (id)requestGraphStatus:(id )arg1;
- (void)requestHighlightEstimatesWithReply:(id /* CDUnknownBlockType */)arg1;
...
- (void)invalidateGraphWithReply:(id /* CDUnknownBlockType */)arg1;
- (void)enrichDataModelWithProgress:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)rebuildGraphWithOptions:(id)arg1 progress:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
- (void)notifyWhenGraphReadyWithCoalescingIdentifier:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
...
- (void)generateQuestionsWithOptions:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)generateSuggestionsWithOptions:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)simulateMemoriesNotificationWithOptions:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)generateMemoriesWithOptions:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
