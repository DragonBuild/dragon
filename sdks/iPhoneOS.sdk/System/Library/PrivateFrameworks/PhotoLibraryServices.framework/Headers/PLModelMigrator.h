...
+ (BOOL)enumerateObjectsWithIncrementalSaveDefaultBatchSizeFetchRequest:(id)arg1 managedObjectContext:(id)arg2 count:(NSUInteger )arg3 error:(id )arg4 block:(id /* CDUnknownBlockType */)arg5;
...
- (BOOL)_runMigrationStepWithName:(id)arg1 fetchRequest:(id)arg2 store:(id)arg3 migrationHandler:(id /* CDUnknownBlockType */)arg4;
- (BOOL)_runMigrationStepWithPrettyFunction:(const char )arg1 store:(id)arg2 migrationHandler:(id /* CDUnknownBlockType */)arg3;
...
- (BOOL)_saveChangesToPhotoIrisInStore:(id)arg1 matchingPredicate:(id)arg2 countChanged:(NSUInteger )arg3 error:(id )arg4 changeBlock:(id /* CDUnknownBlockType */)arg5;
...
- (BOOL)_performChangesOnBatchFetchedObjects:(id)arg1 inMOC:(id)arg2 batchSize:(NSUInteger)arg3 objectHandler:(id /* CDUnknownBlockType */)arg4 error:(id )arg5;
...
- (void)_importAfterCrash:(id)arg1 dictionariesByPhotoStreamID:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)importAfterCrash:(id)arg1 dictionariesByPhotoStreamID:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)loadFileSystemDataIntoDatabaseIfNeededWithReason:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)loadFileSystemAssetsNotifyCompleted:(id /* CDUnknownBlockType */)arg1;
