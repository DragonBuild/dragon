...
- (NSUInteger)_makeResourceLocallyAvailable:(id)arg1 asset:(id)arg2 inContext:(id)arg3 options:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (id)_videoConversionServiceClient;
- (id)_imageConversionServiceClient;
- (NSUInteger)_pruneResource:(id)arg1 asset:(id)arg2 inContext:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_downloadCPLResource:(id)arg1 forAsset:(id)arg2 options:(id)arg3 taskDidBeginHandler:(id /* CDUnknownBlockType */)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
