...
- (id)observeCameraPreviewWellImageChangeOnQueue:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (void)enumerateIndexMappingCachesForObject:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
...
- (id)addObserverForName:(id)arg1 object:(id)arg2 queue:(id)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
