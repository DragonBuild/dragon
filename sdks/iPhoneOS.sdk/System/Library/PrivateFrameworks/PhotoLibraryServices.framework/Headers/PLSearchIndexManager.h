...
- (void)_fetchMemoriesToIndexWithUUIDs:(id)arg1 managedObjectContext:(id)arg2 result:(id /* CDUnknownBlockType */)arg3;
...
- (void)applyGraphUpdates:(id)arg1 supportingData:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)applyUpdates:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)resetSearchIndexWithReason:(long long)arg1 dropCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)_inqResetSearchIndexWithReason:(long long)arg1 dropCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)dropSearchIndexWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)closeSearchIndexWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)ensureSearchIndexExistsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_inqCloseSearchIndexAndDelete:(BOOL)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)enqueuedUUIDsCountWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_onQueueAsyncWithDelay:(double)arg1 perform:(id /* CDUnknownBlockType */)arg2;
- (void)_onQueueAsync:(id /* CDUnknownBlockType */)arg1;
- (void)_onQueueSync:(id /* CDUnknownBlockType */)arg1;
- (void)dealloc;
