...
+ (void)batchFetchAssetsByFaceUUIDWithFaceUUIDs:(id)arg1 library:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
+ (void)enumerateImageRequestHintData:(id)arg1 assetWidth:(long long)arg2 assetHeight:(long long)arg3 libraryID:(id)arg4 startingOffset:(long long)arg5 block:(id /* CDUnknownBlockType */)arg6;
...
- (void)generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 retryNumber:(NSUInteger)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (id)attemptReframeWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 isOnDemand:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)synchronouslyGenerateFullsizeRenderImageIfNecessaryAtPath:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_asyncGenerateRenderImageFileWithSize:(CGSize)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 adjustmentDataBlob:(id)arg4 originalImageFilePath:(id)arg5 originalImageEXIFOrientation:(long long)arg6 renderedImageFilePath:(id)arg7 completionHandler:(id /* CDUnknownBlockType */)arg8;
...
- (void)synchronouslyFetchAdjustmentDataWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_setValue:(id)arg1 forKey:(id)arg2 valueDidChangeHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)hasGPS;
...
- (void)synchronouslyFetchAdjustmentBlobWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (NSUInteger)resourceTypeForUnadjustedFlattenedLivePhotoAssetResourceType:(NSUInteger)arg1 sourceAsset:(id)arg2;
...
- (BOOL)checkAllResourcesRequiredForCPLDisableWithReachableBlock:(id /* CDUnknownBlockType */)arg1;
...
- (id)fetchResourceWithIdentity:(id)arg1 createIfNeeded:(BOOL)arg2 fetchConfigurationBlock:(id /* CDUnknownBlockType */)arg3 error:(id )arg4;
- (id)firstPersistedResourceMatching:(id /* CDUnknownBlockType */)arg1;
- (id)persistedResourcesMatching:(id /* CDUnknownBlockType */)arg1;
...
- (id)_persistedResourcesForResourceIdentity:(id)arg1 fetchConfigurationBlock:(id /* CDUnknownBlockType */)arg2 error:(id )arg3;
