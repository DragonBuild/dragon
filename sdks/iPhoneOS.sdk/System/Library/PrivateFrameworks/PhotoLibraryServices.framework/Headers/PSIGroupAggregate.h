...
- (_NSRange)_rangeOfString:(id)arg1 inGroup:(id)arg2 useNormalizedString:(BOOL)arg3 extendingSearchRange:(BOOL)arg4 matchingFullToken:(BOOL)arg5 excludingRanges:(id)arg6;
