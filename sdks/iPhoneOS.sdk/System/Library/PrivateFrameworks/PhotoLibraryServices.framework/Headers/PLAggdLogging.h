...
+ (void)performLibraryStatisticsLoggingForLibrary:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
+ (void)performHyperionLocalResourcesLogging:(id /* CDUnknownBlockType */)arg1 inManagedObjectContext:(id)arg2 cloudPhotoLibraryEnabled:(BOOL)arg3;
+ (void)performHyperionLocalResourcesLoggingForLibrary:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
