...
- (void)_fixIrisWithZeroVideoComplementDuration:(id)arg1 cloudPhotoLibraryManager:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_fixFullSizeAdjustedResource:(id)arg1 cloudPhotoLibraryManager:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_fixRawUTIForAsset:(id)arg1 error:(id )arg2;
- (void)_fixOriginalAssetDimensionsForAsset:(id)arg1 cloudPhotoLibraryManager:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_fixDimensionsForAsset:(id)arg1 cloudPhotoLibraryManager:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (id)_assetKindsAllowedForDownloading;
- (void)_downloadResources:(id)arg1 forAsset:(id)arg2 usingCloudPhotoLibraryManager:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_performAssetRecoveryTaskForInconsistentState:(id)arg1 state:(NSUInteger)arg2 usingCloudPhotoLibraryManager:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)_recoverAsset:(id)arg1 usingCloudPhotoLibraryManager:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
