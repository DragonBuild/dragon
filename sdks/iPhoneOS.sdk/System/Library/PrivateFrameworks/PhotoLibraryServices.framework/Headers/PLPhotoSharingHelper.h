...
+ (void)countOfAssetsInMstreamdSharingDownloadQueueWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
+ (void)isMstreamdBusyPerformingSharingActivityWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
+ (void)handlePhoneInvitationFailuresWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
+ (void)markPendingInvitationAsSpamForAlbum:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)declinePendingInvitationForAlbum:(id)arg1;
+ (void)acceptPendingInvitationForAlbum:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
+ (unsigned int)registerIdleStateChangeObserverWithToken:(int )arg1 handler:(id /* CDUnknownBlockType */)arg2;
+ (BOOL)removeCloudSharingDirectories:(id )arg1;
+ (void)requestVideoPlaybackURLForAsset:(id)arg1 videoType:(NSUInteger)arg2 completion:(id /* CDUnknownBlockType */)arg3;
