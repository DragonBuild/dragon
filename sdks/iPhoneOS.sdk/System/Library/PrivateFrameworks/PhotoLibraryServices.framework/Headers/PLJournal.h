...
- (BOOL)enumeratePayloadsUsingBlock:(id /* CDUnknownBlockType */)arg1 error:(id )arg2;
...
- (BOOL)createSnapshotUsingNextPayloadBlock:(id /* CDUnknownBlockType */)arg1 error:(id )arg2;
