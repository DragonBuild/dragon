...
+ (CGImage )_thumbnailForAssetURL:(id)arg1 library:(id)arg2 useAspect:(BOOL)arg3;
+ (CGImage )aspectRatioThumbnailForAssetURL:(id)arg1 library:(id)arg2;
+ (CGImage )thumbnailForAssetURL:(id)arg1 library:(id)arg2;
