...
- (id /* CDUnknownBlockType */)_commentSortingComparator;
- (id /* CDUnknownBlockType */)_assetSortingComparator;
...
- (void)rebuildAllEntries:(id /* CDUnknownBlockType */)arg1;
- (void)processAlbumUpdates:(id)arg1 assetInserts:(id)arg2 assetUpdates:(id)arg3 commentInserts:(id)arg4 invitationRecordUpdates:(id)arg5 deletionEntries:(id)arg6 completionHandler:(id /* CDUnknownBlockType */)arg7;
