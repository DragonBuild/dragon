...
- (void)getThumbnailImageDataAssetUUID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)calculateCurrentBadgeCountWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
