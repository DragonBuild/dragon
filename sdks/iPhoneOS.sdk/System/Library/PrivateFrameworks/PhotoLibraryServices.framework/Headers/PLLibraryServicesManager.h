...
- (void)_enqueueExternalWaiterCompletionBlockForState:(long long)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)_awaitLibraryState:(long long)arg1 sync:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_dispatchAwaitLibraryStateCompletionHandler:(id /* CDUnknownBlockType */)arg1 group:(id)arg2 error:(id)arg3;
