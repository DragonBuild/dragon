...
- (void)_updateProviderListForMatchingExtensions:(id)arg1 allExtensionStartedHandler:(id /* CDUnknownBlockType */)arg2;
- (id)uniquedExtensions:(id)arg1;
- (id)extensionsByID:(id)arg1;
- (void)migrateEnabledStateIfNecessary:(id)arg1;
- (void)loadProvidersAndMonitorWithUpdateHandler:(id /* CDUnknownBlockType */)arg1;
