...
- (void)dumpInternalStateTo:(id)arg1 request:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (long long)nonEvictableSpace;
- (void)downloadItemWithItemID:(id)arg1 request:(id)arg2 progress:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)forceIngestionForItemID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)forceFSIngestionForItemID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)forceIngestionAtURL:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)didChangeItemID:(id)arg1 request:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)workingSetDidChangeWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)fetchEnumeratorWithSettings:(id)arg1 observer:(id)arg2 request:(id)arg3 lifetimeExtender:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)daemonSideItemChange:(id)arg1 changedFields:(NSUInteger)arg2 request:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (BOOL)isProviderForURL:(id)arg1;
- (void)_unregisterFromFileCoordinator;
- (void)_registerFileCoordinatorWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (id)_fileReactorID;
- (void)extensionIndexer:(id)arg1 didIndexOneBatchWithError:(id)arg2 updatedItems:(id)arg3 deletedIDs:(id)arg4 anchor:(id)arg5 anchorPersisted:(id /* CDUnknownBlockType */)arg6;
...
- (void)_startWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)createRootAndObserveIfNeededWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_startObservingRootAndResumeIndexerWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)createRootURLWithCompletion:(id /* CDUnknownBlockType */)arg1;
