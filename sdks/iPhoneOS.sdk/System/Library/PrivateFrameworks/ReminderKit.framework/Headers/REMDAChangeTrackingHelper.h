...
- (void)_handleLazyDeletionChange:(id)arg1 ofModelClass:(Class)arg2 forClientID:(id)arg3 deleteHandler:(id /* CDUnknownBlockType */)arg4 undeleteHandler:(id /* CDUnknownBlockType */)arg5;
