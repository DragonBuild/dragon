...
+ (void)prepareDocumentForSerializationWithAttachmentContentIDs:(id)arg1 withAttachmentPresentations:(id)arg2 newPresentationProvider:(id /* CDUnknownBlockType */)arg3 leftoverPresentations:(id )arg4;
