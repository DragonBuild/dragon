...
- (id)fm_addNotificationBlockObserverForObject:(id)arg1 keyPath:(id)arg2 options:(NSUInteger)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
- (id)fm_addNotificationBlockObserverForName:(id)arg1 object:(id)arg2 queue:(id)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
