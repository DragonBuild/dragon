...
- (void)signRequest:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (BOOL)handleAuthKitActionAttribute:(id)arg1;
- (id)initWithRequestConfiguration:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
