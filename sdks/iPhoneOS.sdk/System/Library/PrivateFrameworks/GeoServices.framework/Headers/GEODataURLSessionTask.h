...
// - (void).cxx_destruct;
- (void)delegateAsync:(id /* CDUnknownBlockType */)arg1;
...
- (void)didReceiveResponse:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)updateRequest:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)dataSession:(id)arg1 willSendRequestForEstablishedConnection:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)createURLRequest;
