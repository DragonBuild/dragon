...
- (void)_addOpportunisticManifestUpdateCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_addManifestUpdateCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_setCurrentUpdateType:(long long)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)updateIfNecessary:(id /* CDUnknownBlockType */)arg1;
- (void)_updateManifest;
- (void)_updateManifest:(id /* CDUnknownBlockType */)arg1;
- (BOOL)_updateManifestIfNecessary:(id /* CDUnknownBlockType */)arg1;
- (id)_manifestURL;
...
- (void)_changeActiveTileGroup:(id)arg1 activeScales:(id)arg2 activeScenarios:(id)arg3 dataSet:(id)arg4 migrationTasks:(id)arg5 flushTileCache:(BOOL)arg6 completionHandler:(id /* CDUnknownBlockType */)arg7;
