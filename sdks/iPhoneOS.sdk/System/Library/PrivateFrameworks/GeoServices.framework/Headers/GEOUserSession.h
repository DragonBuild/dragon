...
- (void)mapsSessionEntityWithCallback:(id /* CDUnknownBlockType */)arg1 shareSessionIDWithMaps:(BOOL)arg2 resetSession:(BOOL)arg3;
...
- (void)_shortSessionWithBasisComponentsCompletion:(id /* CDUnknownBlockType */)arg1;
