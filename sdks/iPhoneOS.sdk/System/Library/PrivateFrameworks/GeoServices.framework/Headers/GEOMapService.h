...
+ (void)_attributedGeoMapItemsForPlaceDatasWithType:(int)arg1 placeDatas:(id)arg2 disambiguationLabels:(id)arg3 handler:(id /* CDUnknownBlockType */)arg4;
+ (id)sharedService;
// - (void).cxx_destruct;
...
- (void)_geoMapItemsForResponseData:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)resolveMapItemLocallyFromHandle:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)resolveMapItemFromHandle:(id)arg1 traits:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)resolveMapItemFromHandle:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)resolveMapItemFromHandle:(id)arg1 withTraits:(id)arg2 useCache:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)resolveMapItemFromHandle:(id)arg1 withTraits:(id)arg2 useCache:(BOOL)arg3 coordinateOnlyRefinement:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_resolveMapItemFromHandle:(id)arg1 withTraits:(id)arg2 cachePolicy:(NSUInteger)arg3 coordinateOnlyRefinement:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_resolveMapItemFromHandle:(id)arg1 withTraits:(id)arg2 cachePolicy:(NSUInteger)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
