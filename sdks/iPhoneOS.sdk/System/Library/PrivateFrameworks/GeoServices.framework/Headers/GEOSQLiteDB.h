...
- (BOOL)executeInTransaction:(id /* CDUnknownBlockType */)arg1;
- (BOOL)vacuum;
- (BOOL)executeStatement:(id)arg1 statementBlock:(id /* CDUnknownBlockType */)arg2;
...
- (BOOL)_bindParameter:(const char )arg1 inStatement:(struct sqlite3_stmt )arg2 error:(id )arg3 withBinder:(id /* CDUnknownBlockType */)arg4;
- (BOOL)statementForKey:(id)arg1 statementBlock:(id /* CDUnknownBlockType */)arg2;
...
- (BOOL)setup;
- (void)_execute:(id /* CDUnknownBlockType */)arg1 errorHandler:(id /* CDUnknownBlockType */)arg2;
- (void)executeAsync:(id /* CDUnknownBlockType */)arg1;
- (void)executeAsync:(id /* CDUnknownBlockType */)arg1 errorHandler:(id /* CDUnknownBlockType */)arg2;
- (void)executeSync:(id /* CDUnknownBlockType */)arg1;
- (void)executeSync:(id /* CDUnknownBlockType */)arg1 errorHandler:(id /* CDUnknownBlockType */)arg2;
- (id)description;
- (id)initWithQueueName:(const char )arg1 log:(id)arg2 databaseFileURL:(id)arg3 sqliteFlags:(int)arg4 pragmas:(id)arg5 setupBlock:(id /* CDUnknownBlockType */)arg6;
- (id)initWithQueueName:(const char )arg1 logFacility:(const char )arg2 dbFilePath:(id)arg3 sqliteFlags:(int)arg4 pragmas:(id)arg5 setupBlock:(id /* CDUnknownBlockType */)arg6;
- (id)init;
