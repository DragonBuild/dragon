...
- (id)initWithComposedRoute:(id)arg1 routeLegType:(long long)arg2 stepIndex:(NSUInteger)arg3 pointRange:(_NSRange)arg4 line:(id)arg5 maneuverType:(int)arg6 significance:(int)arg7;
- (id)initWithComposedRoute:(id)arg1 decoderData:(id)arg2 step:(id)arg3 stepIndex:(NSUInteger)arg4 duration:(unsigned int)arg5 pointRange:(_NSRange)arg6;
