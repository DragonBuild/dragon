...
- (void)_requestIdentifiersFromNetwork:(id)arg1 resultProviderID:(int)arg2 traits:(id)arg3 auditToken:(id)arg4 throttleToken:(id)arg5 finished:(id /* CDUnknownBlockType */)arg6 error:(id /* CDUnknownBlockType */)arg7;
...
- (void)startRequest:(id)arg1 traits:(id)arg2 timeout:(double)arg3 auditToken:(id)arg4 throttleToken:(id)arg5 finished:(id /* CDUnknownBlockType */)arg6 networkActivity:(id /* CDUnknownBlockType */)arg7 error:(id /* CDUnknownBlockType */)arg8;
- (void)dealloc;
- (id)init;
