...
- (void)_geo_cacheMissErrorParameters:(id /* CDUnknownBlockType */)arg1;
- (void)_geo_cacheMissParameters:(id /* CDUnknownBlockType */)arg1;
- (void)_geo_cacheHitParameters:(id /* CDUnknownBlockType */)arg1;
