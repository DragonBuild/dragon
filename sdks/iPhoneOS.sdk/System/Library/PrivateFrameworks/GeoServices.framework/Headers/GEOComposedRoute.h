...
- (BOOL)isSnapping;
- (void)forEachSnappedPath:(id /* CDUnknownBlockType */)arg1;
...
- (void)_snapPaths:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)roadFeaturesForRouteCoordinate:(struct PolylineCoordinate)arg1 distanceAhead:(double)arg2 handler:(id /* CDUnknownBlockType */)arg3;
...
- (void)dealloc;
- (void)_enumerateAllStepsWithBlock:(id /* CDUnknownBlockType */)arg1;
