...
- (void)importCustomAssetsWithImportInfos:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)deleteNamedAssets:(id)arg1 shouldDeleteAssetFiles:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)importNamedAssetsWithImportInfos:(id)arg1 referenceFiles:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)canImportNamedAssetImportInfo:(id)arg1;
- (void)importNamedAssetsFromFileURLs:(id)arg1 referenceFiles:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
