...
- (void)eventQueuePerformBlockOnObservers:(id /* CDUnknownBlockType */)arg1;
...
- (void)forgetEverythingInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)setMultipleContributorsEnabled:(BOOL)arg1 forAlbumWithGUID:(id)arg2 info:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)setMultipleContributorsEnabled:(BOOL)arg1 forAlbumWithGUID:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)setPublicAccessEnabled:(BOOL)arg1 forAlbumWithGUID:(id)arg2 info:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)setPublicAccessEnabled:(BOOL)arg1 forAlbumWithGUID:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)acceptInvitationWithToken:(id)arg1 info:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)videoURLsForAssetCollectionWithGUID:(id)arg1 forMediaAssetType:(NSUInteger)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)videoURLForAssetCollectionWithGUID:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)shutDownForDestruction:(BOOL)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)shutDown;
- (void)cancel;
- (void)start;
...
- (void)performBlockOnObservers:(id /* CDUnknownBlockType */)arg1;
