...
- (void)forgetEverythingCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)workQueueForgetEverythingAboutPersonIDs:(id)arg1 index:(NSUInteger)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)forgetEverythingAboutPersonID:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)workQueueForgetEverythingAboutPersonID:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)shutDownStateMachine:(id)arg1 forDestruction:(BOOL)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_postModelShutdownForPersonID:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)mapQueueShutDownStateMachineInMap:(id)arg1 personIDs:(id)arg2 index:(NSUInteger)arg3 forDestruction:(BOOL)arg4 completionBlock:(id /* CDUnknownBlockType */)arg5;
- (void)shutDown;
- (void)start;
- (id)init;
