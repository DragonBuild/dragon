...
- (void)unregisterAssetCollections:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)unregisterAssetCollections:(id)arg1;
- (void)registerAssetCollections:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)workQueueRegisterAssetCollections:(id)arg1 index:(NSUInteger)arg2 results:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)workQueueRegisterAssets:(id)arg1 index:(NSUInteger)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)workQueueCancelAssetCollections:(id)arg1;
- (void)workQueueUploadNextBatch;
- (id)_orphanedAssetCollectionError;
- (void)workQueueCancel;
- (void)workQueueShutDownCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)workQueueStop;
- (void)_workQueueStop;
