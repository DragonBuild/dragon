...
- (void)videoURLsForAssetCollection:(id)arg1 forMediaAssetType:(NSUInteger)arg2 inAlbum:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)videoURLForAssetCollection:(id)arg1 inAlbum:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)setMultipleContributorsEnabled:(BOOL)arg1 forAlbum:(id)arg2 info:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)setPublicAccessEnabled:(BOOL)arg1 forAlbum:(id)arg2 info:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)workQueueCancelCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)workQueueCancelAllCommandsFilteredByAlbumGUID:(id)arg1 assetCollectionGUID:(id)arg2;
- (void)cancelCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)stopAssetDownloadsCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)purgeEverythingCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)shutDownCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_workQueueEmptyFileTransferQueuesCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)start;
