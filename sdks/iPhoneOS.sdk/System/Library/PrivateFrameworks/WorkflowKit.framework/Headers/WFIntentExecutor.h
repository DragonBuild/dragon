...
- (void)retainSelf;
- (void)showConfirmationForInteraction:(id)arg1 confirmationRequired:(BOOL)arg2 authenticationRequired:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (BOOL)continueInApp;
- (void)finish;
...
- (void)handleIntent:(id)arg1 inBackgroundAppWithBundleIdentifier:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
...
- (void)startConnectionWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)configureConnection;
- (void)getDynamicOptionsForParameterNamed:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
