...
+ (id)requestWithURL:(id)arg1 scheme:(id)arg2 userInterface:(id)arg3 bundleIdentifier:(id)arg4 successHandler:(id /* CDUnknownBlockType */)arg5 failureHandler:(id /* CDUnknownBlockType */)arg6;
...
- (id)initWithURL:(id)arg1 scheme:(id)arg2 userInterface:(id)arg3 successHandler:(id /* CDUnknownBlockType */)arg4 failureHandler:(id /* CDUnknownBlockType */)arg5 bundleIdentifier:(id)arg6;
