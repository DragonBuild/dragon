...
+ (void)showImplicitChooseFromListWithInput:(id)arg1 userInterface:(id)arg2 cancelHandler:(id /* CDUnknownBlockType */)arg3 selectionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)askForValuesOfParameters:(id)arg1 withDefaultStates:(id)arg2 input:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_processParameterStates:(id)arg1 withInput:(id)arg2 skippingHiddenParameters:(BOOL)arg3 askForValuesIfNecessary:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)processParametersWithoutAskingForValuesWithInput:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)processParameterStates:(id)arg1 withInput:(id)arg2 skippingHiddenParameters:(BOOL)arg3 askForValuesIfNecessary:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (BOOL)getInputContentFromVariablesInParameterState:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)previousAction;
