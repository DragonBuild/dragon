...
- (void)loadActionDescriptionIconsMaxCount:(long long)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)configureAsSingleStepShortcutIfNecessary:(id /* CDUnknownBlockType */)arg1;
- (void)saveActionsToRecordIfNeeded;
- (void)performBatchOperation:(id /* CDUnknownBlockType */)arg1;
...
- (void)requestToRunScriptsOnDomain:(id)arg1 withUserInterface:(id)arg2 database:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
