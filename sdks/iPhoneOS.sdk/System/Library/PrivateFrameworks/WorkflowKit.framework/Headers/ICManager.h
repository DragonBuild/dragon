...
- (void)registerHandler:(id /* CDUnknownBlockType */)arg1 forIncomingRequestsWithAction:(id)arg2 legacyAction:(id)arg3 scheme:(id)arg4;
...
- (BOOL)handleOpenURL:(id)arg1 fromSourceApplication:(id)arg2 errorHandler:(id /* CDUnknownBlockType */)arg3;
- (void)dealloc;
- (id)init;
