...
- (void)loadAppInStoreController:(id)arg1 withCampaignToken:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)openFile:(id)arg1 withAnnotation:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)openFile:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
