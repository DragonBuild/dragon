...
- (void)syncDatabase:(id)arg1 includingOrdering:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)applyConflictResolution:(id)arg1 inDatabase:(id)arg2;
- (void)syncDatabase:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
