...
- (void)triggerSync:(BOOL)arg1 onlyIfPending:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)triggerSync:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)completeSyncWithSuccess:(BOOL)arg1 changes:(BOOL)arg2 error:(id)arg3;
- (void)pushCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)handleUserDeletedZoneErrorIfNeededWithSuccess:(BOOL)arg1 changes:(BOOL)arg2 error:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)startSync;
- (void)dealloc;
