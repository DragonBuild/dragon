...
- (void)scrollToTop;
- (void)recordedImpressionsMatching:(id)arg1 reset:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)recordedImpressions:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)onViewAttributesChangeWithArguments:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)onPerformanceMetricsChange:(id)arg1;
- (void)onImpressionsChange:(id)arg1;
- (void)onUpdate;
- (void)onNeedsUpdateWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)onInactive;
- (void)onActive;
- (void)onDisappear;
- (void)onAppear;
