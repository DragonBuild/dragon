...
// - (void).cxx_destruct;
- (void)didCompleteLoadingFromMemoryWithRequest:(id)arg1 response:(id)arg2 withResponseBodyBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_didCompleteLoadingFromCache:(long long)arg1 mimeType:(id)arg2 withResponseBody:(id)arg3 timestamp:(double)arg4;
- (void)didCompleteLoadingFromCache:(long long)arg1 withResponseBodyBlock:(id /* CDUnknownBlockType */)arg2;
