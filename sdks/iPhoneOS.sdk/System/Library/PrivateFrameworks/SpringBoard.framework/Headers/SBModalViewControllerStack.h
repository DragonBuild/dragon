...
- (void)_removeViewController:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_addViewController:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)removeViewControllerAnimated:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)removeViewController:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)addViewController:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
