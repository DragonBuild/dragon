...
// - (void).cxx_destruct;
- (void)_fadeInIcon:(id)arg1 isReplacing:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_fadeOutIcon:(id)arg1 atIndex:(NSUInteger)arg2 isReplacing:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)_performOrDefer:(BOOL)arg1 iconUpdate:(id /* CDUnknownBlockType */)arg2;
