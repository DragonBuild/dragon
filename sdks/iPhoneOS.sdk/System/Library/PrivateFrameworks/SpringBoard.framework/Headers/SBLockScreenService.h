...
- (oneway void)requestPasscodeUnlockUIWithOptions:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (oneway void)launchEmergencyDialerWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;
- (void)requestPasscodeUnlockUIForClient:(id)arg1 options:(id)arg2 description:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
