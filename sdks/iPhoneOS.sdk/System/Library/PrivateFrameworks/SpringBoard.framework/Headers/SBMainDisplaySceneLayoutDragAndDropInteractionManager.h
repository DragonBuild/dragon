...
- (BOOL)_anyActiveAndVisibleSceneEntityMatches:(id /* CDUnknownBlockType */)arg1;
...
- (void)_dragInteraction:(id)arg1 prepareForSession:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
