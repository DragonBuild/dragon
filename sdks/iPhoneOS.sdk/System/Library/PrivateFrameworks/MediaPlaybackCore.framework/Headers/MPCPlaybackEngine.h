...
// - (void).cxx_destruct;
- (void)requestAuthorizationForExplicitItem:(id)arg1 reason:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)restoreStateWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)becomeActive;
- (void)start;
