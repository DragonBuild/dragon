...
+ (void)_sendRemoteCommand:(unsigned int)arg1 playbackIntent:(id)arg2 options:(id)arg3 toPlayerPath:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
+ (void)_sendLocalCommand:(unsigned int)arg1 playbackIntent:(id)arg2 options:(id)arg3 toPlayerPath:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
+ (void)_sendCommand:(unsigned int)arg1 options:(id)arg2 appOptions:(unsigned int)arg3 toPlayerPath:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
+ (void)sendCommand:(unsigned int)arg1 options:(id)arg2 toPlayerPath:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (id /* CDUnknownBlockType */)_onQueue_setOptimisticPlayingItemIdentifier:(id)arg1;
- (id /* CDUnknownBlockType */)_onQueue_setOptimisticPlaybackState:(unsigned int)arg1 withOptions:(id)arg2;
- (id /* CDUnknownBlockType */)_onQueue_setOptimisticElapsedTimeForContentItem:(id)arg1 elapsedTime:(double)arg2 rate:(float)arg3;
- (id /* CDUnknownBlockType */)_onQueue_updateOptimisticStateForCommand:(unsigned int)arg1 options:(id)arg2;
...
- (id /* CDUnknownBlockType */)artworkCatalogBlockForContentItem:(id)arg1;
