...
- (void)_addPlaybackContext:(id)arg1 atPosition:(long long)arg2 afterContentItemID:(id)arg3 sectionIdentifier:(id)arg4 actions:(NSUInteger)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)reset;
- (void)removeContentItemID:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)reloadWithPlaybackContext:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)moveContentItemID:(id)arg1 afterContentItemID:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)finalizeStateRestorationWithAccountManager:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)addPlaybackContext:(id)arg1 atPosition:(long long)arg2 jumpToIt:(BOOL)arg3 userModification:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)addPlaybackContext:(id)arg1 atPosition:(long long)arg2 jumpToIt:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)addPlaybackContext:(id)arg1 atPosition:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)addPlaybackContext:(id)arg1 afterContentItemID:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
