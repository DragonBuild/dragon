...
- (id)onInvalid:(id /* CDUnknownBlockType */)arg1;
- (id)onCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)onFailure:(id /* CDUnknownBlockType */)arg1;
- (id)onSuccess:(id /* CDUnknownBlockType */)arg1;
