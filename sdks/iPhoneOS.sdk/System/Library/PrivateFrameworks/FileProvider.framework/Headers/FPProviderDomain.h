...
+ (void)fetchProviderDomainForItem:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
+ (void)fetchProviderDomainWithID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
+ (id)providerDomainForURL:(id)arg1 error:(id )arg2;
+ (BOOL)supportsSecureCoding;
+ (void)endMonitoringProviderDomainChanges:(id)arg1;
+ (id)beginMonitoringProviderDomainChangesWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)setEnabled:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
