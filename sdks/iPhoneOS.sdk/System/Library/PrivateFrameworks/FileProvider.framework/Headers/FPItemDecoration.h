...
+ (void)fetchInfoForItem:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
// - (void).cxx_destruct;
- (void)folderStatusForItem:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
