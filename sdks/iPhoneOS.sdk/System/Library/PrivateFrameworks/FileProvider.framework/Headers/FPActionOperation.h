...
// - (void).cxx_destruct;
- (void)tryRecoveringFromPreflightErrors:(id)arg1 recoveryHandler:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)tryRecoveringFromError:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_runUserInteractionsPreflight:(id /* CDUnknownBlockType */)arg1;
