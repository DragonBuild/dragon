...
- (void)_queue_updateRemoveBulletin:(id)arg1 withReply:(id /* CDUnknownBlockType */)arg2;
- (void)_queue_updateModifyBulletin:(id)arg1 withReply:(id /* CDUnknownBlockType */)arg2;
- (void)_queue_updateAddBulletin:(id)arg1 withReply:(id /* CDUnknownBlockType */)arg2;
- (void)_queue_updateBulletin:(id)arg1 withReply:(id /* CDUnknownBlockType */)arg2;
- (void)_prewarmSectionParametersAndAttachmentsForBulletin:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)updateBulletin:(id)arg1 withReply:(id /* CDUnknownBlockType */)arg2;
...
- (void)_getComposedImageSizeIgnoringCacheForAttachment:(id)arg1 bulletin:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)getComposedImageSizeForAttachment:(id)arg1 bulletin:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_getComposedImageIgnoringCacheForAttachment:(id)arg1 bulletin:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)getComposedImageForAttachment:(id)arg1 bulletin:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_getDataIgnoringCacheForAttachment:(id)arg1 bulletin:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)getDataForAttachment:(id)arg1 bulletin:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)getParametersForSectionID:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)getBulletinsForPublisherMatchIDs:(id)arg1 sectionID:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)getPublisherMatchIDsOfBulletinsPublishedAfterDate:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)getBulletinsWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)getUniversalSectionIDForSectionID:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)getPrimaryAttachmentDataForBulletin:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)getAttachmentImageForBulletin:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
