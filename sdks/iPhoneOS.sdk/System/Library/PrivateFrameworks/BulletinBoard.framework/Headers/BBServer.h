...
- (void)_updateSectionInfoForSectionID:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)_saveUpdatedSectionInfo:(id)arg1 forSectionID:(id)arg2;
- (void)_updateClearedInfoForSectionID:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (void)setSectionInfo:(id)arg1 forSectionID:(id)arg2 withHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)setEffectiveGlobalSpokenNotificationSetting:(long long)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
- (void)getEffectiveGlobalSpokenNotificationSettingWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)setEffectiveGlobalContentPreviewsSetting:(long long)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
- (void)getEffectiveGlobalContentPreviewsSettingWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)getSectionIDsWithHandler:(id /* CDUnknownBlockType */)arg1;
- (void)getEffectiveSectionInfoForSectionIDs:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
- (void)getSectionInfoForSectionIDs:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
- (void)getEffectiveSectionInfoForSectionID:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
- (void)getSectionInfoForSectionID:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)getEffectiveSectionInfoWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)observer:(id)arg1 getSectionInfoForSectionIDs:(id)arg2 withHandler:(id /* CDUnknownBlockType */)arg3;
- (void)observer:(id)arg1 getSectionInfoForActiveSectionsWithHandler:(id /* CDUnknownBlockType */)arg2;
- (void)observer:(id)arg1 getSectionInfoWithHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)observer:(id)arg1 handleResponse:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_resumeAllSuspendedConnectionsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)deliverResponse:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
