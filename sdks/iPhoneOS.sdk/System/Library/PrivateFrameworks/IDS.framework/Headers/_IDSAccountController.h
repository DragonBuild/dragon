...
- (void)setupAccountWithSetupParameters:(id)arg1 aliases:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)setupAccountWithLoginID:(id)arg1 aliases:(id)arg2 password:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)setupAccountWithLoginID:(id)arg1 password:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_setupAccountWithLoginID:(id)arg1 accountConfig:(id)arg2 authToken:(id)arg3 password:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)_connect;
- (void)_callDelegatesRespondingToSelector:(SEL)arg1 withPreCallbacksBlock:(id /* CDUnknownBlockType */)arg2 callbackBlock:(id /* CDUnknownBlockType */)arg3 postCallbacksBlock:(id /* CDUnknownBlockType */)arg4 group:(id)arg5;
- (void)_callDelegatesRespondingToSelector:(SEL)arg1 withPreCallbacksBlock:(id /* CDUnknownBlockType */)arg2 callbackBlock:(id /* CDUnknownBlockType */)arg3 postCallbacksBlock:(id /* CDUnknownBlockType */)arg4;
- (void)_callDelegatesWithBlock:(id /* CDUnknownBlockType */)arg1 group:(id)arg2;
