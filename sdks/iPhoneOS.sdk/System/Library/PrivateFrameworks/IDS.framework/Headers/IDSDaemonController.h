...
- (id)forwarderWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)addedDelegateForService:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_blockUntilSendQueueIsEmpty;
- (BOOL)_makeConnectionWithLaunch:(BOOL)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)_handleDaemonException:(id)arg1;
- (void)dealloc;
- (id)init;
- (void)_performBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_performBlock:(id /* CDUnknownBlockType */)arg1 wait:(BOOL)arg2;
