...
- (void)_transactionMessagesFromTransportMessages:(id)arg1 withParticipants:(id)arg2 groups:(id)arg3 accountInfo:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)qFetchParticipantsFromDeviceMessges:(id)arg1 andGroupsFromGroupMessages:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)qIngestMessages:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
