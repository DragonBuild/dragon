...
- (void)writeDatagram:(const void )arg1 datagramSize:(unsigned int)arg2 datagramInfo:(CDStruct_54fea20c)arg3 options:(CDStruct_6bf83f29 )arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)_writeDatagram:(const void )arg1 datagramSize:(unsigned int)arg2 datagramInfo:(CDStruct_54fea20c)arg3 options:(CDStruct_6bf83f29 )arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)writeDatagrams:(const void )arg1 datagramSizes:(unsigned int )arg2 datagramInfo:(CDStruct_54fea20c)arg3 datagramCount:(int)arg4 options:(CDStruct_6bf83f29 )arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
