...
- (void)_callHandlersAsyncWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_callHandlersWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_callHandlersWithBlockOnIvarQueue:(id /* CDUnknownBlockType */)arg1;
- (void)_callHandlersWithBlockOnIvarQueue:(id /* CDUnknownBlockType */)arg1 cleanup:(id /* CDUnknownBlockType */)arg2;
- (void)removeHandler:(id)arg1;
- (void)addHandler:(id)arg1;
- (void)_performSyncBlock:(id /* CDUnknownBlockType */)arg1;
