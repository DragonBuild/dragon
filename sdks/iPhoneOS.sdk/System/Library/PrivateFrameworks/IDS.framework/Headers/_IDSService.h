...
- (void)performGroupTask:(id /* CDUnknownBlockType */)arg1;
...
- (BOOL)sendAheadGroup:(id)arg1 priority:(long long)arg2 options:(id)arg3 identifier:(id )arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (id /* CDUnknownBlockType */)_acknowledgementBlockWithDelegateIdentifier:(id)arg1;
