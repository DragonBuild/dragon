...
- (void)_queue_startObservingMobileGestaltQuestions:(id)arg1 withChangeHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_queue_runBlockOnObservers:(id /* CDUnknownBlockType */)arg1;
