...
- (BOOL)_performEnrichmentWithGraphUpdateInventory:(id)arg1 enrichmentContext:(long long)arg2 progressBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_triggerUpdateForGraphUpdate:(id)arg1;
- (void)_triggerFullRebuildDuringLiveUpdate:(BOOL)arg1 graphIngestRecipe:(id)arg2 progressBlock:(id /* CDUnknownBlockType */)arg3 keepExistingGraph:(BOOL)arg4 completionBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)_performRebuildWithGraphIngestRecipe:(id)arg1 progressBlock:(id /* CDUnknownBlockType */)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
