...
- (void)enumerateContactIdentifiersAndMentionedAddressesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateMessageGroupsWithProgressBlock:(id /* CDUnknownBlockType */)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumeratePersonLocalIdentifiersExchangingLoveEmojisWithProgressBlock:(id /* CDUnknownBlockType */)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (id)description;
