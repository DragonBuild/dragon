...
- (void)removeSamplesFrom:(double)arg1 to:(double)arg2 callback:(id /* CDUnknownBlockType */)arg3;
- (void)fetchSamplesFrom:(double)arg1 to:(double)arg2 callback:(id /* CDUnknownBlockType */)arg3;
- (void)fetchMetadataWithTime:(double)arg1 offset:(NSUInteger)arg2 metadataFrame:(void )arg3 next:(void )arg4;
- (id)findClosestMetadataFrameTo:(double)arg1 offset:(NSUInteger)arg2;
- (void)writeMetadataBytes:(const void )arg1 length:(NSUInteger)arg2 timestamp:(double)arg3;
- (BOOL)writeSampleBytes:(const void )arg1 length:(NSUInteger)arg2 timestamp:(double)arg3;
- (void)dealloc;
- (id)initWithSampleFile:(id)arg1 metadataFile:(id)arg2 permission:(NSUInteger)arg3 defaults:(id)arg4;
