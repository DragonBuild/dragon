...
// - (void).cxx_destruct;
- (BOOL)enumeratePercentilesWithError:(id )arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
@property(readonly, nonatomic) NSUInteger percentileCount;
- (BOOL)enumerateHistogramBucketsWithError:(id )arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
