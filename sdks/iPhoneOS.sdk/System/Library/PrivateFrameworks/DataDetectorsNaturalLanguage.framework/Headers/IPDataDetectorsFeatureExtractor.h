...
- (_NSRange)textRangeReferencingEvening:(id)arg1;
- (_NSRange)textRangeReferencingAfternoon:(id)arg1;
- (_NSRange)textRangeReferencingNoon:(id)arg1;
- (_NSRange)textRangeReferencingMorning:(id)arg1;
- (_NSRange)textRangeReferencingNewYearsEve:(id)arg1;
- (_NSRange)textRangeReferencingValentineDay:(id)arg1;
- (_NSRange)textRangeReferencingAllDay:(id)arg1;
- (_NSRange)textRangeReferencingNextWeekEnd:(id)arg1;
- (_NSRange)textRangeReferencingThisWeekEnd:(id)arg1;
- (_NSRange)textRangeReferencingTomorrow:(id)arg1;
...
- (BOOL)stringContainsNonTimeStrings:(id)arg1 aroundRange:(_NSRange)arg2;
