...
// - (void).cxx_destruct;
- (void)fetchSecurityLevelForAccount:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (id)accountWithDSID:(id)arg1;
- (id)accountDSID:(id)arg1;
- (void)disableAllDevicesWithCompletion:(id /* CDUnknownBlockType */)arg1;
@property(readonly, nonatomic) BOOL isInCloudKitDemoMode;
- (void)eligibleForTruthZoneWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_metricForPCSReportManateeStatusWithReason:(id)arg1 linkedFunction:(/* void * /* void * CDUnknownFunctionPointerType */ */)arg2 timeoutInSec:(double)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)metricForPCSReportManateeStatusWithReason:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)logDumpIsNecessaryAfterSync;
- (BOOL)logDumpIsExpected;
- (BOOL)_isRunningInAutomation;
- (id)ckStatisticCalculations;
- (void)logDumpAndSendMessageTo:(id)arg1 forHours:(int)arg2 reason:(id)arg3 isInitialSync:(BOOL)arg4 requirePreviousPrompt:(BOOL)arg5 willSendBlock:(id /* CDUnknownBlockType */)arg6;
...
- (void)logDumpAndSendMessageTo:(id)arg1 forHours:(int)arg2 reason:(id)arg3 requirePreviousPrompt:(BOOL)arg4 willSendBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)_showCKLogNotificationWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)primaryAccountHasiCloudBackupEnabledWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)_personIdFromAccount:(id)arg1;
- (void)fetchiCloudAccountPersonID:(id /* CDUnknownBlockType */)arg1;
- (void)_fetchPrimaryAccountWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)fetchMOCEnabledStateWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)fetchCloudKitAccountStatusAndCheckForAccountNeedsRepairWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)fetchLocalAccountSecurityLevel:(id /* CDUnknownBlockType */)arg1;
- (BOOL)_accountNeedsRepairOverride;
- (void)fetchCloudKitAccountStatusWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)_createAccountError:(id)arg1;
- (void)_checkEligibilityWithLoggedInAccountWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (BOOL)_accountInfoWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)checkiCloudQuota:(id /* CDUnknownBlockType */)arg1;
- (NSUInteger)messageDatabaseSize;
- (void)isFirstSyncWithCompletion:(id /* CDUnknownBlockType */)arg1;
