...
- (void)fetchChatZoneToCheckManateeStatus:(id /* CDUnknownBlockType */)arg1;
- (long long)derivedQualityOfService;
- (id)ckUtilities;
- (void)_deleteAllZonesForDatabase:(id)arg1;
- (void)deleteAllZones;
- (void)createSubscriptionIfNeededOnDeDupeZoneForSubscription:(id)arg1 recordType:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)deleteDeDupeSaltZone;
- (void)createDeDupeSaltZoneIfNeededWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)deleteAnalyticZone;
- (void)createAnalyticZoneIfNeededWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)deleteMessageZone;
- (void)createMessageZoneIfNeededWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)deleteAttachmentZone;
- (void)createAttachmentZoneIfNeededWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)deleteChatZone;
- (void)createChatZoneIfNeededWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_deleteZone:(id)arg1 forDatabase:(id)arg2;
- (void)_deleteZone:(id)arg1;
- (void)_createRecordZoneIfNeeded:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)_createRecordZone:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)_checkRecordZoneExists:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)_createSubscriptionIfNeededForZoneID:(id)arg1 subscriptionID:(id)arg2 recordType:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)_createSubscriptionForZoneID:(id)arg1 subscriptionID:(id)arg2 recordType:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
