...
- (void)didSendBalloonPayload:(id)arg1 forChat:(id)arg2 style:(unsigned char)arg3 messageGUID:(id)arg4 account:(id)arg5 completionBlock:(id /* CDUnknownBlockType */)arg6;
...
- (void)didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(BOOL)arg5 date:(id)arg6 useMessageSuppression:(BOOL)arg7 account:(id)arg8 completionBlock:(id /* CDUnknownBlockType */)arg9;
- (void)didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(BOOL)arg5 date:(id)arg6 completionBlock:(id /* CDUnknownBlockType */)arg7;
- (void)_didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(BOOL)arg5 date:(id)arg6 attempts:(long long)arg7 useMessageSuppression:(BOOL)arg8 account:(id)arg9 completionBlock:(id /* CDUnknownBlockType */)arg10;
- (void)didReceiveMessagePlayedReceiptForMessageID:(id)arg1 date:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_didReceiveMessagePlayedReceiptForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 useMessageSuppression:(BOOL)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 useMessageSuppression:(BOOL)arg4 completionBlock:(id /* CDUnknownBlockType */)arg5;
- (void)didReceiveMessageReadReceiptForMessageID:(id)arg1 date:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_didReceiveMessageReadReceiptForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 useMessageSuppression:(BOOL)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 useMessageSuppression:(BOOL)arg4 completionBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)sendLocationSharingInfo:(id)arg1 toID:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)leaveAllChats;
...
- (void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(BOOL)arg4 account:(id)arg5 completionBlock:(id /* CDUnknownBlockType */)arg6;
- (void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(BOOL)arg4 completionBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)_IMDStoreMessage:(id)arg1 inMessage:(id)arg2 forceReplace:(BOOL)arg3 modifyError:(BOOL)arg4 modifyFlags:(BOOL)arg5 calculateUnreadCount:(BOOL)arg6 flagMask:(NSUInteger)arg7 shouldStoreBlock:(id /* CDUnknownBlockType */)arg8 didStoreBlock:(id /* CDUnknownBlockType */)arg9 block:(id /* CDUnknownBlockType */)arg10;
...
- (void)sendLogDumpMessageAtFilePath:(id)arg1 toRecipient:(id)arg2 shouldDeleteFile:(BOOL)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
...
- (void)enqueReplayMessageCallback:(id /* CDUnknownBlockType */)arg1;
