...
- (void)syncAttachmentDeletesToCloudKit:(id /* CDUnknownBlockType */)arg1;
- (void)_deleteAttachmentsWithRecordIDs:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_fetchAndValidateFileTransfersFromCloudKit:(id)arg1 capturedWithABC:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_processAndValidateAttachmentRecordsEligibleForPurge:(id)arg1 recordIDsToTransfers:(id)arg2 capturedWithABC:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_validateTransferFromCloudKit:(id)arg1 localTransfer:(id)arg2 validateCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_processFetchRecordChangesCompleted:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)_processModifyPerRecordCallBack:(id)arg1 error:(id)arg2;
- (void)_processRecordZoneFetchCompletion:(id)arg1 zoneID:(id)arg2 clientChangeTokenData:(id)arg3 moreComing:(BOOL)arg4 shouldWriteBackChanges:(BOOL)arg5 desiredKeys:(long long)arg6 syncType:(long long)arg7 error:(id)arg8 currentBatchCount:(long long)arg9 maxBatchCount:(long long)arg10 completionBlock:(id /* CDUnknownBlockType */)arg11;
...
- (void)_writeCKRecordsToAttachmentZone:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchAttachmentZoneChangesShouldWriteBackChanges:(BOOL)arg1 desiredKeys:(long long)arg2 syncType:(long long)arg3 currentBatchCount:(long long)arg4 maxBatchCount:(long long)arg5 syncToken:(id)arg6 completionBlock:(id /* CDUnknownBlockType */)arg7;
- (BOOL)_fetchedAllChangesFromCloudKit;
- (void)_fetchAttachmentZoneRecords:(id)arg1 desiredKeys:(long long)arg2 useNonHSA2ManateeDatabase:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_writeAttachmentsToCloudKit:(id /* CDUnknownBlockType */)arg1;
...
- (void)downloadAttachmentAssetsForChatIDs:(id)arg1 services:(id)arg2 style:(unsigned char)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)downloadAttachmentAssetsWithActivity:(id)arg1 restoringAttachments:(BOOL)arg2 useNonHSA2ManateeDatabase:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_downloadAttachmentAssetsWithActivity:(id)arg1 restoringAttachments:(BOOL)arg2 useNonHSA2ManateeDatabase:(BOOL)arg3 retryCount:(NSUInteger)arg4 numAttachmentsDownloaded:(NSUInteger)arg5 transfers:(id)arg6 completion:(id /* CDUnknownBlockType */)arg7;
- (void)_downloadAttachmentAssetsWithActivity:(id)arg1 restoringAttachments:(BOOL)arg2 useNonHSA2ManateeDatabase:(BOOL)arg3 retryCount:(NSUInteger)arg4 numAttachmentsDownloaded:(NSUInteger)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (BOOL)_attachmentDownloadCanStart:(BOOL)arg1 withActivity:(id)arg2;
- (void)acceptFileTransfer:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)fetchAttachmentDataForTransfers:(id)arg1 highQuality:(BOOL)arg2 perTransferProgress:(id /* CDUnknownBlockType */)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)fetchAttachmentDataForTransfers:(id)arg1 highQuality:(BOOL)arg2 useNonHSA2ManateeDatabase:(BOOL)arg3 perTransferProgress:(id /* CDUnknownBlockType */)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)syncAttachmentsWithSyncType:(long long)arg1 deviceConditionsToCheck:(NSUInteger)arg2 activity:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
