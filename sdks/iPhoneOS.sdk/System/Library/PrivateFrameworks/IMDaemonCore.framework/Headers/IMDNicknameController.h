...
- (void)deleteAllPersonalNicknames:(BOOL)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)NicknameWithRecordID:(id)arg1 URI:(id)arg2 decryptionKey:(id)arg3 withCompletionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)getNicknameWithRecordID:(id)arg1 decryptionKey:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)currentPersonalNicknameWithRecordID:(id)arg1 decryptionKey:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)currentPersonalNicknamewithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_resetHandleSharingList;
- (void)_uploadPendingNicknameIfNecessary;
- (void)setPersonalNickname:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
