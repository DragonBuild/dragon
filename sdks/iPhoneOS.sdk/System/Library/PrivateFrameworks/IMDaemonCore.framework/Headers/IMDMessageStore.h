...
- (id)deleteMessagesWithChatIdentifiers:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_deleteMessagesWithGUIDs:(id)arg1 chatIdentifiers:(id)arg2 style:(unsigned char)arg3 onServices:(id)arg4 batchNumber:(NSUInteger)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (id)deleteMessageGUIDs:(id)arg1;
- (id)deleteMessageGUIDs:(id)arg1 inChat:(id)arg2;
- (void)resolveUnformattedRepresentationsForHandles:(id)arg1 onService:(id)arg2 message:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)_performBlock:(id /* CDUnknownBlockType */)arg1 afterDelay:(double)arg2;
