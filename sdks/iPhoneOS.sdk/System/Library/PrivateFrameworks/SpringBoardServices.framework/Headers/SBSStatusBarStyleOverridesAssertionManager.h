...
- (void)_internalQueue_updateRegistrationForCoordinator:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)updateRegistrationForCoordinator:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
...
- (void)statusBarTappedWithContext:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
...
- (void)addStatusBarStyleOverridesAssertion:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2 onQueue:(id)arg3;
