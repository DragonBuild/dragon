...
- (id)_operationWithRequest:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)removeTouchIconMetadataForHosts:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_enumerateRequestsForHost:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (id)_resizedImage:(id)arg1 forHost:(id)arg2;
- (double)_maximumScreenScale;
- (void)savePendingChangesBeforeTermination;
- (void)purgeUnneededCacheEntries;
- (void)emptyCaches;
- (id /* CDUnknownBlockType */)_blockOperationForRequest:(id)arg1 knownImageState:(long long)arg2;
