...
- (id).cxx_construct;
// - (void).cxx_destruct;
- (void)_resetForAccountChangeWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)resetForAccountChange;
- (void)_resetCloudHistoryDataWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_performBlockAsynchronouslyOnCloudHistoryQueueAfterHistoryHasLoaded:(id /* CDUnknownBlockType */)arg1;
...
- (void)_determineNumberOfDevicesInSyncCircleForOperation:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_pushNotificationsAreInitializedWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_updateHistoryAfterSuccessfulPersistedLongLivedSaveOperationWithGeneration:(long long)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_transitionCloudHistoryStoreToManateeState:(long long)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_getServerChangeTokenDataWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_callAndResetFetchCompletionHandlerWithError:(id)arg1;
- (void)_registerFetchCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)fetchAndMergeChangesBypassingThrottler:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_saveVisits:(id)arg1 tombstones:(id)arg2 toCloudHistoryBypassingThrottler:(BOOL)arg3 longLivedOperationPersistenceCompletion:(id /* CDUnknownBlockType */)arg4 withCallback:(id /* CDUnknownBlockType */)arg5;
...
- (void)_registerSaveCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)saveChangesBypassingThrottler:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)dealloc;
- (void)_determineCloudHistoryStoreWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)initWithHistory:(id)arg1 configuration:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
