...
- (void)getContentBlockersEnabledStateForDomain:(id)arg1 withTimeout:(double)arg2 fallbackEnabledState:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
