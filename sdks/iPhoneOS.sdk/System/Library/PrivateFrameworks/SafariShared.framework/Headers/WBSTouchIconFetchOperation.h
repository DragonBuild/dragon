...
- (void)_downloadFirstValidImageWithURLs:(id)arg1 failureHandler:(id /* CDUnknownBlockType */)arg2;
...
- (id)initWithRequest:(id)arg1 allowFetchingOverCellularNetwork:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
