...
- (void)synchronizeCloudTabDevicesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)clearTabsForFirstDuplicateDeviceInCloudKitWithName:(id)arg1 passingTest:(id /* CDUnknownBlockType */)arg2;
...
- (void)saveCurrentCloudTabDeviceDictionaryToCloudKit:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
