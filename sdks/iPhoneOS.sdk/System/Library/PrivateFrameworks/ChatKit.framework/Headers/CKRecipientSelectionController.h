...
- (void)autocompleteResultsController:(id)arg1 tintColorForRecipient:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)colorTypeForRecipient:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
