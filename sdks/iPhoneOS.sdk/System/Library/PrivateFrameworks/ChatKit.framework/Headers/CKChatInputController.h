...
- (void)showModalViewController:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)showEntryViewShelf:(id)arg1 forPlugin:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)startEditingPayload:(id)arg1 dismiss:(BOOL)arg2 forPlugin:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)startEditingPayloadBypassingValidation:(id)arg1 forPlugin:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_openContainingBundleID:(id)arg1 applicationService:(id)arg2 withURL:(id)arg3 pluginID:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)_dismissCompactSwitcherOverKeyboardWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_presentCompactSwitcherOverKeyboardWithCompletion:(id /* CDUnknownBlockType */)arg1;
