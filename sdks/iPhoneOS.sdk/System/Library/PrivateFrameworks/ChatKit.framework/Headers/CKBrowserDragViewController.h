...
// - (void).cxx_destruct;
- (void)reversePeelAnimationToPoint:(CGPoint)arg1 forPlacement:(BOOL)arg2 shouldShrink:(BOOL)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)animateScaleDown;
- (void)animatePeelWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)animatePlacementAtPoint:(CGPoint)arg1 shouldShrink:(BOOL)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)animateBackToSourceCompletionBlock:(id /* CDUnknownBlockType */)arg1;
