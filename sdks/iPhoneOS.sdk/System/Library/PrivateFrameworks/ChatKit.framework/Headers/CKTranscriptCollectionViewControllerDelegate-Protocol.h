...
- (UIContextMenuConfiguration *)transcriptCollectionViewController:(CKTranscriptCollectionViewController *)arg1 contextMenuConfigurationForItemAtIndexPath:(NSIndexPath *)arg2 point:(CGPoint)arg3;
@end
