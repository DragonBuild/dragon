...
// - (void).cxx_destruct;
- (void)verticallyScrollTranscriptByAmount:(double)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)updateTranscriptChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 reload:(id)arg4 regenerate:(id)arg5 animated:(BOOL)arg6 completion:(id /* CDUnknownBlockType */)arg7;
- (void)updateTranscriptChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 reload:(id)arg4 regenerate:(id)arg5 animated:(BOOL)arg6 checkFiltered:(BOOL)arg7 completion:(id /* CDUnknownBlockType */)arg8;
...
- (void)liveViewController:(id)arg1 stageSticker:(id)arg2 skipShelf:(BOOL)arg3 allowAllCommits:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)liveViewController:(id)arg1 stagePayload:(id)arg2 skipShelf:(BOOL)arg3 allowAllCommits:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)updateTranscript:(id /* CDUnknownBlockType */)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)reloadData;
