...
- (void)performCancelAnimationWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)performSendAndCloseAnimationWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_performClosingAnimationsWithSendAnimation:(BOOL)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
