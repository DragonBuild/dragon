...
- (void)animateOutCompactWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)animateInCompactWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_performAfterFirstLayout:(id /* CDUnknownBlockType */)arg1;
...
- (void)dismissBrowserFullscreenAnimated:(BOOL)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
