...
- (void)handleContentViewChangeWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_animateToCompactLayoutCollapsing:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)_shouldNotAnimateCollapseInteractive;
- (void)collapseGestureRecognized;
- (void)expandGestureRecongnized;
- (void)_animateExpandForManualToggle:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)minifyAppStrip;
- (void)setShowAppStrip:(BOOL)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
