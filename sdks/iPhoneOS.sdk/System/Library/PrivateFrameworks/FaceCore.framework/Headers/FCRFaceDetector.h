...
- (id)createFCRImage:(CGImage )arg1;
...
- (id)extractDetailsForFaces:(id)arg1 inCGImage:(CGImage )arg2 options:(id)arg3 error:(id )arg4;
...
- (id)detectFacesInCGImage:(CGImage )arg1 options:(id)arg2 error:(id )arg3;
...
- (id)transformROIs:(id)arg1 image:(id)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
