...
// - (void).cxx_destruct;
- (void)syncUserKeysForService:(id)arg1 serviceIsManatee:(BOOL)arg2 account:(id)arg3 shouldThrottle:(BOOL)arg4 testOverrideProvider:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)performKeySyncWithSyncTracker:(id)arg1 testableSyncConfig:(NSUInteger)arg2 shouldThrottle:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
