...
- (void)_prepPCSDataWithContext:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(BOOL)arg4 containerIdentifier:(id)arg5 sharedRecordZone:(id)arg6 completionHandler:(id /* CDUnknownBlockType */)arg7;
- (void)_prepPCSDataUsingPreDecryptedPCSOnlyWithContext:(id)arg1 databaseScope:(long long)arg2;
- (void)_prepPCSDataWithContext:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(BOOL)arg4 containerIdentifier:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)_ingestAndExportPPPCSFromShareInvitationToken:(id)arg1 context:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
