...
- (void)validateVettingToken:(id)arg1 vettingEmail:(id)arg2 vettingPhone:(id)arg3 accountAccessProvider:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)iCloudAuthTokenWithAccessProvider:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)iCloudAuthTokenWithAccessProvider:(id)arg1 error:(id )arg2;
- (void)renewiCloudAuthTokenWithReason:(id)arg1 shouldForce:(BOOL)arg2 accessProvider:(id)arg3 failedToken:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (id)_lockedCloudKitAuthTokenWithAccessProvider:(id)arg1 error:(id )arg2;
- (void)cloudKitAuthTokenWithAccessProvider:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)cloudKitAuthTokenWithAccessProvider:(id)arg1 error:(id )arg2;
- (void)renewCloudKitAuthTokenWithReason:(id)arg1 shouldForce:(BOOL)arg2 accessProvider:(id)arg3 failedToken:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_lockedRenewTokenWithReason:(id)arg1 shouldForce:(BOOL)arg2 accountAccessProvider:(id)arg3 tokenFetchBlock:(id /* CDUnknownBlockType */)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *authTokenQueue;
- (void)updateAccountPropertiesAndSaveAccountWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)dsid;
