...
- (void)performASyncOnLifecycleQueueIfNotFinished:(id /* CDUnknownBlockType */)arg1;
- (void)performOnLifecycleQueueIfNotFinished:(id /* CDUnknownBlockType */)arg1;
...
- (void)prepareRequestWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (id /* CDUnknownBlockType */)_xmlObjectParsedBlock;
- (long long)_handlePlistResult:(id)arg1;
- (id /* CDUnknownBlockType */)_jsonObjectParsedBlock;
- (long long)_handleServerJSONResult:(id)arg1;
- (id /* CDUnknownBlockType */)_protobufObjectParsedBlock;
- (long long)_handleServerProtobufResult:(id)arg1 rawData:(id)arg2;
- (void)_handleAuthFailure;
- (void)_renewAuthTokenWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_authTokenWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
