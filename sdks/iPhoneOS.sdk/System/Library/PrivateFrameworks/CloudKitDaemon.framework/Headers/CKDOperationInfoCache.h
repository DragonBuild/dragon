...
- (void)enumerateCallbackArgumentsForOperationWithID:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)_locked_enumerateCallbackArgumentsForOperationWithID:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
