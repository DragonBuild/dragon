...
- (void)_decryptRootRecordsForShareURL:(id)arg1 withMetadata:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_continueHandlingFetchedShareMetadata:(id)arg1 shareURL:(id)arg2;
- (void)_prepPPPCSDataForDugongShareMetadata:(id)arg1 withInvitationToken:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
