...
- (void)_uploadPackageSectionsWithTask:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)_uploadPackageSectionsWithEnumerator:(id)arg1 task:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_uploadPackageSection:(id)arg1 task:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
