...
- (void)fetchPrivateURLForServerType:(long long)arg1 operation:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)deviceIDForOperation:(id)arg1;
- (void)fetchServerEnvironmentForOperation:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchImportantUserIDsForOperation:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchPublicURLForServerType:(long long)arg1 operation:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_fetchContainerInfoForOperation:(id)arg1 requireUserIDs:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)fetchConfigurationForOperation:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)baseURLForServerType:(long long)arg1 partitionType:(long long)arg2;
- (id)_urlBySettingCustomBaseURL:(id)arg1 onURL:(id)arg2;
- (void)finishSetupWithClientProxy:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)startSetupWithClientProxy:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)removeClientProxy:(id)arg1;
- (void)addClientProxy:(id)arg1;
@property(readonly, copy) NSString *description;
- (id)CKPropertiesDescription;
- (double)publicIdentitiesExpirationTimeout;
- (void)showUserNotification:(void )arg1 withCompletionBlock:(id /* CDUnknownBlockType */)arg2;
