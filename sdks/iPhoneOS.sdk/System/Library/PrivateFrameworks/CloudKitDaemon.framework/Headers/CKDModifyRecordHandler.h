...
- (void)_fetchSharePCSForID:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchParentPCSForID:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchPCSData;
