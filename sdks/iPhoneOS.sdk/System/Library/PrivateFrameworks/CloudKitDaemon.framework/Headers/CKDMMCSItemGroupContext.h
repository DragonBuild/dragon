...
- (void)start;
- (void)cancel;
- (id)initWithMMCS:(id)arg1 itemGroup:(id)arg2 operation:(id)arg3 progress:(id /* CDUnknownBlockType */)arg4 command:(id /* CDUnknownBlockType */)arg5 start:(id /* CDUnknownBlockType */)arg6 completionHandler:(id /* CDUnknownBlockType */)arg7;
