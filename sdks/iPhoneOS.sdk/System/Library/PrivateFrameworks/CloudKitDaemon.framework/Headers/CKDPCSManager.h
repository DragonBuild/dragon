...
- (void)_onSynchronizeQueue:(id /* CDUnknownBlockType */)arg1;
- (void)synchronizeUserKeyRegistryForServiceType:(NSUInteger)arg1 shouldThrottle:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)boundaryKeyDataWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_lockedBoundaryKeyDataWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_locked_pcsDataFromFetchedShare:(id)arg1 withPublicSharingKey:(id)arg2 withServiceType:(NSUInteger)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)pcsDataFromFetchedShare:(id)arg1 withPublicSharingKey:(id)arg2 withServiceType:(NSUInteger)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)pcsDataFromFetchedShare:(id)arg1 withServiceType:(NSUInteger)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)pcsDataFromFetchedShare:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_locked_decryptPCSDataOnSharePCS:(id)arg1 withPublicSharingKey:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_locked_decryptCurrentPerParticipantPCSDataOnSharePCS:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)decryptPCSDataOnSharePCS:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)preflightIdentitiesForService:(NSUInteger)arg1 withSyncKeyRegistryRetry:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_locked_preflightIdentitiesForService:(NSUInteger)arg1 withSyncKeyRegistryRetry:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)availableIdentityForService:(NSUInteger)arg1 error:(id )arg2;
- (void)createIngestedPPPCSDataFromInvitationData:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)createZonePCSFromData:(id)arg1 usingServiceIdentityWithType:(NSUInteger)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_createPCSFromData:(id)arg1 ofType:(NSUInteger)arg2 usingPCSServiceType:(NSUInteger)arg3 withSyncKeyRegistryRetry:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_triggerAutobugCaptureForLostManateeIdentityError;
- (void)_locked_createPCSFromData:(id)arg1 ofType:(NSUInteger)arg2 usingPCSServiceType:(NSUInteger)arg3 withSyncKeyRegistryRetry:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)createZonePCSWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)createZonePCSWithSyncKeyRegistryRetry:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_locked_createZonePCSWithSyncKeyRegistryRetry:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)updateAccount:(id)arg1 clearPCSCacheHandler:(id /* CDUnknownBlockType */)arg2;
