...
- (void)_enumerateCaptureServicesUsingBlock:(id /* CDUnknownBlockType */)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_enumerateCaptureServicesUsingBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)_sessionQueue_startWithRetryCount:(NSUInteger)arg1 retryInterval:(double)arg2 logReason:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)startWithRetryCount:(NSUInteger)arg1 retryInterval:(double)arg2 logReason:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
