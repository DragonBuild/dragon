...
- (void)stopCaptureSessionWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)startCaptureSession;
- (void)startCaptureSessionWithRetryCount:(NSUInteger)arg1 retryInterval:(double)arg2 logReason:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)willPerformRecoveryFromRuntimeError:(id)arg1;
- (void)queryTimelapseDimensionsWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)queryVideoDimensionsWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)lockFocusAtLensPosition:(float)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
