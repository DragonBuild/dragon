...
- (void)setFooterButtonTitle:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (void)addActionWithTitle:(id)arg1 subtitle:(id)arg2 glyph:(id)arg3 handler:(id /* CDUnknownBlockType */)arg4;
- (void)addActionWithTitle:(id)arg1 glyph:(id)arg2 handler:(id /* CDUnknownBlockType */)arg3;
