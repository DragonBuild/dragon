...
- (void)_queue_addDeviceChangeHandler:(id /* CDUnknownBlockType */)arg1 withIdentifier:(id)arg2;
- (void)addDeviceChangeHandler:(id /* CDUnknownBlockType */)arg1 withIdentifier:(id)arg2;
- (id)_queue_connectedDevices;
- (void)connectedDevicesWithResult:(id /* CDUnknownBlockType */)arg1;
