...
- (void)_registerCompletion:(id /* CDUnknownBlockType */)arg1 forQueryID:(id)arg2;
...
- (void)enumerateAllChatsAndAttachmentSizesWithOptions:(NSUInteger)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)_startBackgroundProcessingChats:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
