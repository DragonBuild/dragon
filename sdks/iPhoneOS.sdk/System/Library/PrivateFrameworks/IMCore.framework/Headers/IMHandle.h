...
+ (void)handlesForPersons:(id)arg1 useBestHandle:(BOOL)arg2 useExtendedAsyncLookup:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
+ (void)validHandlesForPersons:(id)arg1 useExtendedAsyncLookup:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
+ (void)validHandlesForPersons:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
+ (void)bestHandlesForPersons:(id)arg1 useExtendedAsyncLookup:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
+ (void)bestHandlesForPersons:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
