...
+ (void)updateVIPChatIdentifiers:(id /* CDUnknownBlockType */)arg1;
+ (id /* CDUnknownBlockType */)watermarkComparator;
...
- (id)_performQueryWithKey:(id)arg1 loadImmediately:(BOOL)arg2 block:(id /* CDUnknownBlockType */)arg3;
- (id)_performQueryWithKey:(id)arg1 loadImmediately:(BOOL)arg2 block:(id /* CDUnknownBlockType */)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)_updateChatItemsAsNotSpamEnumeratingItems:(id /* CDUnknownBlockType */)arg1;
...
- (void)loadAttachments:(id /* CDUnknownBlockType */)arg1;
...
- (void)_updateChatItemsWithReason:(id)arg1 block:(id /* CDUnknownBlockType */)arg2 shouldPost:(BOOL)arg3;
- (void)_updateChatItemsWithReason:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
