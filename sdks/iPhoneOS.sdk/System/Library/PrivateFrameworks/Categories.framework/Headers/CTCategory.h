...
+ (void)_lookupAppStoreUsing:(id)arg1 platform:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
+ (id)_DHToAppStoreCategoriesMap;
+ (id)_DHIDtoPrimaryCategoriesMap;
+ (void)_getCategoryTypeForDomainName:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
+ (id)_overrideEquivalentIdentifiers:(id)arg1 forBundleID:(id)arg2;
+ (id)systemAppCategoryIdentifierForBundleIdentifier:(id)arg1;
+ (void)categoryForDomainName:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)categoryForDomainURL:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)categoryForBundleID:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)categoryForBundleIdentifiers:(id)arg1 platform:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
+ (void)categoryForBundleID:(id)arg1 platform:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
