...
- (void)refreshDayPassesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)getDayPassRTT;
...
- (void)startProbingEdges:(id)arg1 atIndex:(NSUInteger)arg2 doneCount:(NSUInteger)arg3 sampleCount:(NSUInteger)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (BOOL)reprocessWithNewRTT:(NSUInteger)arg1 reProbe:(BOOL )arg2;
- (long long)getFallbackReasonForLatencies:(id)arg1;
- (void)reprocessLatencies:(id)arg1 sampleCount:(NSUInteger)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)reprocessEdgeAtIndex:(NSUInteger)arg1 networkSignature:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)reprocessAdHocWithEdgeIndex:(NSUInteger)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)reprocessWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)establishTrustWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
