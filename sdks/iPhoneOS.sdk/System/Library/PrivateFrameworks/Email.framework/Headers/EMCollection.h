...
- (void)_filterAndTransformObjectIDs:(id)arg1 before:(BOOL)arg2 existingObjectID:(id)arg3 batchBlock:(id /* CDUnknownBlockType */)arg4;
...
- (id)iterateItemIDsStartingAtItemID:(id)arg1 inReverse:(BOOL)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
