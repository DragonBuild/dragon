...
- (id)proxy;
- (void)addRecoveryHandler:(id /* CDUnknownBlockType */)arg1;
- (void)addResetHandler:(id /* CDUnknownBlockType */)arg1;
- (void)recover;
- (void)reset;
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)initWithProtocol:(id)arg1 proxyGenerator:(id /* CDUnknownBlockType */)arg2;
