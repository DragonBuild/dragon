...
@class EFLazyCache, EMCollectionItemIDStateCapturer, EMMailboxScope, EMMessageListChangeObserverHelper, EMMessageRepository, EMThreadScope, NSMapTable, NSMutableDictionary, NSObject, NSSet, NSString;
