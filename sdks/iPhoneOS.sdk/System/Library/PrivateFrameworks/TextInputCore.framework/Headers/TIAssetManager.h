...
+ (id)singletonInstanceWithEnabledInputModesProvider:(id /* CDUnknownBlockType */)arg1;
+ (id)sharedAssetManagerWithEnabledInputModesProvider:(id /* CDUnknownBlockType */)arg1;
...
- (void)requestAssetDownloadForLanguage:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)dealloc;
- (id)initWithMobileAssetMediator:(id)arg1 requestedInputModes:(id)arg2 inputModePreferenceProvider:(id)arg3 enabledInputModesProvider:(id /* CDUnknownBlockType */)arg4;
- (id)init;
- (id)initForTestingWithMobileAssetMediator:(id)arg1 requestedInputModes:(id)arg2 inputModePreferenceProvider:(id)arg3 enabledInputModesProvider:(id /* CDUnknownBlockType */)arg4;
