...
+ (oneway void)downloadAsset:(id)arg1 continuation:(id /* CDUnknownBlockType */)arg2;
+ (id)downloadOptionsForAsset:(id)arg1;
+ (id /* CDUnknownBlockType */)downloadProgressHandlerForAsset:(id)arg1;
...
// - (void).cxx_destruct;
- (void)downloadUninstalledAssetsMatching:(id)arg1 continuation:(id /* CDUnknownBlockType */)arg2;
...
- (oneway void)downloadAssets:(id)arg1 continuation:(id /* CDUnknownBlockType */)arg2;
- (oneway void)fetchUninstalledAssetInformationMatchingAny:(id)arg1 continuation:(id /* CDUnknownBlockType */)arg2;
- (void)dealloc;
- (id)init;
