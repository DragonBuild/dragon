...
+ (void)_drawLineFromCellAtIndex:(NSUInteger)arg1 ofResponse:(id)arg2 atYCoordinate:(double)arg3 inContext:(CGContext )arg4 withAvailableWidth:(double)arg5;
+ (CGColor )_newCgColorWithTraitsColor:(id)arg1;
...
+ (struct __CFAttributedString )_newAttributedStringWithText:(id)arg1 font:(struct __CTFont )arg2 color:(CGColor )arg3;
+ (BOOL)_textRunsHaveFixedFontSize:(id)arg1;
+ (id)truncatedWidthsForItemWidths:(id)arg1 availableWidth:(double)arg2;
+ (CGColor )_newCgColorWithRed:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4;
