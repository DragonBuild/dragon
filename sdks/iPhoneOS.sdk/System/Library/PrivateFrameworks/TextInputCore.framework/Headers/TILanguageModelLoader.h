...
- (shared_ptr_e9f752ce)sharedLanguageModelForClient:(id)arg1 withRecipient:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (shared_ptr_e9f752ce)sharedLanguageModelForClient:(id)arg1 withRecipient:(id)arg2;
- (void)setLanguageModelRecipientIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)lookupRecordForRecipientIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)findRecordsMatchingRecipient:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
