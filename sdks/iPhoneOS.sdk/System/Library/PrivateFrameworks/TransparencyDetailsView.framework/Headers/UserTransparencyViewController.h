...
- (void)_reportUserTransparencyViewControllerEventWithType:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)requestUserTransparencyDetailsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_commonInit;
