...
- (void)_executeGenericActions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_executeMediaPlaybackActions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)executeWithTriggerSource:(id)arg1 captureCurrentState:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
