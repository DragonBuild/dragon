...
+ (id)shortDescription;
+ (void)createZoneWithName:(id)arg1 rootRecordName:(id)arg2 subscriptionName:(id)arg3 owner:(id)arg4 cacheZone:(id)arg5 cloudCache:(id)arg6 completion:(id /* CDUnknownBlockType */)arg7;
...
- (void)fetchMigratedObjects:(id /* CDUnknownBlockType */)arg1;
