...
- (void)runTransaction:(id)arg1 waitForCloudPush:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)settingTransactionWithName:(id)arg1;
- (void)runSettingTransaction:(id)arg1 waitForCloudPush:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)runSettingTransaction:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
