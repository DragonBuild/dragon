...
- (void)setAudioVolume:(id)arg1 callback:(id /* CDUnknownBlockType */)arg2;
...
- (id)logIdentifier;
- (id)initWithWorkQueue:(id)arg1 streamSnapshotHandler:(id)arg2 messageSender:(id /* CDUnknownBlockType */)arg3 accessory:(id)arg4 streamManagementService:(id)arg5 msgDispatcher:(id)arg6 profileUniqueIdentifier:(id)arg7 networkMonitor:(id)arg8 residentMessageHandler:(id)arg9;
