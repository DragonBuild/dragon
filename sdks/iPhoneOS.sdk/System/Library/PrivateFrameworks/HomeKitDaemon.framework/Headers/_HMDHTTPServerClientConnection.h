...
// - (void).cxx_destruct;
- (void)_reallySendMessage:(id)arg1 timeout:(double)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)sendMessage:(id)arg1 timeout:(double)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)dequeueRequest;
- (void)queueRequest:(id)arg1;
- (id /* CDUnknownBlockType */)removeCompletionHandlerForTransactionIdentifier:(id)arg1;
- (void)addCompletionHandler:(id /* CDUnknownBlockType */)arg1 forTransactionIdentifier:(id)arg2;
