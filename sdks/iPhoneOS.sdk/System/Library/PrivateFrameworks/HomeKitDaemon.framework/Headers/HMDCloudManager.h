...
- (void)_fetchDatabaseZoneChangesCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_forceCleanCloud:(BOOL)arg1 fetchTransaction:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)updateCloudDataSyncFilterState:(BOOL)arg1;
- (void)_accountIsActive;
- (void)_createZoneAndFetchChanges:(id /* CDUnknownBlockType */)arg1;
- (void)_verifyZonesExist:(id)arg1 zoneIndex:(NSUInteger)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_resetHomeDataRecordState;
- (id)_changeTokenFromData:(id)arg1;
- (void)_handleAccountStatus:(long long)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)updateAccountStatusChanged:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_processFetchCompletedWithError:(id)arg1 serverToken:(id)arg2 fetchTransaction:(id)arg3 migrationOptions:(long long)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5 moreRecordsComing:(BOOL)arg6 emptyRecord:(BOOL)arg7;
- (BOOL)_processFetchedTransaction:(id)arg1;
- (void)_fetchLegacyTransaction:(id)arg1 forceFetch:(BOOL)arg2 accountCompletionHandler:(id /* CDUnknownBlockType */)arg3 dataCompletionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)fetchLegacyTransaction:(id)arg1 forceFetch:(BOOL)arg2 accountCompletionHandler:(id /* CDUnknownBlockType */)arg3 dataCompletionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)setAccountActiveUpdateCallback:(id /* CDUnknownBlockType */)arg1;
- (void)setDataDecryptionFailedCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)setControllerKeyAvailableNotificationBlock:(id /* CDUnknownBlockType */)arg1;
- (void)setCloudMetadataDeletedNotificationBlock:(id /* CDUnknownBlockType */)arg1;
- (void)setCloudDataDeletedNotificationBlock:(id /* CDUnknownBlockType */)arg1;
- (void)setDataAvailableFromCloudCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)fetchCurrentAccountStateWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)_serverTokenData;
@property(readonly, nonatomic) NSData *serverTokenData;
@property(readonly, nonatomic) BOOL decryptionFailed;
- (void)_resetCloudCache:(id /* CDUnknownBlockType */)arg1;
- (void)resetCloudCache:(id /* CDUnknownBlockType */)arg1;
- (void)_resetCloudServerTokenData;
- (void)resetCloudServerTokenData:(id)arg1;
- (void)_resetCloudDataAndDeleteMetadataForCurrentAccount:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_resetCloudZonesIgnoreHomeManager:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_removeAllHomeZonesCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)resetCloudDataAndDeleteMetadataForCurrentAccount:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchAndVerifyZoneRootRecord:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_uploadLegacyTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)uploadLegacyTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_removeZonesTransactions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)removeZonesTransactions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_uploadTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_checkZoneAndUploadTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_verifyZoneHasBeenDeletedTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_createZoneAndUploadTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)uploadTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchTransaction:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)__deleteRecordWithID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)__deleteRecordZonesWithIDs:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)__deleteRecordZoneWithID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)__saveRecordZone:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)__fetchRecordZoneWithID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)__fetchAllRecordZonesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)__saveSubscription:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)__fetchSubscriptionWithID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
