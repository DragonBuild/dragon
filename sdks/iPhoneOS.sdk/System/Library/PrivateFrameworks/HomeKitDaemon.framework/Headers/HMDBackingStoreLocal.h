...
- (void)_selectAllLog:(id /* CDUnknownBlockType */)arg1;
- (id)_selectLogOptionsWithID:(long long)arg1;
- (id)_insertLogOptionsWithID:(long long)arg1 options:(id)arg2;
- (void)_selectLogWithMask:(long long)arg1 compare:(long long)arg2 callback:(id /* CDUnknownBlockType */)arg3;
- (void)_selectLogWithRoot:(id)arg1 after:(long long)arg2 mask:(long long)arg3 compare:(long long)arg4 callback:(id /* CDUnknownBlockType */)arg5;
- (NSUInteger)_insertLogWithRoot:(id)arg1 transaction:(id)arg2 set:(long long)arg3 error:(id )arg4;
- (void)_selectAllRecords:(id /* CDUnknownBlockType */)arg1;
- (void)_fetchRecordsWithGroupID:(long long)arg1 share:(long long)arg2 names:(id)arg3 callback:(id /* CDUnknownBlockType */)arg4;
- (void)_fetchRecordsWithGroupID:(long long)arg1 share:(long long)arg2 parent:(id)arg3 type:(id)arg4 callback:(id /* CDUnknownBlockType */)arg5;
- (void)_fetchRecordsWithGroupID:(long long)arg1 share:(long long)arg2 parentUuids:(id)arg3 callback:(id /* CDUnknownBlockType */)arg4;
- (id)_fetchRecordWithUUID:(id)arg1 root:(id)arg2 error:(id )arg3;
- (void)_fetchRecordsWithGroupID:(long long)arg1 share:(long long)arg2 uuids:(id)arg3 callback:(id /* CDUnknownBlockType */)arg4;
- (void)_fetchRecordsWithGroupID:(long long)arg1 share:(long long)arg2 callback:(id /* CDUnknownBlockType */)arg3;
