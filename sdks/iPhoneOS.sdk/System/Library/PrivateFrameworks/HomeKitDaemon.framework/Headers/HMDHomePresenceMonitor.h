...
- (void)_updateUserPresence:(id)arg1 presenceAuth:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)handleUserHomePresencePayload:(id)arg1 device:(id)arg2 remoteUserPairingIdentity:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
