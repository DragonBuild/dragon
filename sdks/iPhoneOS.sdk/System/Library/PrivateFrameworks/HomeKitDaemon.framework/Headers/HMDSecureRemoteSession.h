...
- (void)_openServerStreamWithIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_closeClientStream:(id)arg1 error:(id)arg2;
- (void)_openClientStreamWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
