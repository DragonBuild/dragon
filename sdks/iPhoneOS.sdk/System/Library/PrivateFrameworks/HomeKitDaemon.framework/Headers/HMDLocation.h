...
+ (void)timeZoneISOCountryCodeForCLLocationAsync:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)beingConfigured:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)deregisterForRegionUpdate:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)registerForRegionUpdate:(id)arg1 withDelegate:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
