...
// - (void).cxx_destruct;
- (void)_configureTargetAccessories:(id)arg1 reason:(id)arg2 targetAccessories:(id)arg3 responseHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_handleConfigureTargets:(id)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
- (void)handleConfigureTargets:(id)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_listTargetsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)_dataForListTargetsWithOutError:(id )arg1;
- (void)_refreshConfigurationWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_readSupportedConfigurationWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)refreshConfigurationWithCompletion:(id /* CDUnknownBlockType */)arg1;
