...
- (void)_cleanChangesIfNoAddChangeObjectID:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)pingDevice:(id)arg1 secure:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)__startupFirewallRuleManagerForMessage:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_handleAccountAvailabilityChanged:(id /* CDUnknownBlockType */)arg1;
- (void)_updateAccountAvailabilityChanged:(id /* CDUnknownBlockType */)arg1;
...
- (void)_sendHomeDataToWatch:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_sendHomeDataToAllWatches;
- (void)_scheduleSendHomeDataToAllWatches;
- (BOOL)_addWatch:(id)arg1 toAssociatedList:(id)arg2;
- (void)_sendKeysToWatch:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_addWatch:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_eraseLocalHomeConfigurationAndDeleteMetadata:(BOOL)arg1 completionQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_eraseLocalHomeConfigurationAfterSignout;
- (void)_eraseLocalHomeConfiguration;
- (void)_eraseLocalHomeConfigurationCommon;
- (void)_eraseConfiguration:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)processTransactionsFromHomeDataSync:(id)arg1 accessories:(id)arg2 version:(long long)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)_sendUserRemoved:(id)arg1 fromHome:(id)arg2 pairingUsername:(id)arg3 pushToCloud:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)cleanupOperationsForAccessory:(id)arg1 user:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_extractVendorIdentifierFor:(id)arg1 andRun:(id /* CDUnknownBlockType */)arg2;
...
- (void)_getRuntimeStateUpdateForHomeManager:(BOOL)arg1 includeMediaAccessoryState:(BOOL)arg2 options:(NSUInteger)arg3 includeResidentDeviceState:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (id)_runtimeState;
...
- (void)_retryCloudOperationWithName:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_transactionalizeAndApplyHomeData:(id)arg1 cachedHomeData:(id)arg2 syncCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_transactionalizeAndApplyCloudHomeData:(id)arg1 cachedHomeData:(id)arg2 version:(long long)arg3 migrationOptions:(NSUInteger)arg4 dataWasMerged:(BOOL )arg5 syncCompletion:(id /* CDUnknownBlockType */)arg6;
- (id)_deviceForIdentifier:(id)arg1;
- (void)_resumeXPCWithCompletionHanlder:(id /* CDUnknownBlockType */)arg1;
- (void)_suspendXPCWithCompletionHanlder:(id /* CDUnknownBlockType */)arg1;
...
- (void)_updateCloudDataSyncWithAccountState:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_updateCloudDataSyncWithAccountState:(BOOL)arg1;
- (void)forceCloudFetch;
- (void)_requestHomeDataSync;
- (void)_runFetchHomeDataFromCloudWithCloudConflict:(BOOL)arg1 forceFetch:(BOOL)arg2 accountCompletion:(id /* CDUnknownBlockType */)arg3 syncCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)_fetchHomeDataFromCloudWithCloudConflict:(BOOL)arg1 forceFetch:(BOOL)arg2 withDelay:(double)arg3 accountCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)fetchHomeDataFromCloudWithCloudConflict:(BOOL)arg1 withDelay:(double)arg2;
- (void)verifyHomeDataFromCloud:(id /* CDUnknownBlockType */)arg1;
...
- (void)generateAssistantTeamIdentifierWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_determineLegacyLocalChanges:(id /* CDUnknownBlockType */)arg1;
- (void)_determineLocalChangesAndSchedulePush;
- (void)determineLocalChangesAndSchedulePush;
- (void)_handleTransactionsFetched:(id)arg1 stagedTransaction:(id)arg2 mustReplay:(id)arg3 zoneID:(id)arg4 cloudConflict:(BOOL)arg5 transactionError:(id)arg6 syncCompletion:(id /* CDUnknownBlockType */)arg7;
- (void)_handleFetchObjectChange:(id)arg1 home:(id)arg2 isLegacyTransaction:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_handleFetchModifyHome:(id)arg1 isLegacyTransaction:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_runFetchHomeFromCloudZone:(id)arg1 cloudConflict:(BOOL)arg2 syncCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)fetchAllZones;
- (void)_runUploadHomeToCloud:(id)arg1 objectChange:(id)arg2 syncCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_uploadTransaction:(id)arg1 home:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_pushZoneInfromationForHome:(id)arg1;
- (void)_updateModelChangesAsPushed:(id)arg1 home:(id)arg2 pushMask:(NSUInteger)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_loadHomeModelChanges:(id)arg1 mustReplay:(id)arg2 legacyPush:(BOOL)arg3 home:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)_loadHomeManagerHomeModelChanges:(id)arg1 mustReplay:(id)arg2 legacyPush:(BOOL)arg3 home:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (void)_handleHomeManagerTransactionsFetched:(id)arg1 stagedTransaction:(id)arg2 mustReplay:(id)arg3 cloudConflict:(BOOL)arg4 transactionError:(id)arg5 syncCompletion:(id /* CDUnknownBlockType */)arg6;
- (void)_runFetchHomeManagerCloudConflict:(BOOL)arg1 syncCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_updateHomeManagerModelChangesAsPushed:(id)arg1 pushMask:(NSUInteger)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_updateHomeManagerModelChangesAsPushed:(id)arg1 legacyPush:(BOOL)arg2;
- (void)_loadHomeManagerTransactionsToPush:(id)arg1 mustReplay:(id)arg2 forLegacyPush:(BOOL)arg3 includeAllChanges:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)_uploadHomeManagerToCloudSyncCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_processRemoveHomeModels:(id)arg1 processIndex:(NSUInteger)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_uploadHomeManagerToCloudWithDelay:(double)arg1;
- (void)uploadHomeManagerToCloudWithDelay:(double)arg1;
- (void)sendUnsecureMessage:(id)arg1 target:(id)arg2 userID:(id)arg3 responseQueue:(id)arg4 responseHandler:(id /* CDUnknownBlockType */)arg5;
- (void)sendSecureMessage:(id)arg1 target:(id)arg2 userID:(id)arg3 destination:(id)arg4 responseQueue:(id)arg5 responseHandler:(id /* CDUnknownBlockType */)arg6;
- (void)electDeviceForUser:(id)arg1 destination:(id)arg2 deviceCapabilities:(id)arg3 queue:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)sendUserRemoved:(id)arg1 fromHome:(id)arg2 pairingUsername:(id)arg3 pushToCloud:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)sendUserAdded:(id)arg1 destination:(id)arg2 toHome:(id)arg3;
- (void)_postCloudSyncNotificationWithSuccess:(BOOL)arg1;
- (void)_handleAccountStatusDeterminedWithError:(id)arg1 homeDataRecordExists:(BOOL)arg2 metadataRecordExists:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)_startCloudOperationRetryWithTimeout:(NSUInteger)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_runUploadHomeConfigToCloud:(id)arg1 rowIDs:(id)arg2 forcePush:(BOOL)arg3 syncCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)_runUploadHomeConfigToCloudForcePush:(BOOL)arg1 syncCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_pushChangesToWatch:(id)arg1 paylod:(id)arg2 group:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)_sendFragmentedMessage:(id)arg1 messageIndex:(NSUInteger)arg2 messageIdentity:(id)arg3 userID:(id)arg4 destination:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
...
- (void)sendFragmentedMessageForData:(id)arg1 objectUUID:(id)arg2 withMessageName:(id)arg3 toUser:(id)arg4 destination:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
