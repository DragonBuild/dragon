...
- (void)confirmWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_confirmResidentDevice:(id)arg1 electionParameters:(id)arg2 againstDevices:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)_electResidentDevice;
- (void)electResidentDevice;
- (void)__currentDeviceUpdated:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
