...
- (void)mediaContentProfileAccessControlModelRemoved:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)mediaContentProfileAccessControlModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)assistantAccessControlModelRemoved:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)assistantAccessControlModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
@property(readonly, copy) HMBModel *assistantAccessControlModelToReset;
- (void)handleRemovedAccessory:(id)arg1;
- (void)handleMediaContentProfileAccessControlUpdatedAccessoryUUIDs:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)handleAssistantAccessControlAccessoryUUIDsUpdated:(id)arg1 requireAuthenticationForSecureRequests:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
