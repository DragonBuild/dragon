...
- (void)_handleWriteMediaProperties:(NSDictionary )arg1 source:(NSUInteger)arg2 requestMessage:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)redispatchMediaWriteRequests:(id)arg1 viaDevice:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_handleMediaPropertiesRead:(id)arg1;
- (void)_handleReadMediaProperties:(NSDictionary )arg1 source:(NSUInteger)arg2 message:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)redispatchMediaReadRequests:(id)arg1 viaDevice:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)migrateCloudZone:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_migrateHomeObjectCloudZone:(id)arg1 defaultModel:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_migrateHomeUsersCloudZone:(id)arg1 migrationQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_migrateHomeMediaSettingsCloudZone:(id)arg1 migrationQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_migrateHomeSettingsCloudZone:(id)arg1 migrationQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_migrateResidentDevicesCloudZone:(id)arg1 migrationQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)cleanChangesIfNoAddChangeObjectID:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)validateDuetEventIdentifiers:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)accessoryBrowser:(id)arg1 setupID:(id)arg2 serverIdentifier:(id)arg3 isPairedWithCompletionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)accessoryBrowser:(id)arg1 accessoryServer:(id)arg2 isBlockedWithCompletionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_notifyRetrievalError:(id)arg1 accessoryServer:(id)arg2 linkType:(long long)arg3 accessoryOperationBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)accessoryBrowser:(id)arg1 didFindAccessoryServer:(id)arg2 stateChanged:(BOOL)arg3 stateNumber:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (void)_retrieveHAPAccessoryForHMDAccessory:(id)arg1 linkType:(long long)arg2 queue:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)retrieveHAPAccessoryForHMDAccessory:(id)arg1 linkType:(long long)arg2 queue:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)_readCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(NSUInteger)arg3 withCompletionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)readCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(NSUInteger)arg3 withCompletionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)_readCharacteristicValuesForAccessories:(id)arg1 readRequestMap:(id)arg2 responseTuples:(id)arg3 requestMessage:(id)arg4 viaDevice:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (id)_getLogEventsForOperation:(BOOL)arg1 accessories:(id)arg2 requestMap:(id)arg3 identifier:(id)arg4 source:(NSUInteger)arg5;
- (void)readCharacteristicValues:(id)arg1 identifier:(id)arg2 isSPIEntitled:(BOOL)arg3 source:(NSUInteger)arg4 withCompletionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_performOperation:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_writeCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(NSUInteger)arg3 withCompletionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)_writeCharacteristicValuesForAccessories:(id)arg1 writeRequestMap:(id)arg2 responseTuples:(id)arg3 requestMessage:(id)arg4 viaDevice:(id)arg5 source:(NSUInteger)arg6 completionHandler:(id /* CDUnknownBlockType */)arg7;
- (id)_applyDeviceLockCheck:(id)arg1 forSource:(NSUInteger)arg2;
- (void)writeCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 identifier:(id)arg3 withCompletionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_notifyChangedCharacteristics:(id)arg1 identifier:(id)arg2 multiPartResponse:(BOOL)arg3 moreMessagesInMultipart:(BOOL)arg4 requestMessage:(id)arg5 withCompletionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)_sendClientCharacteristicsChangedNotification:(id)arg1 identifier:(id)arg2 entitledClientsOnly:(BOOL)arg3 multiPartResponse:(BOOL)arg4 moreMessagesInMultipart:(BOOL)arg5 withCompletionHandler:(id /* CDUnknownBlockType */)arg6;
...
- (void)__handleAcceptedOutgoingInvitationResponse:(id)arg1 destinationAddress:(id)arg2 publicKey:(id)arg3 username:(id)arg4 presenceAuthStatus:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
...
- (void)_removeAllUsersFromAccessory:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_processAccessoriesToAddForUnpairedAccessory:(id)arg1 certificationStatus:(long long)arg2 accessoryServer:(id)arg3 networkCredential:(id)arg4 message:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)_processLegacyPairingRequestForMessage:(id)arg1 cancelPairing:(BOOL)arg2;
- (void)_cancelPairingWithAccessoryUUID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (id /* CDUnknownBlockType */)_setupCodeProviderForMessage:(id)arg1;
- (void)_presentPairingPasswordDialogForAccessory:(id)arg1 setupCodeAvailable:(id /* CDUnknownBlockType */)arg2;
- (void)_retrieveStateForTrackedAccessory:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)dispatchRequestToEvaluateCondition:(id)arg1 forCharacteristics:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)evaluateNotificationConditionForCharacteristics:(id)arg1 homePresence:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)reevaluateAccessoryInfo;
- (void)_reevaluateAccessoryInfoWithBadgeRefresh:(BOOL)arg1;
- (void)_notifyClientsOfAccessoryInfoUpdatedForAccessories:(id)arg1 shouldRefreshBadge:(BOOL)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)notifyClientsOfAccessoryInfoUpdatedForAccessories:(id)arg1;
- (void)_removeAllHomeContentsAndAccessoryPairings:(BOOL)arg1 queue:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_removeAccessory:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)removeAccessory:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_removeReachableAccessory:(id)arg1 hapAccessory:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_removeAccessoriesForPrimaryAccessory:(id)arg1 error:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_sendRemoveCompletionStatusForHMDAccessories:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 error:(id)arg3;
- (void)_notifyClientOfNewlyAddedAccessories:(id)arg1 requestMessage:(id)arg2;
- (void)_sharedAdminDidFailToAddAccessories:(id)arg1;
- (void)_notifyOwnerOfAddedAccessories:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_removeWithMergeSecondaryAccessory:(id)arg1 removedFromBridgeAccessory:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)removeWithMergeSecondaryAccessory:(id)arg1 removedFromBridgeAccessory:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_pairAccessoryWithAccessoryDescription:(id)arg1 configuration:(id)arg2 pairingEvent:(id)arg3 progressHandler:(id /* CDUnknownBlockType */)arg4 requestMessage:(id)arg5;
...
- (void)notifyClientOfVendorInfoUpdatedForManufacturers:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_getRunTimeStateUpdateWithOptions:(NSUInteger)arg1 includeMediaAccessoryState:(BOOL)arg2 includeResidentDeviceState:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (id)residentDevicesIncludingRemoteGateways;
- (void)getRunTimeStateUpdateWithOptions:(NSUInteger)arg1 includeMediaAccessoryState:(BOOL)arg2 includeResidentDeviceState:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)handleBackgroundTaskAgentJob:(id)arg1;
- (void)checkTimerTriggers;
- (id)migrateOwnedTriggers;
- (void)writeCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 transactionId:(id)arg3 withCompletionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)removeAllHomeContentsAndAccessoryPairings:(BOOL)arg1 queue:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_removeClientConfigurationWithIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_removeClientConfigurationWithIdentifier:(id)arg1;
- (void)_requestUniquePSKClientConfigurationWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_createUniquePSKClientConfigurationWithRequestMessage:(id)arg1 pairingEvent:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
