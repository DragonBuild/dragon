...
- (BOOL)_fetchClipsAfterDate:(id)arg1 beforeDate:(id)arg2 error:(id )arg3 handler:(id /* CDUnknownBlockType */)arg4;
- (void)_notifyTransportsOfUpdatedClips:(id)arg1 removedClipUUIDs:(id)arg2;
- (void)_notifyTransport:(id)arg1 ofFetchedClips:(id)arg2 forFetchUUID:(id)arg3 responseHandler:(id /* CDUnknownBlockType */)arg4;
