...
// - (void).cxx_destruct;
- (void)cameraProfileSettingsManager:(id)arg1 canDisableRecordingWithCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)cameraProfileSettingsManager:(id)arg1 canEnableRecordingWithCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (id)initWithAccessory:(id)arg1 services:(id)arg2 msgDispatcher:(id)arg3 settingsManager:(id)arg4 workQueue:(id)arg5 recordingManagerFactory:(id /* CDUnknownBlockType */)arg6;
