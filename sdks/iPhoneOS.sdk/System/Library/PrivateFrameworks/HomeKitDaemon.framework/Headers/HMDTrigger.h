...
- (void)_executeActionSets:(id)arg1 captureCurrentState:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_executeActionSetsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_activate:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)activateAfterResidentChangeWithCompletion:(id /* CDUnknownBlockType */)arg1;
