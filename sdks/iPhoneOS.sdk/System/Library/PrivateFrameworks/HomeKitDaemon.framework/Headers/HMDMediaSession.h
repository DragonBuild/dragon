...
- (void)writeProperties:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)readProperties:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_setPlaybackState:(long long)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_queueSetPlaybackStateCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_getPlaybackStateWithCompletion:(id /* CDUnknownBlockType */)arg1;
