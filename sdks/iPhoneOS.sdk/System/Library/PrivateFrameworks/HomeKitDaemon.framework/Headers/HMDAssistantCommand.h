...
- (void)performWithGather:(id)arg1 queue:(id)arg2 msgDispatcher:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)handleGetColor:(id)arg1 forObjects:(id)arg2 serviceType:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)handleSetColor:(id)arg1 forObjects:(id)arg2 service:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)handleCommandWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_handleCommandForHAPAction:(id)arg1 serviceType:(id)arg2 objects:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_handleCommandForMediaAccessoryAction:(id)arg1 objects:(id)arg2 serviceType:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)handleUpdateActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)handleSetActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (id)compareForBoundary:(id)arg1 withMetadata:(id)arg2;
- (id)compareCurrentValue:(id)arg1 newValue:(id)arg2 withMetadata:(id)arg3;
- (void)handleGetActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)handleMediaAccessorySetActionType:(id)arg1 forObjects:(id)arg2 withServiceType:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)handleGetMetadataActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)executeActionSet:(id)arg1 action:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)actionOutcomeFromError:(id)arg1;
- (void)returnResults:(id)arg1 serviceType:(id)arg2 forAction:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)reportUnlockRequired:(id /* CDUnknownBlockType */)arg1;
- (void)reportResults:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)reportOutcome:(id)arg1 results:(id)arg2 handler:(id /* CDUnknownBlockType */)arg3;
