...
- (void)accessoryServer:(id)arg1 isBlockedWithCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_checkDelegatesofBlockedAccessoryServer:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)accessoryServer:(id)arg1 promtDialog:(id)arg2 forNotCertifiedAccessory:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)accessoryServerBrowser:(id)arg1 getCacheForAccessoryWithIdentifier:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_sendPairingCompletionStatusForServer:(id)arg1 error:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_pairAccessory:(id)arg1 configuration:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_pairAccessoryWithDescription:(id)arg1 configuration:(id)arg2 progressHandler:(id /* CDUnknownBlockType */)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_checkDelegatesOfAccessoryWithSetupID:(id)arg1 serverIdentifier:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)handleStartDiscoveringAssociatedMediaAccessories:(BOOL)arg1 forTransport:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_startDiscoveringPairedAccessories;
- (void)_discoverAccessoryServer:(id)arg1 linkType:(long long)arg2 errorHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)pairAccessoryWithDescription:(id)arg1 configuration:(id)arg2 progressHandler:(id /* CDUnknownBlockType */)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)pairAccessory:(id)arg1 configuration:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)registerProgressHandler:(id /* CDUnknownBlockType */)arg1 unpairedAccessoryUUID:(id)arg2;
...
- (void)requestPermissionToAssociateWACAccessory:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)probeReachabilityForBTLEAccessoryServersWithIdentifiers:(id)arg1 onQueue:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_reprovisionAccessoryWithIdentifier:(id)arg1 wiFiPSK:(id)arg2 countryCode:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)reprovisionAccessoryWithIdentifier:(id)arg1 wiFiPSK:(id)arg2 countryCode:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)activate:(BOOL)arg1;
- (void)discoverAccessoryServer:(id)arg1 linkType:(long long)arg2 errorHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)retrieveCurrentStateForIdentifer:(id)arg1 onQueue:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
