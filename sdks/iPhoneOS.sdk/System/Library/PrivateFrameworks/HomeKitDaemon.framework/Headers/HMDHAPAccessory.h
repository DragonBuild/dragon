...
- (void)makeServiceNameConsistent:(id)arg1 withName:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)readInitialRequiredCharacteristicsForBTLEAccessory:(id /* CDUnknownBlockType */)arg1;
...
- (void)_handleMultipleCharacteristicsUpdated:(id)arg1 message:(id)arg2 completionQueue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)handleMultipleCharacteristicsUpdated:(id)arg1 message:(id)arg2 completionQueue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (id)characteristicsPassingTest:(id /* CDUnknownBlockType */)arg1;
...
- (void)_evaluateLocalOperation:(long long)arg1 state:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_enableNotification:(BOOL)arg1 forCharacteristics:(id)arg2 hapAccessory:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)_disableNotificationsForBundleID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)disableNotificationsForBundleID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_readCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_writeCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)_readCharacteristicValues:(id)arg1 localOperationRequired:(BOOL)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5 errorBlock:(id /* CDUnknownBlockType */)arg6;
- (void)autoUpdateCachedCountDownCharacteristics:(id)arg1;
- (void)readCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 queue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)_writeCharacteristicValues:(id)arg1 localOperationRequired:(BOOL)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5 errorBlock:(id /* CDUnknownBlockType */)arg6;
- (void)writeCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 queue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (BOOL)canWakeBasedOnCharacteristic:(id)arg1;
@property(readonly) BOOL supportsUserManagement;
- (void)_performOperation:(long long)arg1 linkType:(long long)arg2 operationBlock:(id /* CDUnknownBlockType */)arg3 errorBlock:(id /* CDUnknownBlockType */)arg4;
- (void)performOperation:(long long)arg1 linkType:(long long)arg2 operationBlock:(id /* CDUnknownBlockType */)arg3 errorBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)unconfigure;
- (void)configureWithAccessory:(id)arg1 homeNotificationsEnabled:(BOOL)arg2 queue:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)_removeHAPAccessoryWithServerIdentifier:(id)arg1 linkType:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3 completionQueue:(id)arg4;
- (void)removeHAPAccessoryWithServerIdentifier:(id)arg1 linkType:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3 completionQueue:(id)arg4;
- (void)removeRelayUser:(id)arg1 queue:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)addRelayUser:(id)arg1 accessToken:(id)arg2 queue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)_configureTargetControllerWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)verifyPairingWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (BOOL)isPrimary;
...
- (void)_readandWriteToCurrentTime:(id)arg1 errorBlock:(id /* CDUnknownBlockType */)arg2;
...
- (BOOL)initiateScan:(id /* CDUnknownBlockType */)arg1;
...
- (void)writeValue:(id)arg1 toCharacteristic:(id)arg2 queue:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (id)assistantObject;
- (id)url;
...
- (void)getSupportedSiriAudioConfiguration:(id /* CDUnknownBlockType */)arg1;
...
- (void)startBulkSendSessionForFileType:(id)arg1 queue:(id)arg2 callback:(id /* CDUnknownBlockType */)arg3;
...
- (void)cancelPowerOn;
- (void)_cancelPowerOn;
- (void)wirelessPowerOn:(id /* CDUnknownBlockType */)arg1;
- (void)_wirelessPowerOn:(id /* CDUnknownBlockType */)arg1;
