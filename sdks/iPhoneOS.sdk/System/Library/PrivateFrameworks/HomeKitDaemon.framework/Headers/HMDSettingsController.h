...
// - (void).cxx_destruct;
- (void)transactionSettingConstraintModelRemoved:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)transactionSettingConstraintModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)transactionSettingModelRemoved:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)transactionSettingModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)transactionSettingGroupModelRemoved:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)transactionSettingGroupModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)loadWithModels:(id)arg1;
- (void)encodeWithCoder:(id)arg1;
- (void)migrateSettingsWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)handleAddedConstraintModel:(id)arg1 shouldNotify:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)handleAddedConstraintModel:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)handleAddedSettingModel:(id)arg1 shouldNotify:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)handleAddedSettingModel:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)handleAddedGroupModel:(id)arg1 shouldNotify:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)handleAddedGroupModel:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_handleAddedRootGroup:(id)arg1;
- (void)updateWithValue:(id)arg1 onSetting:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)updateWithValue:(id)arg1 onSettingIdentifier:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)updateWithEncodedValue:(id)arg1 onSettingIdentifier:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
