...
- (void)_startSessionForFileType:(id)arg1 queue:(id)arg2 callback:(id /* CDUnknownBlockType */)arg3;
- (void)startSessionForFileType:(id)arg1 queue:(id)arg2 callback:(id /* CDUnknownBlockType */)arg3;
...
- (void)_startSessionCandidate:(id)arg1 queue:(id)arg2 callback:(id /* CDUnknownBlockType */)arg3;
...
- (void)asyncBulkSendSessionCandidate:(id)arg1 didAcceptOnQueue:(id)arg2 callback:(id /* CDUnknownBlockType */)arg3;
...
- (id)initWithQueue:(id)arg1 accessory:(id)arg2 logIdentifier:(id)arg3 bulkSendSessionContextFactory:(id /* CDUnknownBlockType */)arg4;
