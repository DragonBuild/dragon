...
- (void)_startRecordingSessionForTrigger:(NSUInteger)arg1 homePresenceByPairingIdentity:(id)arg2 reason:(id)arg3 completionCallback:(id /* CDUnknownBlockType */)arg4;
- (BOOL)_canAnyDeviceStartRecordingSession;
- (void)handleStartRecordingSessionRequest:(id)arg1;
- (void)_startRecordingSessionForTrigger:(NSUInteger)arg1 homePresenceByPairingIdentity:(id)arg2 reason:(id)arg3;
- (void)_createRecordingSessionForTrigger:(NSUInteger)arg1 homePresenceByPairingIdentity:(id)arg2;
