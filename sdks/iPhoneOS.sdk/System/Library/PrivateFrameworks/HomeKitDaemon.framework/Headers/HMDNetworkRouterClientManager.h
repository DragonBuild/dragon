...
- (void)_registerInterestForFirewallRulesForAccessory:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_fetchFirewallRulesForAccessory:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_getNetworkConfigurationForAccessory:(id)arg1 targetProtectionMode:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3;
