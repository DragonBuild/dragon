...
- (void)sendMessage:(id)arg1 toDevices:(id)arg2 timeout:(double)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)confirmDevice:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
