...
- (void)enumerateCorrectionEntriesForWord:(id)arg1 maxCorrections:(NSUInteger)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
- (void)enumerateCompletionEntriesForPrefix:(id)arg1 maxCompletions:(NSUInteger)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)enumerateEntriesForString:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (id)createCursor;
