...
- (void)addPlayerStatusObserver:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)_notifyPlaybackTimeChange:(CDStruct_198678f7)arg1;
- (void)addPlaybackTimeObserver:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)_notifyPlaybackRateChange:(float)arg1;
- (void)addPlaybackRateObserver:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
