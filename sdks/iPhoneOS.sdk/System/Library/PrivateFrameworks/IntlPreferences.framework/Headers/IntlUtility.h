...
+ (void)setPreferredLanguage:(id)arg1 forBundleID:(id)arg2 andRelaunchWithCompletion:(id /* CDUnknownBlockType */)arg3;
...
+ (void)enumeratePreferredCalendarsForLocaleID:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
