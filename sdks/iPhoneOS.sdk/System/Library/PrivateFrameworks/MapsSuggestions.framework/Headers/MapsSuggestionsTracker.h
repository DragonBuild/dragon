...
// - (void).cxx_destruct;
- (void)_shiftLocation:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2 callbackQueue:(id)arg3;
- (void)_prepareShiftForLocation:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2 withShiftRequestBlock:(id /* CDUnknownBlockType */)arg3;
- (id)location;
