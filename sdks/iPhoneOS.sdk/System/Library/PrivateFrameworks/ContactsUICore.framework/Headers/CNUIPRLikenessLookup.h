...
+ (id)observableFromLikenessProviderBlock:(id /* CDUnknownBlockType */)arg1 withScheduler:(id)arg2;
...
- (id)resolveLikenessesForContacts:(id)arg1 workScheduler:(id)arg2 withContentHandler:(id /* CDUnknownBlockType */)arg3;
