...
// - (void).cxx_destruct;
- (int)_timeoutTimerStart:(int)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (int)_startBonjourWithTimeout:(int)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (void)setPromptForSetupCodeHandler:(id /* CDUnknownBlockType */)arg1;
