...
- (void)_performSingleiCSCRecoveryWithSecret:(id)arg1 type:(NSUInteger)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_handleMultiCSCRecoveryResults:(id)arg1 clique:(id)arg2 type:(NSUInteger)arg3 secret:(id)arg4 device:(id)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)_handleRecoveryFailureForFinalDevice:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_attemptToRecoverWithRecoveryKey:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_attemptToRecoverDevice:(id)arg1 withSecret:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
