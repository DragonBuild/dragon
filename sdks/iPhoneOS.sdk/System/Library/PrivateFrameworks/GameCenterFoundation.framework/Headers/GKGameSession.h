...
+ (void)removeSessionWithIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)loadSessionWithIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)loadSessionsInContainer:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)createSessionInContainer:(id)arg1 withTitle:(id)arg2 maxConnectedPlayers:(long long)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
+ (void)getSessionsForZone:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
+ (void)getZonesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)clearBadgeForPlayers:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)sendMessageWithLocalizedFormatKey:(id)arg1 arguments:(id)arg2 data:(id)arg3 toPlayers:(id)arg4 badgePlayers:(BOOL)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)sendData:(id)arg1 withTransportType:(long long)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)playersWithConnectionState:(long long)arg1;
- (void)setConnectionState:(long long)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
