...
- (void)chooseBestHostingPlayerWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)chooseBestHostPlayerWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)withEventQueueForPlayer:(id)arg1 create:(id /* CDUnknownBlockType */)arg2 perform:(id /* CDUnknownBlockType */)arg3;
- (void)withEventQueueForPlayer:(id)arg1 createIfNeeded:(BOOL)arg2 perform:(id /* CDUnknownBlockType */)arg3;
- (void)withEventQueueForPlayer:(id)arg1 perform:(id /* CDUnknownBlockType */)arg2;
