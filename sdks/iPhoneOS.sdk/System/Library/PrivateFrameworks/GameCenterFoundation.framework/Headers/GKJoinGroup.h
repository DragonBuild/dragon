...
- (void)applyUpdates;
- (void)wait;
- (void)joinRight:(id /* CDUnknownBlockType */)arg1;
- (void)joinLeft:(id /* CDUnknownBlockType */)arg1;
- (void)join:(id /* CDUnknownBlockType */)arg1;
- (void)aggregateJoinRight:(id /* CDUnknownBlockType */)arg1;
- (void)aggregateJoinLeft:(id /* CDUnknownBlockType */)arg1;
- (void)aggregateJoin:(id /* CDUnknownBlockType */)arg1;
- (void)_join:(id /* CDUnknownBlockType */)arg1;
- (void)performRight:(id /* CDUnknownBlockType */)arg1;
- (void)performLeft:(id /* CDUnknownBlockType */)arg1;
- (void)performRightOnQueue:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)performLeftOnQueue:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)dealloc;
