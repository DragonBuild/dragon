...
- (void)updateSavedGameDocumentsForQueryWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)loadDataForSavedGame:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
