...
+ (void)authenticateWithUsername:(id)arg1 password:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
+ (void)authenticatedLocalPlayersDidChange:(id)arg1 complete:(id /* CDUnknownBlockType */)arg2;
...
- (void)acceptFriendRequestWithIdentifier:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)cancelFriendRequestWithIdentifier:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)createFriendRequestWithIdentifier:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)getPlayerIDFromFriendCode:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)generateIdentityVerificationSignatureWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)loadDefaultLeaderboardCategoryIDWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)loadDefaultLeaderboardIdentifierWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)setDefaultLeaderboardCategoryID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)setDefaultLeaderboardIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)removeAllFriendsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)removeFriend:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (void)updateLoginStatus:(NSUInteger)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)loadFriendsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)loadRecentPlayersWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)loadChallengableFriendsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)loadFriendPlayersWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_loadFriendPlayersWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)friends;
...
- (void)setStatus:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)resolveConflictingSavedGames:(id)arg1 withData:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)deleteSavedGamesWithName:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)saveGameData:(id)arg1 withName:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)fetchSavedGamesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
