...
// - (void).cxx_destruct;
- (void)_sendEvent:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)performOnAnalyticsQueueWithDelay:(long long)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)registerQueriableMetric:(unsigned int)arg1 callback:(id /* CDUnknownBlockType */)arg2;
