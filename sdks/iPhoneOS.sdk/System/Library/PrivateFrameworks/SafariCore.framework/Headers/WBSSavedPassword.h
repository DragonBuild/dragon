...
+ (void)enumerateRangesMatchingPatternWithTokenizer:(struct __CFStringTokenizer )arg1 string:(id)arg2 pattern:(id)arg3 matchingType:(long long)arg4 withBlock:(id /* CDUnknownBlockType */)arg5;
