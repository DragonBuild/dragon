...
- (void)_internalQueue_performPaymentWithAmount:(id)arg1 requestToken:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)performPaymentWithAmount:(id)arg1 requestToken:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
