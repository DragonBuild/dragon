...
// - (void).cxx_destruct;
- (void)_executeStatementForQuery:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (void)saveTraceWithHandler:(id /* CDUnknownBlockType */)arg1;
- (void)saveTraceSynchronously;
- (void)cancelTrace;
- (void)saveTrace;
- (void)startWritingTraceToFileAtPath:(id)arg1 shouldPrepareStatements:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)startWritingTraceToFileAtPath:(id)arg1;
- (void)startWritingTraceToFile;
- (void)startWritingTraceToFileWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)startWritingTraceToFileIfNecessaryWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_closeTraceDB;
...
- (void)_dispatchWrite:(id /* CDUnknownBlockType */)arg1;
@property(nonatomic) BOOL copyToCrashReporterDirectory;
- (void)dealloc;
- (id)initWithPath:(id)arg1 clMapMatching:(BOOL)arg2 errorHandler:(id /* CDUnknownBlockType */)arg3;
- (void)startWritingTraceToPath:(id)arg1 withErrorHandler:(id /* CDUnknownBlockType */)arg2;
- (void)openForRecordingWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
- (id)init;
