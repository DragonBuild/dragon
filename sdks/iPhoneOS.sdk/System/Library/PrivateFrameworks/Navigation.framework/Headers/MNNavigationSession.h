...
- (void)guidanceManager:(id)arg1 announce:(id)arg2 shortPromptType:(NSUInteger)arg3 ignorePromptStyle:(BOOL)arg4 stage:(NSUInteger)arg5 hasSecondaryManeuver:(BOOL)arg6 completionBlock:(id /* CDUnknownBlockType */)arg7;
...
- (void)locationTracker:(id)arg1 receivedTrafficIncidentAlert:(id)arg2 responseCallback:(id /* CDUnknownBlockType */)arg3;
