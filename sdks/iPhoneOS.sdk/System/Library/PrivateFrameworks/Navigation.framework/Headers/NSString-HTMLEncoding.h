...
+ (id)_navigation_selectInstructionWithServerStringArray:(id)arg1 isSpoken:(BOOL)arg2 clientBlock:(id /* CDUnknownBlockType */)arg3;
+ (id)_navigation_selectInstructionWithServerString:(id)arg1 isSpoken:(BOOL)arg2 clientBlock:(id /* CDUnknownBlockType */)arg3;
