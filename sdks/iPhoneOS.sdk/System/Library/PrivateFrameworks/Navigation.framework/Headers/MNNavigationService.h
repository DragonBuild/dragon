...
- (void)vibrateForPrompt:(NSUInteger)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)repeatCurrentTrafficAlert:(id /* CDUnknownBlockType */)arg1;
- (void)repeatCurrentGuidance:(id /* CDUnknownBlockType */)arg1;
