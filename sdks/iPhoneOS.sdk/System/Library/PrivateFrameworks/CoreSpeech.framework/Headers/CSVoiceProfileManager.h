...
// - (void).cxx_destruct;
- (void)_createAndSendImplicitUtterenceXPCMessage:(id)arg1 withRecordDeviceInfo:(id)arg2 withRecordCtxt:(id)arg3 withVoiceTriggerCtxt:(id)arg4 withOtherCtxt:(id)arg5 withCompletion:(id /* CDUnknownBlockType */)arg6;
...
- (void)isVoiceProfileUploadedToiCloudForLanguageCode:(id)arg1 withCompletionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (id)_prepareVoiceProfileWithSiriProfileId:(id)arg1 withUploadBlock:(id /* CDUnknownBlockType */)arg2;
- (id)_copyVoiceProfileAtPath:(id)arg1 toPath:(id)arg2;
- (void)_copySATFilesFromPath:(id)arg1 toPath:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)uploadUserVoiceProfileForSiriProfileId:(id)arg1 withUploadTrigger:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_downloadVoiceProfileForProfileId:(id)arg1 forDeviceCategory:(NSUInteger)arg2 withDownloadTriggerBlock:(id /* CDUnknownBlockType */)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (id)_downloadAndEnrollVoiceProfileForProfileId:(id)arg1 withDownloadTriggerBlock:(id /* CDUnknownBlockType */)arg2;
- (void)notifyUserVoiceProfileUpdateReady;
- (void)notifyUserVoiceProfileDownloadReadyForUser:(id)arg1 getData:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)getUserVoiceProfileUpdateDirectory;
- (void)notifyImplicitTrainingUtteranceAvailable:(id)arg1 forVoiceProfileId:(id)arg2 withRecordDeviceInfo:(id)arg3 withRecordCtxt:(id)arg4 withVoiceTriggerCtxt:(id)arg5 withOtherCtxt:(id)arg6 withCompletion:(id /* CDUnknownBlockType */)arg7;
- (id)CSSATBasePath;
- (id)baseDir;
- (BOOL)isSATAvailable;
