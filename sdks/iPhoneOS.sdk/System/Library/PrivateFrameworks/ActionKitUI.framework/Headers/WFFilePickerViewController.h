...
- (void)loadView;
- (id)initWithPath:(id)arg1 selectedFiles:(id)arg2 service:(id)arg3 mode:(long long)arg4 allowsMultipleSelection:(BOOL)arg5 pickCompletionHandler:(id /* CDUnknownBlockType */)arg6 saveCompletionHandler:(id /* CDUnknownBlockType */)arg7;
- (id)initForSavingFilesAtPath:(id)arg1 service:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)initForPickingFilesAtPath:(id)arg1 service:(id)arg2 allowsMultipleSelection:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
