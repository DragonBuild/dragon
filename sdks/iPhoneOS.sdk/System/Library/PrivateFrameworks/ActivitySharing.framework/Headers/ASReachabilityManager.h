...
- (void)queryDestinations:(id)arg1 updateHandler:(id /* CDUnknownBlockType */)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_addDestinationsToQuery:(id)arg1 updateHandler:(id /* CDUnknownBlockType */)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
