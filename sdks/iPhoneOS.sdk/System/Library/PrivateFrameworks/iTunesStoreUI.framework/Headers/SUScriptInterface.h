...
- (void)_dismissSafariViewControllerAnimated:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_getSoftwareApplicationWithCompletionFunction:(id)arg1 lookupBlock:(id /* CDUnknownBlockType */)arg2;
