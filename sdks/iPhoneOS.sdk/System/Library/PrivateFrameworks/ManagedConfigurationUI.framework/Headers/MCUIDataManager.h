...
- (void)reloadAppSignersAndBlockedAppsInBackgroundWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)reloadProfilesInBackgroundWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_reloadQueueReloadDataInBackgroundIncludingProfiles:(BOOL)arg1 appSigners:(BOOL)arg2 blockedApplications:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)reloadDataInBackgroundIncludingProfiles:(BOOL)arg1 appSigners:(BOOL)arg2 blockedApplications:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)reloadAllDataInBackgroundWithCompletion:(id /* CDUnknownBlockType */)arg1;
