...
- (void)_removePhoneProfileWithIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_removeWatchProfileWithIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_showCPLFinalInstallationWarning:(id /* CDUnknownBlockType */)arg1 withMDMWarning:(BOOL)arg2;
- (id)_localizedCPLFinalWarningString;
- (void)_showMDMFinalInstallationWarning:(id /* CDUnknownBlockType */)arg1;
- (void)_showFinalInstallationWarning:(id /* CDUnknownBlockType */)arg1;
...
- (void)_signInMAID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)installProfileRemotelyWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
