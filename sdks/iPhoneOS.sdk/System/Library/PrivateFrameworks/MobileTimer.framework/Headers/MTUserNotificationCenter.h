...
- (void)interruptAudioAndLockDeviceWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)postNotificationForScheduledAlarm:(id)arg1 content:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
