...
- (void)repeatTimerWithIdentifier:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)dismissTimerWithIdentifier:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)removeTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)updateTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)addTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
