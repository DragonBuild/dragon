...
+ (id)_timerTimeForState:(NSUInteger)arg1 remainingTime:(double)arg2 currentDateProvider:(id /* CDUnknownBlockType */)arg3;
...
- (id)initWithState:(NSUInteger)arg1 duration:(double)arg2 currentDateProvider:(id /* CDUnknownBlockType */)arg3;
