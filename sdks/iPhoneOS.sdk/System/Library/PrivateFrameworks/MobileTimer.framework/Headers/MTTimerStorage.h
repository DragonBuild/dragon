...
- (void)_queue_repeatTimerWithIdentifier:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)_queue_dismissTimerWithIdentifier:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)_queue_removeTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (id)_queue_updateTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)_queue_addTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)repeatTimerWithIdentifier:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)dismissTimerWithIdentifier:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)removeTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)updateTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)addTimer:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2 source:(id)arg3;
- (void)getTimersWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_createDefaultTimerIfNeededWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_loadTimersWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)loadTimersSync;
- (void)loadTimers;
- (void)dealloc;
