...
+ (void)generateThumbnailOfMaximumSize:(CGSize)arg1 scale:(double)arg2 forURL:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
+ (id)sharedGenerator;
+ (void)initialize;
...
- (void)_performInBatch:(id /* CDUnknownBlockType */)arg1;
- (void)performInBatch:(id /* CDUnknownBlockType */)arg1;
- (BOOL)_cancelRequestIfNeeded:(id)arg1;
- (void)cancelRequest:(id)arg1;
- (void)saveBestRepresentationForRequest:(id)arg1 toFileAtURL:(id)arg2 withContentType:(id)arg3 allowingThumbnailDownloads:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)saveBestRepresentationForRequest:(id)arg1 toFileAtURL:(id)arg2 withContentType:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)synchronousGenerateThumbnailForRequest:(id)arg1 updateHandler:(id /* CDUnknownBlockType */)arg2 statusHandler:(id /* CDUnknownBlockType */)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)generateThumbnailForRequest:(id)arg1 updateHandler:(id /* CDUnknownBlockType */)arg2 statusHandler:(id /* CDUnknownBlockType */)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)generateRepresentationsForRequest:(id)arg1 updateHandler:(id /* CDUnknownBlockType */)arg2;
- (void)generateBestRepresentationForRequest:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)init;
