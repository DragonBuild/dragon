...
+ (void)iterateLogsWithOptions:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
...
+ (id)createForSubmission:(id)arg1 metadata:(id)arg2 options:(id)arg3 error:(id )arg4 writing:(id /* CDUnknownBlockType */)arg5;
