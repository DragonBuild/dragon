...
- (void)dealloc;
- (void)queueUnregisterForPropertyChanges:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (void)unregisterForPropertyChanges:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (void)queueRegisterForPropertyChanges:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (void)registerForPropertyChanges:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (id)propertyNames;
