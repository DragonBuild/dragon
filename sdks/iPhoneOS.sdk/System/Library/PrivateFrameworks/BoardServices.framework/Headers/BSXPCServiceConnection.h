...
- (void)_lock_enqueueConnectionEstablishedEvent:(id /* CDUnknownBlockType */)arg1;
- (void)_lock_enqueueChildActivateEvent:(id /* CDUnknownBlockType */)arg1 forHandoff:(id)arg2;
- (void)_lock_associateNewChildConnection:(id)arg1;
- (void)_lock_disconnect;
- (void)_lock_invalidate;
- (id)_lock_createMessageWithParent:(id)arg1;
- (BOOL)_lock_activateNowOrWhenReady:(id /* CDUnknownBlockType */)arg1 withParent:(id)arg2;
- (id)_eventHandler;
...
- (BOOL)activateNowOrWhenReady:(id /* CDUnknownBlockType */)arg1;
