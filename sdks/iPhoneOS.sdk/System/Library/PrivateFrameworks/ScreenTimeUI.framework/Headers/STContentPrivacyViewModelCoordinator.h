...
// - (void).cxx_destruct;
- (void)saveRestrictionValue:(id)arg1 forItem:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)saveValuesForRestrictions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)saveCommunicationLimits:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)saveContentPrivacyEnabled:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
