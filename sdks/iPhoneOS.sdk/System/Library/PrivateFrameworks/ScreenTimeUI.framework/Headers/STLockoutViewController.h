...
- (void)_showRestrictionsPINControllerWithMainCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_fadeInBackdropWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_fadeOutBackdropWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_unlockWithSuccessMainCompletion:(id /* CDUnknownBlockType */)arg1;
