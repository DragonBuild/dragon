...
- (BOOL)prerollVideoAtRate:(float)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (BOOL)seekVideoPlayerToTime:(CDStruct_1b6d18a9)arg1 toleranceBefore:(CDStruct_1b6d18a9)arg2 toleranceAfter:(CDStruct_1b6d18a9)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (BOOL)seekVideoPlayerToTime:(CDStruct_1b6d18a9)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)setVideoVolume:(float)arg1;
- (void)setVideoPlayRate:(float)arg1;
- (void)setOutputInfo:(id)arg1 withTransitionOptions:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
