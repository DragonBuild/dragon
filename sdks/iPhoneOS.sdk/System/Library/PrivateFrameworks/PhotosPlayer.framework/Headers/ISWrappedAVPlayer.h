...
- (void)prerollAtRate:(float)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)replaceCurrentItemWithPlayerItem:(id)arg1 thenCall:(id /* CDUnknownBlockType */)arg2;
...
- (id)addBoundaryTimeObserverForTimes:(id)arg1 queue:(id)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)_performPlayerTransaction:(id /* CDUnknownBlockType */)arg1;
