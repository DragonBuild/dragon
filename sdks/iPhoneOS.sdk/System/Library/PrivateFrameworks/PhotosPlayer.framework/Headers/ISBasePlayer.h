...
- (void)behavior:(id)arg1 playVideoToTime:(CDStruct_1b6d18a9)arg2 initialRate:(float)arg3 overDuration:(double)arg4 progressHandler:(id /* CDUnknownBlockType */)arg5;
- (void)behavior:(id)arg1 removeTimeObserver:(id)arg2;
- (id)behavior:(id)arg1 addBoundaryTimeObserverForTimes:(id)arg2 queue:(id)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
...
- (BOOL)behavior:(id)arg1 prerollVideoAtRate:(float)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)behavior:(id)arg1 seekVideoPlayerToTime:(CDStruct_1b6d18a9)arg2 toleranceBefore:(CDStruct_1b6d18a9)arg3 toleranceAfter:(CDStruct_1b6d18a9)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (BOOL)behavior:(id)arg1 seekVideoPlayerToTime:(CDStruct_1b6d18a9)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (float)videoPlayRate;
- (void)behavior:(id)arg1 setVideoPlayRate:(float)arg2;
- (void)behavior:(id)arg1 didSetOutputInfo:(id)arg2 withTransitionOptions:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)enumerateOutputsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)applyOutputInfo:(id)arg1 fromBehavior:(id)arg2 withTransitionOptions:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
