...
- (void)loadImageSetAsync:(long long)arg1 preheat:(BOOL)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)loadContentAsyncWithCompletion:(id /* CDUnknownBlockType */)arg1;
