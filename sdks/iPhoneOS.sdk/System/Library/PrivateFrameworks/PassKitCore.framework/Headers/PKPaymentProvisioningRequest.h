...
// - (void).cxx_destruct;
- (void)_updateContextUsingWebService:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_deviceScoreWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_requestBodyWithWebService:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_urlRequestWithServiceURL:(id)arg1 deviceIdentifier:(id)arg2 appleAccountInformation:(id)arg3 certChain:(id)arg4 devSigned:(BOOL)arg5 deviceData:(id)arg6 webService:(id)arg7 completion:(id /* CDUnknownBlockType */)arg8;
