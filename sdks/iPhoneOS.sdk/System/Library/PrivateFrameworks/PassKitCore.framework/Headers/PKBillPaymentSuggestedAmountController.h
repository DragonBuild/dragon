...
+ (void)previousStatementSelectedSuggestedAmountEventsForAccount:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
+ (void)currentStatementSelectedSuggestedAmountEventsForAccount:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
+ (void)_approvedTransactionsForPreviousStatementForAccount:(id)arg1 transactionType:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3;
+ (void)_approvedTransactionsSinceStatementForAccount:(id)arg1 transactionType:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3;
+ (void)approvedTransactionsPurchasesSinceStatementForAccount:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
+ (void)approvedTransactionsPurchasesForPreviousStatementForAccount:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
+ (void)approvedTransactionsBillPaymentForPreviousStatementForAccount:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
+ (void)approvedTransactionsBillPaymentSinceStatementForAccount:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
+ (void)defaultControllerForAccount:(id)arg1 paymentPass:(id)arg2 configuration:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
