...
- (void)_coreRecentsContactsForPreference:(id)arg1 queue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)_labelsToPropertiesDictionaryForContact:(id)arg1;
- (void)meCardEntriesForPreference:(id)arg1 queue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)meCardEntriesForPreference:(id)arg1;
- (void)deleteAllRecentsWithCallbackQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)_contactFromRecent:(id)arg1 preference:(id)arg2;
- (id)_postalAddressLabeledValueFromRecent:(id)arg1;
- (void)deleteRecent:(id)arg1;
- (void)deleteRecentsForPreference:(id)arg1 callbackQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)recentsForPreference:(id)arg1 queue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
