...
- (void)preflightPasscodeUpgradeWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_downloadMoreInfoItemURLs:(id)arg1 withMetadata:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_provisioningNonceWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)removeProvisionedPass;
- (void)locationManager:(id)arg1 didUpdateLocations:(id)arg2;
- (BOOL)_isValidLocation:(id)arg1;
- (void)_loadMoreInfoItemForMarket:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_startLocationSearchWithTimeout:(double)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_verifyPassIsSupportedForExpressInLocalMarket:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_ingestPaymentPass:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)_requestProvisioning:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)ingestPaymentPassForCredential:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)declineTerms;
- (void)acceptTerms;
- (void)_requestEligibility:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_requestRequirements:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)requestRequirements:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_queryEligibilityForCredential:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_queryRequirementsForCredential:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)_filterPaymentSetupProducts:(id)arg1;
- (void)_setupAccountCredentialForProvisioning:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)setupAccountCredentialForProvisioning:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)setupProductForProvisioning:(id)arg1 includePurchases:(BOOL)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)requestPurchasesForProduct:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)requestProvisioningMethodMetadataForProduct:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)_mockBrowseBanksResponse;
- (void)browsableBankAppsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)updatePaymentSetupProductModelWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_informDelegatesOfPaymentPassUpdateOnCredential:(id)arg1;
- (void)_downloadRemoteAssetsForPaymentPass:(id)arg1 paymentCredential:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_updateCredentialWithPaymentPassAssets:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_updateCredentialWithPaymentPass:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_associateCredential:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (BOOL)_credentialIsValidForSetupConfiguration:(id)arg1;
- (BOOL)_hasSetupConfiguration;
- (void)_associateCredentials:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)associateCredentials:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)updateRemoteCredentials:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)retrieveAllAvailableCredentials:(id /* CDUnknownBlockType */)arg1;
- (BOOL)_featureApplicationInValidStateToPresent:(id)arg1;
- (void)setupFeatures:(id /* CDUnknownBlockType */)arg1;
- (void)_addAccountToProductMatchingFeatureIdentifier:(NSUInteger)arg1;
- (id)_fetchOrCreateProductsForIdentifier:(NSUInteger)arg1;
- (void)retrieveAccountCredentials:(id /* CDUnknownBlockType */)arg1;
- (id)_supportedFeatureIdentifierStringsForAccountProvisioning;
- (id)_supportedFeatureIdentifierStrings;
- (void)retrieveRemoteCredentials:(id /* CDUnknownBlockType */)arg1;
- (void)performDeviceCheckInIfNeeded:(id /* CDUnknownBlockType */)arg1;
- (id)_doesDisplayableErrorConstitutePreflightFailure:(id)arg1;
- (void)preflightWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)validatePreconditionsRegisterAndAssociateRemoteCredentials:(id /* CDUnknownBlockType */)arg1;
- (void)validatePreconditionsAndRegister:(id /* CDUnknownBlockType */)arg1;
- (void)registerDevice:(id /* CDUnknownBlockType */)arg1;
- (void)validatePreconditions:(id /* CDUnknownBlockType */)arg1;
