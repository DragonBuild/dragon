...
- (id)_queue_cancelRemotePaymentRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_queue_addThumbnailCompletionHandler:(id /* CDUnknownBlockType */)arg1 forKey:(id)arg2;
...
- (id)requestInstrumentThumbnail:(id)arg1 forRemoteDevice:(id)arg2 size:(CGSize)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (id)cancelRemotePaymentRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)sendPaymentStatus:(long long)arg1 forRemotePaymentRequest:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)sendPaymentResult:(id)arg1 forRemotePaymentRequest:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)sendPayment:(id)arg1 forRemotePaymentRequest:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)sendPaymentClientUpdate:(id)arg1 forRemotePaymentRequest:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)sendPaymentHostUpdate:(id)arg1 forRemotePaymentRequest:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)sendRemotePaymentRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)sendSetupRequest:(id)arg1 appDisplayName:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
