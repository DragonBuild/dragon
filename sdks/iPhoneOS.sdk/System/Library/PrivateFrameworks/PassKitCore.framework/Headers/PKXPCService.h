...
// - (void).cxx_destruct;
- (id /* CDUnknownBlockType */)_newErrorHandlerWithSemaphore:(id)arg1;
- (id /* CDUnknownBlockType */)_newWrappedErrorHandlerForHandler:(id /* CDUnknownBlockType */)arg1;
...
- (id)existingSynchronousRemoteObjectProxyWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
- (id)synchronousRemoteObjectProxyWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
- (id)existingRemoteObjectProxyWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
...
- (id)remoteObjectProxyWithFailureHandler:(id /* CDUnknownBlockType */)arg1;
