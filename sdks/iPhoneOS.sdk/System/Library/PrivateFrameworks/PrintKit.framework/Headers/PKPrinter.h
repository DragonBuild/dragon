...
- (void)setupWithOptions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)validatePassCode:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)showPassCodeForSetupWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)cancelUnlock;
- (void)unlockWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)getSupplyLevels:(id /* CDUnknownBlockType */)arg1;
