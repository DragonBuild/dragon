...
- (void)encodeRequestData:(id)arg1 startRequestCallback:(id /* CDUnknownBlockType */)arg2;
...
- (void)pause;
- (void)cancel;
- (void)_performOnDelegateQueue:(id /* CDUnknownBlockType */)arg1;
- (void)_cancelNoNotify;
- (void)_start;
- (void)start;
- (void)_serializePayload:(id /* CDUnknownBlockType */)arg1;
