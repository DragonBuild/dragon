...
- (void)handleIdentityRequestWithMetadata:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)handlePeerCertificateTrustEvaluationWithMetadata:(id)arg1 trust:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)writeClose;
- (void)write:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)readMinimumLength:(NSUInteger)arg1 maximumLength:(NSUInteger)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)readLength:(NSUInteger)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)cancel;
