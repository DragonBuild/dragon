...
- (void)performDatabaseOperation:(NSUInteger)arg1 onLibrary:(id)arg2 withAttributes:(id)arg3 options:(id)arg4 fromClient:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
...
- (id)beginTransactionForLibrary:(id)arg1 withClient:(id)arg2 options:(NSUInteger)arg3 error:(id )arg4;
- (id)description;
- (void)dealloc;
- (id)init;
