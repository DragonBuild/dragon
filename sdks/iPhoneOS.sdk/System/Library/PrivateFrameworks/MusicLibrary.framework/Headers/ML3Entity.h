...
+ (void)enumeratePersistentIDsInLibrary:(id)arg1 afterRevision:(long long)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
...
+ (void)enumeratePersistentIDsInLibrary:(id)arg1 matchingPredicate:(id)arg2 orderingTerms:(id)arg3 persistentIDs:(const long long )arg4 count:(NSUInteger)arg5 options:(long long)arg6 usingBlock:(id /* CDUnknownBlockType */)arg7;
...
- (void)setValues:(id)arg1 forProperties:(id)arg2 async:(BOOL)arg3 withCompletionBlock:(id /* CDUnknownBlockType */)arg4;
