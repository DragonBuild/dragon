...
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(BOOL)arg2 sectionProperty:(id)arg3 cancelBlock:(id /* CDUnknownBlockType */)arg4 usingBlock:(id /* CDUnknownBlockType */)arg5;
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(BOOL)arg2 cancelBlock:(id /* CDUnknownBlockType */)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(BOOL)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
- (void)enumeratePersistentIDsAndSectionsWithProperty:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumeratePersistentIDsAndProperties:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)loadNamesFromLibrary:(id)arg1 onConnection:(id)arg2 forPredicate:(id)arg3 loadAllNames:(BOOL)arg4 cancelHandler:(id /* CDUnknownBlockType */)arg5;
