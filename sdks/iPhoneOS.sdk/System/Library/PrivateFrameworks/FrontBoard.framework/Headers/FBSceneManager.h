...
+ (void)synchronizeChanges:(id /* CDUnknownBlockType */)arg1;
...
- (void)scene:(id)arg1 handleUpdateToSettings:(id)arg2 withTransitionContext:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)scene:(id)arg1 enumerateAndCalloutToObserversWithEventName:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
- (void)_executeNextIdleEventIfAppropriate;
- (void)_executeEventWhenIdle:(id)arg1;
- (void)_enqueueObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 preferInternal:(BOOL)arg3 sceneObserverBlock:(id /* CDUnknownBlockType */)arg4 sceneManagerObserverBlock:(id /* CDUnknownBlockType */)arg5;
- (void)_enqueueObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 sceneObserverBlock:(id /* CDUnknownBlockType */)arg3 sceneManagerObserverBlock:(id /* CDUnknownBlockType */)arg4;
- (void)_enqueueSceneObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_enqueueSceneManagerObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_enqueueSceneManagerInternalObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_enqueueEventForScene:(id)arg1 withName:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
- (id)_eventForScene:(id)arg1 withName:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
...
- (void)_updateScene:(id)arg1 withSettings:(id)arg2 transitionContext:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_applyMutableSettings:(id)arg1 toScene:(id)arg2 withTransitionContext:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (id)_createSceneWithDefinition:(id)arg1 initialParameters:(id)arg2 clientProvider:(id)arg3 transitionContext:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (id)scenesPassingTest:(id /* CDUnknownBlockType */)arg1;
