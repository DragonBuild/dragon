...
// - (void).cxx_destruct;
- (void)_dispatchClientMessageWithBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)updateSettings:(id)arg1 withTransitionContext:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_invalidateWithTransitionContext:(id)arg1;
- (void)_setContentState:(long long)arg1;
- (void)_applyUpdateWithContext:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)updateUISettingsWithTransitionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)updateUISettingsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (id)uiClientSettings;
- (id)uiSettings;
