...
- (void)server:(id)arg1 didReceiveSceneRequestWithOptions:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (id)_server;
- (id)_queue;
- (void)_queue_enumerateScenes:(id /* CDUnknownBlockType */)arg1;
