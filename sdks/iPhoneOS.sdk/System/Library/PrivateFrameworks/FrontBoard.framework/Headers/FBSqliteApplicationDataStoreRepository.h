...
- (void)_dbQueue_performWithSavepoint:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (BOOL)_dbQueue_executeStatement:(id)arg1 bindings:(id)arg2 resultRowHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_dbQueue_executeStatement:(id)arg1 bindings:(id)arg2 resultRowHandler:(id /* CDUnknownBlockType */)arg3 error:(out id )arg4;
