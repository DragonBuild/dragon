...
- (id)stats;
- (BOOL)isInMemory;
- (void)writeTransactionWithClient:(unsigned char)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)readTransactionWithClient:(unsigned char)arg1 block:(id /* CDUnknownBlockType */)arg2;
