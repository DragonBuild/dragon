...
- (int)registerQueryPlanLoggingChangeHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_triggerDelayedOperationWithCoalescingToken:(_Atomic int )arg1 operation:(id /* CDUnknownBlockType */)arg2;
...
- (int)registerDisabledBundleIdentifierChangeHandler:(id /* CDUnknownBlockType */)arg1;
