...
+ (id)defaultStorage;
// - (void).cxx_destruct;
- (id /* CDUnknownBlockType */)postalAddressFilterWithQuery:(id)arg1;
- (id /* CDUnknownBlockType */)phoneFilterWithQuery:(id)arg1;
- (id /* CDUnknownBlockType */)nameFilterWithQuery:(id)arg1;
- (id /* CDUnknownBlockType */)emailFilterWithQuery:(id)arg1;
...
- (void)_namesRecordsForAllFoundInAppsContactsWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (id)_contactsFullTextSearchWithQuery:(id)arg1 explanationSet:(id)arg2 error:(id )arg3 filter:(id /* CDUnknownBlockType */)arg4;
...
- (id)_foundInAppsContactsQueryWithTerm:(id)arg1 explanationSet:(id)arg2 error:(id )arg3 filter:(id /* CDUnknownBlockType */)arg4;
