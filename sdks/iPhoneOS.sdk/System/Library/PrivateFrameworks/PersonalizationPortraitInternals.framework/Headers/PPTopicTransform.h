...
- (void)_enumerateSparseColumnAtIndex:(unsigned int)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)_enumerateSparseRowAtIndex:(unsigned int)arg1 block:(id /* CDUnknownBlockType */)arg2;
