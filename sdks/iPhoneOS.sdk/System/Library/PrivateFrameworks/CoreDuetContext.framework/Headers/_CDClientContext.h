...
- (NSDictionary )valuesForKeyPaths:(id)arg1 synchronous:(BOOL)arg2 responseQueue:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)valuesForKeyPaths:(id)arg1 responseQueue:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (NSDictionary )valuesForKeyPaths:(id)arg1;
- (id)valuesForKeyPaths:(id)arg1 inContextsMatchingPredicate:(id)arg2;
- (id)localContext;
- (BOOL)addObjects:(id)arg1 andRemoveObjects:(id)arg2 fromArrayAtKeyPath:(id)arg3 synchronous:(BOOL)arg4 responseQueue:(id)arg5 withCompletion:(id /* CDUnknownBlockType */)arg6;
- (void)addObjects:(id)arg1 andRemoveObjects:(id)arg2 fromArrayAtKeyPath:(id)arg3 responseQueue:(id)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (BOOL)addObjects:(id)arg1 andRemoveObjects:(id)arg2 fromArrayAtKeyPath:(id)arg3;
- (BOOL)removeObjects:(id)arg1 fromArrayAtKeyPath:(id)arg2 synchronous:(BOOL)arg3 responseQueue:(id)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (void)removeObjects:(id)arg1 fromArrayAtKeyPath:(id)arg2 responseQueue:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (BOOL)removeObjects:(id)arg1 fromArrayAtKeyPath:(id)arg2;
- (BOOL)addObjects:(id)arg1 toArrayAtKeyPath:(id)arg2 synchronous:(BOOL)arg3 responseQueue:(id)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (void)addObjects:(id)arg1 toArrayAtKeyPath:(id)arg2 responseQueue:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (BOOL)addObjects:(id)arg1 toArrayAtKeyPath:(id)arg2;
- (BOOL)setObject:(id)arg1 forContextualKeyPath:(id)arg2 synchronous:(BOOL)arg3 responseQueue:(id)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (void)setObject:(id)arg1 forContextualKeyPath:(id)arg2 responseQueue:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (BOOL)setObject:(id)arg1 forContextualKeyPath:(id)arg2;
- (BOOL)setObject:(id)arg1 forKeyedSubscript:(id)arg2;
- (void)handleRegistrationCompleted:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)handleContextualChange:(id)arg1 info:(id)arg2 handler:(id /* CDUnknownBlockType */)arg3;
...
- (void)retryTimes:(int)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (id)lastModifiedDateForContextualKeyPath:(id)arg1 synchronous:(BOOL)arg2 responseQueue:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)lastModifiedDateForContextualKeyPath:(id)arg1 responseQueue:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (id)lastModifiedDateForContextualKeyPath:(id)arg1;
- (id)objectForKeyedSubscript:(id)arg1;
- (id)objectForContextualKeyPath:(id)arg1 synchronous:(BOOL)arg2 responseQueue:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)objectForContextualKeyPath:(id)arg1 responseQueue:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
