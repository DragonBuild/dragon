...
- (id)register:(id)arg1 createDefinitionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (id)unsafeRegisterForKey:(id)arg1 name:(id)arg2 factory:(id /* CDUnknownBlockType */)arg3;
- (id)registerKey:(id)arg1 factory:(id /* CDUnknownBlockType */)arg2;
- (id)registerProtocol:(id)arg1 name:(id)arg2 factory:(id /* CDUnknownBlockType */)arg3;
- (id)registerProtocol:(id)arg1 factory:(id /* CDUnknownBlockType */)arg2;
- (id)registerClass:(Class)arg1 name:(id)arg2 factory:(id /* CDUnknownBlockType */)arg3;
- (id)registerClass:(Class)arg1 factory:(id /* CDUnknownBlockType */)arg2;
