...
- (void)triggerOnAnyEvent:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)triggerOnEvent:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)triggerOnceWhenAnyEventHasOccurred:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)triggerAlwaysWhenAllEventsHaveOccurred:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (void)triggerOnceWhenAllEventsHaveOccurred:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
