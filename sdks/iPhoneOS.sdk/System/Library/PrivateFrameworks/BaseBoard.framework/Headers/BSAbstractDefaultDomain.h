...
- (id)observeDefaults:(id)arg1 onQueue:(id)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
- (id)observeDefault:(id)arg1 onQueue:(id)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
