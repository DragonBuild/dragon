...
- (void)_preventTransactionCompletionForReason:(id)arg1 ignoringAuditHistory:(BOOL)arg2 andExecuteBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_notifyObserversOfCompletion;
- (void)_notifyObserversOfFinishedWork;
- (BOOL)_evaluateParentTransactionsWithSchedulingPolicy:(NSUInteger)arg1 evaluator:(id /* CDUnknownBlockType */)arg2;
...
- (void)_unsafe_enumerateChildTransactionsWithBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)_unsafe_enumerateParentTransactionsWithBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)listenForSatisfiedMilestone:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (void)evaluateMilestone:(id)arg1 withEvaluator:(id /* CDUnknownBlockType */)arg2;
...
- (void)registerBlockObserver:(id /* CDUnknownBlockType */)arg1;
