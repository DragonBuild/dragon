...
- (id)initWithContentHostDirectory:(id)arg1 processVariant:(NSUInteger)arg2 accessQueue:(id)arg3 fetchQueue:(id)arg4 sessionProvider:(id /* CDUnknownBlockType */)arg5;
- (id)initWithContentContext:(id)arg1 processVariant:(NSUInteger)arg2 accessQueue:(id)arg3 fetchQueue:(id)arg4 sessionProvider:(id /* CDUnknownBlockType */)arg5;
- (id)init;
