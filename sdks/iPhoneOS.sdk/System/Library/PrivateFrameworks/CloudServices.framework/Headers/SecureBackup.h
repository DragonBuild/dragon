...
// - (void).cxx_destruct;
- (void)getCertificates:(id /* CDUnknownBlockType */)arg1;
- (id)beginHSA2PasscodeRequest:(BOOL)arg1 uuid:(id)arg2 error:(id )arg3;
- (id)beginHSA2PasscodeRequest:(BOOL)arg1 error:(id )arg2;
- (void)prepareHSA2EscrowRecordContents:(BOOL)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (id)srpRecoveryBlobFromSRPInitResponse:(id)arg1;
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;
- (id)srpInitNonce;
- (void)setBackOffDateWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)backOffDateWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (id)backupWithInfo:(id)arg1;
- (void)changeSMSTargetWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (id)changeSMSTargetWithInfo:(id)arg1;
- (BOOL)changeSMSTargetWithError:(id )arg1;
- (void)getCountrySMSCodesWithInfo:(id)arg1 completionBlockWithResults:(id /* CDUnknownBlockType */)arg2;
- (void)startSMSChallengeWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)startSMSChallengeWithInfo:(id)arg1 completionBlockWithResults:(id /* CDUnknownBlockType */)arg2;
- (id)startSMSChallengeWithInfo:(id)arg1 results:(id )arg2;
- (id)startSMSChallengeWithError:(id )arg1;
- (void)uncachePassphraseWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (id)uncachePassphraseWithInfo:(id)arg1;
- (void)cachePassphraseWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (id)cachePassphraseWithInfo:(id)arg1;
- (void)stashRecoveryDataWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)recoverWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)updateMetadataWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (id)updateMetadataWithInfo:(id)arg1;
- (BOOL)updateMetadataWithError:(id )arg1;
- (void)getAccountInfoWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)stateCaptureWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)notificationInfo:(id /* CDUnknownBlockType */)arg1;
- (void)setBackOffDateWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)backOffDateWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)backupWithInfo:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)changeSMSTargetWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)getCountrySMSCodesWithResults:(id /* CDUnknownBlockType */)arg1;
- (void)startSMSChallengeWithResults:(id /* CDUnknownBlockType */)arg1;
- (void)uncachePassphrase;
- (void)uncacheRecoveryKeyWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)cacheRecoveryKeyWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)uncachePassphraseWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)cachePassphraseWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)cachePassphrase;
- (void)updateMetadataWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)stashRecoveryDataWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)disableWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)recoverRecordContents:(id /* CDUnknownBlockType */)arg1;
- (void)recoverWithResults:(id /* CDUnknownBlockType */)arg1;
- (void)enableWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)getAccountInfoWithResults:(id /* CDUnknownBlockType */)arg1;
