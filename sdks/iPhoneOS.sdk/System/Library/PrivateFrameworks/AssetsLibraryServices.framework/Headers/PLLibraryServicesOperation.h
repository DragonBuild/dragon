...
+ (id)operationWithName:(id)arg1 requiredState:(long long)arg2 parentProgress:(id)arg3 execution:(id /* CDUnknownBlockType */)arg4;
...
- (id)debugDescription;
- (void)setExecutionBlockFromOperationBlock:(id /* CDUnknownBlockType */)arg1;
- (void)dealloc;
- (id)init;
