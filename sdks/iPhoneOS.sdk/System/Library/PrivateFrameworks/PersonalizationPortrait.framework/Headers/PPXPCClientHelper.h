...
- (void)dealloc;
- (id)initWithServiceName:(id)arg1 whitelistedServerInterface:(id)arg2 whitelistedClientInterface:(id)arg3 clientExportedObject:(id)arg4 interruptionHandler:(id /* CDUnknownBlockType */)arg5 invalidationHandler:(id /* CDUnknownBlockType */)arg6;
