...
- (oneway void)async_observedProcessStatesDidChange:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (oneway void)async_assertionWillInvalidate:(id)arg1;
- (oneway void)async_assertionsDidInvalidate:(id)arg1 withError:(id)arg2;
- (oneway void)async_didChangeInheritances:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_subscribeToProcessDeath:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)subscribeToProcessDeath:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (id)observeProcessAssertionsExpirationWarningWithBlock:(id /* CDUnknownBlockType */)arg1;
