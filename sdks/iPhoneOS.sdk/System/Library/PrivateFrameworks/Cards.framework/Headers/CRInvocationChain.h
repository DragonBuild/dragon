...
- (void)_enumerateChainedObjectsUsingBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)_accessChainedObjectsSafely:(id /* CDUnknownBlockType */)arg1;
- (BOOL)isEligibleForSelector:(SEL)arg1;
- (void)enumerateChainedObjectsUsingBlock:(id /* CDUnknownBlockType */)arg1;
