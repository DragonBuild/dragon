...
- (void)_removeInvitation:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_removeUser:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_stopSharingWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_stopSharing;
- (void)_reinvite;
