...
// - (void).cxx_destruct;
- (void)deleteZoneWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)dumpAllRecordsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)saveKey:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)loadKeyWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)overwriteFilesWithRecords:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)readFilesWithRecordIDs:(id)arg1 forColumns:(id)arg2 priority:(NSUInteger)arg3 withCompletionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)generateKeyWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)keyboardUsed;
...
- (void)modifyInformationWithOperations:(id /* CDUnknownBlockType */)arg1;
- (id)information;
- (void)disable;
- (void)dealloc;
- (id)init;
