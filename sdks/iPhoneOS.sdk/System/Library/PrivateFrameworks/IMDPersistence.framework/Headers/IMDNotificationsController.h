...
+ (id)_displayNameForHandle:(struct _IMDHandleRecordStruct )arg1 andContact:(id)arg2 suggestionProvider:(id /* CDUnknownBlockType */)arg3;
...
- (NSUInteger)screenTimeNotificationOptionsForChatDictionary:(id)arg1;
...
- (void)_proceedMostActiveDevice:(BOOL)arg1 isBlockCalled:(BOOL )arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_isMostActiveDeviceWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
