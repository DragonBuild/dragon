...
- (void)moveAttachmentsForTransfer:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)saveAttachmentsForTransfer:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
