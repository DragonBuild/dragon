...
- (BOOL)performOnOpenParentFileDescriptor:(id /* CDUnknownBlockType */)arg1 error:(int )arg2;
- (BOOL)performOnOpenFileDescriptor:(id /* CDUnknownBlockType */)arg1 error:(int )arg2;
- (BOOL)flock:(int)arg1;
