...
- (id)_setOfParentIDs;
- (void)_ascendItemHierarchyWithBlock:(id /* CDUnknownBlockType */)arg1;
...
- (NSUInteger)maskForDiffsToSyncUpForZone:(id)arg1 sideCarZone:(BOOL)arg2 whenClearing:(BOOL)arg3;
