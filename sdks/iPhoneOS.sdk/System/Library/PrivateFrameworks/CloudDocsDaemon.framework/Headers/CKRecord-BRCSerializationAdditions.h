...
- (void)serializeSideCarInfo:(id)arg1 filenameExtension:(id)arg2 diffs:(NSUInteger)arg3 deadInServerTruth:(BOOL)arg4;
- (void)serializeVersion:(id)arg1 diffs:(NSUInteger)arg2 deadInServerTruth:(BOOL)arg3;
- (void)serializeStatInfo:(id)arg1 diffs:(NSUInteger)arg2 stageID:(id)arg3 deadInServerTruth:(BOOL)arg4 shouldPCSChainStatus:(unsigned char)arg5;
