...
- (NSUInteger)didSyncDownRequestID:(NSUInteger)arg1 serverChangeToken:(id)arg2 editedRecords:(id)arg3 deletedRecordIDs:(id)arg4 deletedShareRecordIDs:(id)arg5 movedZoneNames:(id)arg6 allocRankZones:(id )arg7 syncStatus:(long long)arg8 savedDirectly:(BOOL )arg9;
- (NSUInteger)_saveInconsistentStateWithRequestID:(NSUInteger)arg1 serverChangeToken:(id)arg2 editedRecords:(id)arg3 deletedRecordIDs:(id)arg4 deletedShareRecordIDs:(id)arg5 syncStatus:(long long)arg6;
