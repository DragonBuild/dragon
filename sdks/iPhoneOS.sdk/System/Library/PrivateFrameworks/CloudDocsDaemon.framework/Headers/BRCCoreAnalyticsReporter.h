...
+ (BOOL)uploadErrorsAsIndividualEvents:(id)arg1 syncType:(id)arg2 totalItemsCount:(NSUInteger)arg3 zoneType:(id)arg4 zoneCountsOnly:(BOOL)arg5 isFolderSharingEnabled:(BOOL)arg6;
