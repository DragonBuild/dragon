...
- (id)objectForKey:(id)arg1 inheritFromGlobal:(BOOL)arg2 validateWithBlock:(id /* CDUnknownBlockType */)arg3;
- (id)_serverDefaultForKey:(id)arg1;
- (id)_loadObjectForKey:(id)arg1 inheritFromGlobal:(BOOL)arg2 validateWithBlock:(id /* CDUnknownBlockType */)arg3;
