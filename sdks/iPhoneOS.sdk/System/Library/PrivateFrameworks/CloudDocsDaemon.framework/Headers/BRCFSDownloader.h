...
- (void)transferStreamOfSyncContext:(id)arg1 didBecomeReadyWithMaxRecordsCount:(NSUInteger)arg2 sizeHint:(NSUInteger)arg3 priority:(long long)arg4 completionBlock:(id /* CDUnknownBlockType */)arg5;
...
- (NSUInteger)_bumpThrottleForDownload:(id)arg1 throttle:(id)arg2;
