...
- (void)suspend;
- (void)resume;
- (void)scheduleWithBatchSize:(int)arg1 whereSQLClause:(NSObject )arg2 columns:(id)arg3 actionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (NSUInteger)postponeJobID:(id)arg1 withThrottle:(id)arg2;
...
- (id)descriptionForJobsMatching:(id)arg1 ordering:(id)arg2 additionalColumns:(id)arg3 additionalValuesHandler:(id /* CDUnknownBlockType */)arg4 context:(id)arg5;
