...
// - (void).cxx_destruct;
- (void)_t_resetAllZones:(id)arg1 waitUntilIdle:(BOOL)arg2 reply:(id /* CDUnknownBlockType */)arg3;
...
- (void)_setupAppLibraryAndZoneWithID:(id)arg1 recreateDocumentsIfNeeded:(BOOL)arg2 reply:(id /* CDUnknownBlockType */)arg3;
- (void)_startDownloadItemsAtURLs:(id)arg1 pos:(NSUInteger)arg2 options:(NSUInteger)arg3 error:(id)arg4 reply:(id /* CDUnknownBlockType */)arg5;
- (void)_addExternalDocumentReferenceTo:(id)arg1 underParent:(id)arg2 forceReparent:(BOOL)arg3 reply:(id /* CDUnknownBlockType */)arg4;
...
- (void)accessLogicalOrPhysicalURL:(id)arg1 accessKind:(long long)arg2 dbAccessKind:(long long)arg3 asynchronously:(BOOL)arg4 handler:(id /* CDUnknownBlockType */)arg5;
