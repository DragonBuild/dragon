...
// - (void).cxx_destruct;
- (void)waitForCrossZoneMoveProcessingWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)performBlock:(id /* CDUnknownBlockType */)arg1 whenSyncDownCompletesLookingForItemID:(id)arg2;
- (void)_cancelSyncDownFromDBCorruption;
- (void)_prepareForForegroundSyncDown;
- (void)performBlock:(id /* CDUnknownBlockType */)arg1 whenItemWithIDIsDownloaded:(id)arg2;
- (void)performBlock:(id /* CDUnknownBlockType */)arg1 whenItemWithIDIsOnDisk:(id)arg2;
- (id /* CDUnknownBlockType */)popDownloadedBlockForItemID:(id)arg1;
- (id /* CDUnknownBlockType */)popOnDiskBlockForItemID:(id)arg1;
...
- (void)_t_notifyClient:(id)arg1 whenIdle:(id /* CDUnknownBlockType */)arg2;
- (void)notifyClient:(id)arg1 afterNextSyncDown:(id /* CDUnknownBlockType */)arg2;
...
- (void)_createCloudKitZoneWithGroup:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)createCloudKitZoneWithGroup:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_enumerateFaultsWithBlock:(id /* CDUnknownBlockType */)arg1 rowID:(NSUInteger)arg2 batchSize:(NSUInteger)arg3;
- (void)enumerateFaultsAsyncWithBlock:(id /* CDUnknownBlockType */)arg1 batchSize:(NSUInteger)arg2;
...
- (void)scheduleResetServerAndClientTruthsForReason:(const char )arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (id)ownerName;
- (void)_finishedReset:(NSUInteger)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_mkdirAppLibraryIfNeeded:(id)arg1;
- (id)_cancelAllOperationsForReset;
- (void)_performAfterResetServerAndClientTruthsAndUnlinkDataAndPurgeTheZone:(id /* CDUnknownBlockType */)arg1;
- (void)_performAfterResetServerAndClientTruthsAndUnlinkData:(id /* CDUnknownBlockType */)arg1;
- (void)_performAfterResetServerAndClientSharedTruthsAndUnlinkData:(id /* CDUnknownBlockType */)arg1;
- (void)_performAfterResetServerAndClientPrivateTruthsAndUnlinkData:(id /* CDUnknownBlockType */)arg1;
- (void)_performResetAndWantsUnlink:(BOOL)arg1 clientTruthBlock:(id /* CDUnknownBlockType */)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (BOOL)supportsKeepingClientItemsDuringReset;
- (void)_removeTargetedAliasesWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_reset:(NSUInteger)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)scheduleReset:(NSUInteger)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
