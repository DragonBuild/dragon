...
// - (void).cxx_destruct;
- (void)scheduleRenameOfItemAtURL:(id)arg1 toItemAtURL:(id)arg2 contentUpdate:(BOOL)arg3 queue:(id)arg4 taskTracker:(id)arg5 accessor:(id /* CDUnknownBlockType */)arg6;
- (void)scheduleUpdateOfItemAtURL:(id)arg1 queue:(id)arg2 taskTracker:(id)arg3 accessor:(id /* CDUnknownBlockType */)arg4;
- (void)scheduleDeleteOfItemAtURL:(id)arg1 queue:(id)arg2 taskTracker:(id)arg3 accessor:(id /* CDUnknownBlockType */)arg4;
- (void)scheduleReadOfItemAtURL:(id)arg1 queue:(id)arg2 taskTracker:(id)arg3 accessor:(id /* CDUnknownBlockType */)arg4;
- (void)_didObtainCoordination:(id)arg1 context:(id)arg2 url1:(id)arg3 url2:(id)arg4 handler:(id /* CDUnknownBlockType */)arg5 fcHandler:(id /* CDUnknownBlockType */)arg6 error:(id)arg7;
- (void)_willRequestCoordinationWithContext:(id)arg1 url1:(id)arg2 url2:(id)arg3;
- (void)cancelAfterDelay:(double)arg1;
- (void)cancel;
- (id)initWithSession:(id)arg1 forRead:(BOOL)arg2 doneHandler:(id /* CDUnknownBlockType */)arg3;
