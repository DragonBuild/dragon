...
+ (id)calDAVResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 groupMembersProvider:(id /* CDUnknownBlockType */)arg5 userInfo:(id)arg6;
+ (id)messagesResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 addressType:(long long)arg5 identifier:(id)arg6 contactProvider:(id /* CDUnknownBlockType */)arg7 groupMembersProvider:(id /* CDUnknownBlockType */)arg8 userInfo:(id)arg9;
+ (id)messagesResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 groupMembersProvider:(id /* CDUnknownBlockType */)arg5 userInfo:(id)arg6;
+ (id)calDAVResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 groupMembersProvider:(id /* CDUnknownBlockType */)arg5;
...
- (void)addDiagnosticLog:(id /* CDUnknownBlockType */)arg1;
...
- (long long)compare:(id)arg1 withPriorityComparator:(id /* CDUnknownBlockType */)arg2;
