...
+ (void)restart:(id /* CDUnknownBlockType */)arg1;
+ (void)removeFilesOlderThan:(id)arg1 inDirectory:(id)arg2;
+ (id)shared;
+ (void)addSessionConfigurator:(id /* CDUnknownBlockType */)arg1;
...
- (id)downloadURL:(id)arg1 category:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)downloadRequest:(id)arg1 category:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)downloadURL:(id)arg1 toPath:(id)arg2 category:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (id)downloadRequest:(id)arg1 toPath:(id)arg2 category:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (id)loadURL:(id)arg1 category:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)loadRequest:(id)arg1 category:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3 receiveData:(id /* CDUnknownBlockType */)arg4;
- (id)loadRequest:(id)arg1 category:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)internalRestart:(id /* CDUnknownBlockType */)arg1;
- (void)resume;
- (void)suspend;
...
- (void)enumerateCookies:(id)arg1 secure:(BOOL)arg2 cookies:(id)arg3 withBlock:(id /* CDUnknownBlockType */)arg4;
- (void)enumerateCookies:(id)arg1 inDomain:(id)arg2 secure:(BOOL)arg3 withBlock:(id /* CDUnknownBlockType */)arg4;
...
- (id)downloadImageWithRequest:(id)arg1 category:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)downloadImageFromURL:(id)arg1 category:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
