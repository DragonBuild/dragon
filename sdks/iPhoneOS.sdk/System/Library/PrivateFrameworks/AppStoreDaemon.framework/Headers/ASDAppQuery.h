...
+ (void)_executeQueryWithPredicate:(id)arg1 onPairedDevice:(id)arg2 usingServiceBroker:(id)arg3 withResultHandler:(id /* CDUnknownBlockType */)arg4;
+ (void)anyWithPredicate:(id)arg1 withResultHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)executeQueryWithResultHandler:(id /* CDUnknownBlockType */)arg1;
