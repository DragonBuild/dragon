...
// - (void).cxx_destruct;
- (oneway void)performTextOperations:(id)arg1 resultHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_modifyTextEditingAllowedForReason:(id)arg1 notify:(BOOL)arg2 block:(id /* CDUnknownBlockType */)arg3;
...
- (void)enumerateServices:(id)arg1 force:(BOOL)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
