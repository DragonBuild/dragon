...
- (void)addNewPlanWithAddress:(id)arg1 matchingId:(id)arg2 confirmationCode:(id)arg3 userConsent:(long long)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)addNewPlanWithCardData:(id)arg1 confirmationCode:(id)arg2 userConsentResponse:(long long)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)shouldShowPlanSetupWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)dealloc;
- (id)init;
