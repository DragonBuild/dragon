...
+ (void)setSpeechJobStartedUnitTestBlock:(id /* CDUnknownBlockType */)arg1;
+ (void)setSpeechJobFinishedUnitTestBlock:(id /* CDUnknownBlockType */)arg1;
...
// - (void).cxx_destruct;
- (void)connection:(id)arg1 speechRequest:(id)arg2 willSpeakMark:(long long)arg3 inRange:(_NSRange)arg4;
...
- (id)_applySubstitution:(id)arg1 toText:(id)arg2 wordRange:(_NSRange)arg3 request:(id)arg4 phonemes:(id )arg5;
