...
- (void)_setupTermsControllerHandlerWithNavigationController:(id)arg1 forCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)_cancelDatasourceTimeout;
- (void)_showEligibilityIssueForStatus:(long long)arg1 learnMoreURL:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_displayTermsForEligibilityResponse:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
