...
- (void)_presentSecurityCapabilitiesFlowWithFeature:(NSUInteger)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)performSecurityCheckForCredentials:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_presentAccountAlertIfNotSelectedWithContinueHandler:(id /* CDUnknownBlockType */)arg1 setupLaterHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_presentAlertForCredentialCache:(id)arg1 continueHandler:(id /* CDUnknownBlockType */)arg2 setupLaterHandler:(id /* CDUnknownBlockType */)arg3;
