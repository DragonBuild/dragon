...
- (void)_fetchBalancesAndTransitPassPropertiesForPass:(id)arg1 withDataProvider:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (long long)_paymentSetupContextForSettingsContext:(long long)arg1;
- (void)_transitPropertiesForPaymentPass:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)_performPhoneToWatchProvisioningForPaymentPass:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_presentPeerPaymentSetupFlowWithAmount:(id)arg1 flowState:(NSUInteger)arg2 senderAddress:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_presentPeerPaymentSetupFlowForSpecifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)addCardTappedForPaymentPassWithUniqueID:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
