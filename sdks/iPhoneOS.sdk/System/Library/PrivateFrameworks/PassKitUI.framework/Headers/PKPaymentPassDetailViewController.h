...
- (void)_preflightWatchForTransferWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_presentPhysicalCardPasswordAuthorization:(id /* CDUnknownBlockType */)arg1;
...
- (void)_fetchScheduledPaymentsWithAccountIdentifier:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_reloadTransactionsWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_fetchBalanceRemindersWithActionForBalance:(id)arg1 transitProperties:(id)arg2 pass:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)_updateDisplayableBalancesAndTransitPropertiesWithBalances:(id)arg1 transitProperties:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_updateDisplayableBalancesWithBalances:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)_updateDisplayableBalances;
- (void)_updateTransitPropertiesWithCompletion:(id /* CDUnknownBlockType */)arg1;
