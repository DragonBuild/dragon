...
- (void)nextViewControllerFromViewController:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)presentNextViewControllerFromViewController:(id)arg1;
- (void)performScheduleAutomaticPaymentsFromViewController:(id)arg1;
- (void)performScheduleAutomaticPayments:(id /* CDUnknownBlockType */)arg1;
