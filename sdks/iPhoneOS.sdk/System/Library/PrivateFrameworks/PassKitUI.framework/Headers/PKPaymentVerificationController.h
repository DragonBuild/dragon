...
// - (void).cxx_destruct;
- (void)_downloadAndAddPassWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)submitVerificationCode:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)performVerificationUpdateRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)performVerificationOptionsRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
