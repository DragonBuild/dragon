...
// - (void).cxx_destruct;
- (BOOL)_enumerateKey:(id)arg1 updatedAfter:(id)arg2 fromTable:(id)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4 error:(id )arg5;
- (BOOL)enumerateSentItemsOfKey:(id)arg1 updatedAfter:(id)arg2 error:(id )arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
- (BOOL)enumerateRemovalsOfKey:(id)arg1 updatedAfter:(id)arg2 error:(id )arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
- (BOOL)enumerateItemsOfKey:(id)arg1 updatedAfter:(id)arg2 error:(id )arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
...
- (BOOL)succeedOrRollbackOnFail:(id)arg1 error:(id )arg2 whileExecuting:(id /* CDUnknownBlockType */)arg3;
