...
- (void)_handleLastEventFromBackgroundConnection:(id)arg1 pendingConnectionExhaustionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)_activeOrAnyPendingConnection;
- (void)_waitForActiveConnection:(id /* CDUnknownBlockType */)arg1;
- (void)_accessPotentiallyActiveConnections:(id /* CDUnknownBlockType */)arg1;
- (void)getConnectionMetricsSynchronously:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)getAnalysisInfo:(id /* CDUnknownBlockType */)arg1;
- (id)analysisInfo;
- (void)cancelSynchronously:(BOOL)arg1 onQueue:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_cancelSynchronously:(id /* CDUnknownBlockType */)arg1;
...
- (void)sendCommand:(id)arg1 errorHandler:(id /* CDUnknownBlockType */)arg2;
- (void)start;
