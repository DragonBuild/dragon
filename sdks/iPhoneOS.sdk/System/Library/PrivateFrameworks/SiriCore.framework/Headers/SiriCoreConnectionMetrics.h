...
- (void)setConnectionMetricsFromNWConnectionForPOP:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)setConnectionMetricsFromNWConnectionForDirect:(id)arg1 isMPTCP:(BOOL)arg2 attemptedEndpoints:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (void)setConnectionMetricsFromConnection:(id)arg1 isPop:(BOOL)arg2 isMPTCP:(BOOL)arg3 attemptedEndpoints:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)_setConnectionMetricsTCPInfo:(id)arg1;
- (void)setConnectionMetricsFromStreamForPOP:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)setConnectionMetricsFromStreamForDirect:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)setConnectionMetricsFromStream:(id)arg1 isPop:(BOOL)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
