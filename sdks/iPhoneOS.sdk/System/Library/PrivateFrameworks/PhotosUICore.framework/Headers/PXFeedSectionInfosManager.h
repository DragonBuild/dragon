...
- (id /* CDUnknownBlockType */)_sectionInfoSortingComparator;
...
- (void)reconfigure:(id /* CDUnknownBlockType */)arg1;
...
- (void)dealloc;
- (id)initWithPhotoLibrary:(id)arg1 configurationBlock:(id /* CDUnknownBlockType */)arg2;
