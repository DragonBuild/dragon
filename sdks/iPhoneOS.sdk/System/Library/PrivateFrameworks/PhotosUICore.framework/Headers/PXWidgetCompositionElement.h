...
- (void)widget:(id)arg1 animateChanges:(id /* CDUnknownBlockType */)arg2 withAnimationOptions:(id)arg3;
...
- (void)_performChanges:(id /* CDUnknownBlockType */)arg1 withAnimationOptions:(id)arg2;
- (void)_updateFooter;
- (void)_invalidateFooter;
- (void)_updateHeader;
- (void)_invalidateHeader;
- (void)_performContentChangeWhenSafe:(id /* CDUnknownBlockType */)arg1;
- (void)_notifyWidgetUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)saveAnchoring;
