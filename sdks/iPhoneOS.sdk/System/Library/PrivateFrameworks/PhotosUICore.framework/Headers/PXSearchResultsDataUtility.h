...
+ (void)suggestionsDisplayDataFromToken:(id)arg1 searchText:(id)arg2 matchedColor:(UIColor )arg3 remainingColor:(UIColor )arg4 isTextCompletion:(BOOL)arg5 completion:(id /* CDUnknownBlockType */)arg6;
