...
+ (id)px_viewControllerWithContinuousOutputProducer:(id /* CDUnknownBlockType */)arg1;
+ (id)px_viewControllerWithAsynchronousOutputProducer:(id /* CDUnknownBlockType */)arg1;
+ (id)px_viewControllerWithOutput:(id /* CDUnknownBlockType */)arg1;
...
- (void)px_presentViewControllerInNavigationController:(id)arg1 animated:(BOOL)arg2 dimissButtonLocation:(long long)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)px_enumerateDescendantViewControllersWithOptions:(NSUInteger)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (BOOL)px_isDescendantOfViewController:(id)arg1;
- (BOOL)px_canPresentViewControllerAnimated:(BOOL)arg1;
- (void)px_presentOverTopmostPresentedViewController:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
