...
- (void)scrollLibraryViewToObjectReference:(id)arg1 scrollPosition:(NSUInteger)arg2 padding:(UIEdgeInsets)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)scrollLibraryViewToAssetReference:(id)arg1 scrollPosition:(NSUInteger)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
