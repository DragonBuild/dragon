...
- (void)waitUntilBackgroundFetchingFinishedWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)_recursivelyEnumerateAssetCollectionsInFetchResult:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (void)_enumerateAllPhotoKitCollectionsUsingBlock:(id /* CDUnknownBlockType */)arg1;
