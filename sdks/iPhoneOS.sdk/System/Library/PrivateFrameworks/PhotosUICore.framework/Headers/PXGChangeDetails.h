...
- (void)applyToDictionary:(id)arg1 removalHandler:(id /* CDUnknownBlockType */)arg2;
- (void)applyToArray:(void )arg1 elementSize:(NSUInteger)arg2 countAfterChanges:(NSUInteger)arg3 insertionHandler:(id /* CDUnknownBlockType */)arg4 modifiedHandler:(id /* CDUnknownBlockType */)arg5;
