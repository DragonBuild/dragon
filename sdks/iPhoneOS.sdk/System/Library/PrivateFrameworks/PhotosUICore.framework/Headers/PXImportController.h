...
+ (id)importFilesAtURLs:(id)arg1 photoLibrary:(id)arg2 collection:(id)arg3 checkDuplicates:(BOOL)arg4 referenced:(BOOL)arg5 delegate:(id)arg6 completionHandler:(id /* CDUnknownBlockType */)arg7;
...
- (void)deleteItems:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)completedImportRecord:(id)arg1;
- (void)finishImportingWithResults:(id)arg1;
- (void)stopImport;
- (void)importItems:(id)arg1 configuration:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
