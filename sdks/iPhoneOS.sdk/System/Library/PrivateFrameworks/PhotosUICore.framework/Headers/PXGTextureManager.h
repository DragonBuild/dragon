...
- (id)_createTextureForCGImage:(CGImage )arg1 orientation:(unsigned int)arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4;
- (void)_processCGImage:(CGImage )arg1 orientation:(unsigned int)arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4 requestID:(int)arg5 deliveryOrder:(unsigned int)arg6;
...
- (id)_storeTexture:(id)arg1 forCGImage:(CGImage )arg2;
...
- (id)_existingTextureForCGImage:(CGImage )arg1 presentationType:(int)arg2;
...
- (CGImage )textureSnapshotForSpriteIndex:(unsigned int)arg1;
- (void)_enumerateSpriteTextures:(id /* CDUnknownBlockType */)arg1;
