...
- (void)_prepareDiffsForPendingResultsWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)enumerateStartingAtIndexPath:(id)arg1 reverseDirection:(BOOL)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)_performManualReloadWithChangeBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_performManualChangesForAssetCollections:(id)arg1 collectionsToDiff:(id)arg2 changeBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_performManualChangesForAssetCollections:(id)arg1 changeBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)_enumerateChangeObserversWithBlock:(id /* CDUnknownBlockType */)arg1;
