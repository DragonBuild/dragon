...
- (void)_enumerateRowFramesWithContiguousTiles:(struct PXTileInfo )arg1 count:(long long)arg2 useMagneticGuidelines:(BOOL)arg3 block:(id /* CDUnknownBlockType */)arg4;
