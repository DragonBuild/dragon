...
// - (void).cxx_destruct;
- (void)fetchAssetsFromDrop:(id)arg1 importIfNeeded:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_addProgress:(id)arg1 forItemProviders:(id)arg2 assetCreationCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_addProgress:(id)arg1 forItemProviders:(id)arg2 sharedSourceCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_handleCompletionOfImportForItemProvider:(id)arg1 resultObject:(id)arg2 progress:(id)arg3 error:(id)arg4;
- (id)importSharedSourcesForDragItems:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)importDragItems:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)init;
