...
- (void)_webView:(id)arg1 contextMenuConfigurationForElement:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)generateSnapshotImageWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_addScriptHandlerForKey:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
