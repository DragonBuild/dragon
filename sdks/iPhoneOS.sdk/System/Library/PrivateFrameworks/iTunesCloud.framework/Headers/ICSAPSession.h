...
// - (void).cxx_destruct;
- (void)verifySignatureData:(id)arg1 forData:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)signData:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
