...
- (void)renewCredentialsForAppleIDWithHandler:(id /* CDUnknownBlockType */)arg1;
- (void)signInWithHandler:(id /* CDUnknownBlockType */)arg1;
- (void)setupChildMailAccountAndEnable:(BOOL)arg1 withEmail:(id)arg2;
- (void)authenticateWithHandler:(id /* CDUnknownBlockType */)arg1;
- (void)updateAccountPropertiesWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (BOOL)presentQuotaDepletionAlertForDataclassIfNecessary:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
- (void)presentQuotaDepletionAlertForDataclass:(id)arg1;
- (void)presentQuotaDepletionAlertForDataclass:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
