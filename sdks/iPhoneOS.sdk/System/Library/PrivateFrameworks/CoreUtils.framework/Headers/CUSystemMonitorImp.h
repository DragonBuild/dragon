...
- (void)_systemConfigUpdateKeyPtr:(id )arg1 name:(id)arg2 enabled:(BOOL)arg3 creator:(id /* CDUnknownBlockType */)arg4;
...
- (void)_update;
- (void)updateWithQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_invokeBlock:(id /* CDUnknownBlockType */)arg1 passingTest:(id /* CDUnknownBlockType */)arg2;
- (BOOL)_hasMonitorPassingTest:(id /* CDUnknownBlockType */)arg1;
- (void)removeMonitor:(id)arg1;
- (void)addMonitor:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)init;
