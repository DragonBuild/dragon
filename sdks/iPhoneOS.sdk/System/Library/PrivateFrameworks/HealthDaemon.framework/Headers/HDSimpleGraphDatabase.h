...
- (BOOL)performWork:(id /* CDUnknownBlockType */)arg1 usingTransaction:(BOOL)arg2 error:(id )arg3;
- (void)performWork:(id /* CDUnknownBlockType */)arg1 usingTransaction:(BOOL)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_performWork:(id /* CDUnknownBlockType */)arg1 usingTransaction:(BOOL)arg2 error:(id )arg3;
...
- (BOOL)attemptDelete;
- (void)attemptDeleteWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_work_attemptDeleteWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)init;
