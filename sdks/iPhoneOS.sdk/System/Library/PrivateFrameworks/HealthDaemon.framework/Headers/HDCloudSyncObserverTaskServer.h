...
- (id)_queue_startSyncIfRestoreNotCompletedWithUUID:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (id)remote_startSyncIfRestoreNotCompletedWithUUID:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)remote_startObservingSyncStatusWithCompletion:(id /* CDUnknownBlockType */)arg1;
