...
+ (void)deleteSamplesWithPredicate:(id)arg1 limit:(NSUInteger)arg2 deletionContext:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
+ (void)deleteSamplesWithPredicate:(id)arg1 limit:(NSUInteger)arg2 generateDeletedObjects:(BOOL)arg3 database:(id)arg4 profile:(id)arg5 recursiveDeleteAuthorizationBlock:(id /* CDUnknownBlockType */)arg6 completionHandler:(id /* CDUnknownBlockType */)arg7;
+ (void)deleteSamplesWithTypes:(id)arg1 sourceEntities:(id)arg2 profile:(id)arg3 recursiveDeleteAuthorizationBlock:(id /* CDUnknownBlockType */)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
