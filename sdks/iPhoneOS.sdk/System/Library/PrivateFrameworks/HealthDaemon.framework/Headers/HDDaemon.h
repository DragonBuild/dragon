...
- (id)_setupSignal:(int)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (void)performBlockWithPowerAssertionIdentifier:(id)arg1 transactionName:(id)arg2 powerAssertionInterval:(double)arg3 block:(id /* CDUnknownBlockType */)arg4;
...
- (void)obliterateAndTerminateWithOptions:(NSUInteger)arg1 reason:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
