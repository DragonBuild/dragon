...
- (void)unitTest_setAggregatorConfigurationChangeHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)generateFakeDataForActivityType:(long long)arg1 minutes:(double)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)stopFakingData;
...
- (id)collectibleTypes;
- (void)_queue_adjustDataCollectionForType:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (void)_requestAggregationThroughDate:(id)arg1 type:(id)arg2 mode:(long long)arg3 freezeSeries:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)_requestAggregationThroughDate:(id)arg1 types:(id)arg2 mode:(long long)arg3 freezeSeries:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)requestAggregationForAllTypesThroughDate:(id)arg1 mode:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)requestAggregationThroughDate:(id)arg1 types:(id)arg2 mode:(long long)arg3 freezeSeries:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (void)performSaveWithMaximumLatency:(double)arg1 block:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)_queue_aggregatorForType:(id)arg1;
- (id)_newAggregatorForObjectType:(id)arg1;
- (id)aggregatorForType:(id)arg1;
- (void)_demoObjectsReceived:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)periodicUpdate;
- (void)dealloc;
