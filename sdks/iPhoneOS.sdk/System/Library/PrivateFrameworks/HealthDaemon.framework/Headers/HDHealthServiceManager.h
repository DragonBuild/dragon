...
- (NSUInteger)connectHealthService:(id)arg1 connectionOptions:(NSUInteger)arg2 sessionHandler:(id /* CDUnknownBlockType */)arg3 dataHandler:(id /* CDUnknownBlockType */)arg4 mfaSuccessHandler:(id /* CDUnknownBlockType */)arg5 autoPairData:(id)arg6 error:(id )arg7;
- (NSUInteger)connectHealthService:(id)arg1 sessionHandler:(id /* CDUnknownBlockType */)arg2 dataHandler:(id /* CDUnknownBlockType */)arg3 error:(id )arg4;
...
- (void)writeCharacteristic:(id)arg1 onSession:(NSUInteger)arg2 expectResponse:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)performOperation:(id)arg1 onSession:(NSUInteger)arg2 withParameters:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)getProperty:(id)arg1 forSession:(NSUInteger)arg2 withHandler:(id /* CDUnknownBlockType */)arg3;
- (void)getSupportedPropertyNamesWithHandler:(id /* CDUnknownBlockType */)arg1;
- (void)updateConnectionInfosForPeripheralUUID:(id)arg1 withMutation:(id /* CDUnknownBlockType */)arg2;
...
- (NSUInteger)connectHealthService:(id)arg1 sessionHandler:(id /* CDUnknownBlockType */)arg2 dataHandler:(id /* CDUnknownBlockType */)arg3 characteristicsHandler:(id /* CDUnknownBlockType */)arg4 error:(id )arg5;
...
- (NSUInteger)discoverHealthServicesWithType:(long long)arg1 timeout:(NSUInteger)arg2 alwaysNotify:(BOOL)arg3 handler:(id /* CDUnknownBlockType */)arg4 error:(id )arg5;
- (void)_queue_notifyBluetoothStatusUpdates:(long long)arg1 error:(id)arg2;
- (void)sendBluetoothStatusUpdatesForServer:(id)arg1 updateHandler:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
