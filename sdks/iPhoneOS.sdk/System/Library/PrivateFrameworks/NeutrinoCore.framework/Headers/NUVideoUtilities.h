...
+ (void)readNextSampleBuffer:(id)arg1 output:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
+ (void)readNextPixelBuffer:(id)arg1 output:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
