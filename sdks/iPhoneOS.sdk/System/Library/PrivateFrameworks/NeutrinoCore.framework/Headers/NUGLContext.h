...
+ (void)executeOnDevice:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
// - (void).cxx_destruct;
- (void)_purgeObjectsOfType:(unsigned int)arg1 fromPool:(id)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_purgeObjectPool:(id)arg1;
- (void)purgeObjectPool:(id)arg1;
- (void)drawVertexArray:(unsigned int)arg1 range:(_NSRange)arg2;
...
- (void )mapBuffer:(id)arg1 range:(_NSRange)arg2 options:(unsigned int)arg3;
