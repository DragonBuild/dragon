...
- (void)addCancelObserver:(id)arg1 queue:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
- (void)addStageObserver:(id)arg1 queue:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
