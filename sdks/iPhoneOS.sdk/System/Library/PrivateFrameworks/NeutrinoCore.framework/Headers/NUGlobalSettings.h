...
+ (id)globalSettings;
// - (void).cxx_destruct;
- (id)urlSettingForKey:(id)arg1 defaultValue:(id /* CDUnknownBlockType */)arg2;
- (id)stringSettingForKey:(id)arg1 defaultValue:(id /* CDUnknownBlockType */)arg2;
- (double)doubleSettingForKey:(id)arg1 defaultValue:(id /* CDUnknownBlockType */)arg2;
- (long long)integerSettingForKey:(id)arg1 defaultValue:(id /* CDUnknownBlockType */)arg2;
- (BOOL)boolSettingForKey:(id)arg1 defaultValue:(id /* CDUnknownBlockType */)arg2;
- (void)setSetting:(id)arg1 forKey:(id)arg2;
- (id)_settingForKey:(id)arg1 defaultValue:(id /* CDUnknownBlockType */)arg2;
- (id)settingForKey:(id)arg1 defaultValue:(id /* CDUnknownBlockType */)arg2;
- (void)reset;
- (id)init;
