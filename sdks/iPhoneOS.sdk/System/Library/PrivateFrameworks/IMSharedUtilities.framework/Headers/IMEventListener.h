...
- (void)startListeningForEventTarget:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)startListeningForEventTarget:(id)arg1 sendStartingEvent:(id /* CDUnknownBlockType */)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)waitForCompletion;
- (void)_dispatchStartEventBlock:(id /* CDUnknownBlockType */)arg1;
