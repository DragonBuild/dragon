...
- (void)dumpLogsToFolderAtPath:(id)arg1 withFileName:(id)arg2 lastHours:(int)arg3 predicate:(id)arg4 includeCKDebug:(BOOL)arg5 withCompletion:(id /* CDUnknownBlockType */)arg6;
- (BOOL)_checkArgumentValidity:(id)arg1 withFileName:(id)arg2 withError:(id )arg3;
- (void)_compressAndDeleteFilesAtPath:(id)arg1 destinationFilePath:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
