...
- (void)rcs_composeToFinalDestinationAndDeleteDecomposedFragments:(BOOL)arg1 composeWaveform:(BOOL)arg2 canGenerateWaveformByProcessingAVURL:(BOOL)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)enumerateOrphanedFragmentsWithBlock:(id /* CDUnknownBlockType */)arg1;
