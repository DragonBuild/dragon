...
+ (void)_AVAssetExportDetermineSettingsForExportingAsset:(id)arg1 outputExtensionWithFallbacks:(id)arg2 preferredFormat:(unsigned int)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
+ (void)AVAssetExportDetermineSettingsForExportingAsset:(id)arg1 preferredOutputExtension:(id)arg2 preferredFormat:(unsigned int)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
