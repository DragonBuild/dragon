...
- (BOOL)_appendPowerMeterValuesFromDataInAudioFile:(id)arg1 progressBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)_onQueue_performObserversBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_onQueue_performInternalFinishedLoadingBlocksAndFinishObservers;
- (void)_onQueue_performLoadingFinishedBlock:(id /* CDUnknownBlockType */)arg1 internalBlockUUID:(id)arg2 isTimeout:(BOOL)arg3;
- (void)async_finishLoadingByTerminating:(BOOL)arg1 loadingFinishedBlockTimeout:(NSUInteger)arg2 loadingFinishedBlock:(id /* CDUnknownBlockType */)arg3;
...
- (BOOL)appendAveragePowerLevelsByDigestingContentsOfAudioFileURL:(id)arg1 progressBlock:(id /* CDUnknownBlockType */)arg2;
