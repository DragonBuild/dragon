...
- (void)audioVideoProxyPropertyListForAsset:(id)arg1 performExport:(BOOL)arg2 atEnd:(id /* CDUnknownBlockType */)arg3;
- (void)waitForAsync_setAudioVideoAttributesForAVProxyData:(id)arg1;
- (void)setAudioVideoAttributesForAVProxyData:(id)arg1 readyHandler:(id /* CDUnknownBlockType */)arg2;
- (void)setAudioVideoAttributesForAVAsset:(id)arg1 path:(id)arg2 fullMetadata:(BOOL)arg3 readyHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)setAudioVideoAttributesForURL:(id)arg1 fullMetadata:(BOOL)arg2 readyHandler:(id /* CDUnknownBlockType */)arg3;
