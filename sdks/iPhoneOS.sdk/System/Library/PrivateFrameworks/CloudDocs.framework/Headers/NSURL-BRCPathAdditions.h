...
+ (void)br_containerIDsWithExternalReferencesTo:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
+ (id)br_documentURLFromBookmarkableString:(id)arg1 error:(id )arg2;
+ (void)br_documentURLFromBookmarkableString:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)br_isConflictedWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)br_containerIDsWithExternalReferencesWithHandler:(id /* CDUnknownBlockType */)arg1;
- (void)br_bookmarkableStringForRemoteOpeningAppWithBundleID:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)br_bookmarkableStringWithEtag:(BOOL)arg1 onlyAllowItemKnowByServer:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)br_bookmarkableStringWithEtag:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
