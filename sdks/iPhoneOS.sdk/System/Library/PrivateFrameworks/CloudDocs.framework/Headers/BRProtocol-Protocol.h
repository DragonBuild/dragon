...
- (void)checkIfItemIsShareableWithInode:(NSUInteger)arg1 reply:(void (^)(BOOL, NSError *))arg2;
...
- (void)startOperation:(NSObject<BROperationClient> *)arg1 toProcessSubitemsAtURL:(NSURL *)arg2 maxSubsharesFailures:(NSUInteger)arg3 processType:(NSUInteger)arg4 reply:(void (^)(NSError *))arg5;
