...
+ (void)forceRefreshAllContainersWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
+ (void)forceRefreshContainers:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
// - (void).cxx_destruct;
- (void)_performWhileAccessingSecurityScopedContainer:(id /* CDUnknownBlockType */)arg1;
- (id)_pathForIconName:(id)arg1;
- (id)_pathForPlist;
- (id)_containerRepositoryURL;
- (void)_replaceDataRepresentationWithData:(id)arg1;
- (void)forceRefreshWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)accessPropertiesInBlock:(id /* CDUnknownBlockType */)arg1;
...
- (id)shortDescription;
- (void)accessDataRepresentationInBlock:(id /* CDUnknownBlockType */)arg1;
