...
// - (void).cxx_destruct;
- (void)readSafelyUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)modifySafelyUsingBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)enumerateMergedStrokesAndCapsForGridRow:(unsigned int)arg1 from:(unsigned int)arg2 to:(unsigned int)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
- (void)enumerateMergedStrokesAndCapsForGridColumn:(unsigned int)arg1 from:(unsigned int)arg2 to:(unsigned int)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
- (void)enumerateMergedStrokesForGridRow:(unsigned int)arg1 from:(unsigned int)arg2 to:(unsigned int)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
- (void)enumerateMergedStrokesForGridColumn:(unsigned int)arg1 from:(unsigned int)arg2 to:(unsigned int)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
