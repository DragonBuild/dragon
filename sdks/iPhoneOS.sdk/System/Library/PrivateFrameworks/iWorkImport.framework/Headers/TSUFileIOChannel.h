...
- (void)dealloc;
- (id)initWithType:(NSUInteger)arg1 descriptor:(int)arg2 cleanupHandler:(id /* CDUnknownBlockType */)arg3;
...
- (id)initForReadingDescriptor:(int)arg1 cleanupHandler:(id /* CDUnknownBlockType */)arg2;
