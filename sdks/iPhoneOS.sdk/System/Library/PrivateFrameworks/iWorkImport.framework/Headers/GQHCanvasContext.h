...
- (void)setCGPath:(CGPath )arg1 state:(id)arg2;
...
- (struct GQHPathEndPointInfo)endPointInfoForPath:(CGPath )arg1;
...
- (void)createMaskedImageWithId:(struct __CFString )arg1 geometry:(id)arg2 imageBinary:(id)arg3 cropGeometry:(id)arg4 maskingShapePath:(id)arg5 alphaMaskBezier:(CGPath )arg6 graphicStyle:(id)arg7 isFloating:(BOOL)arg8 state:(id)arg9;
