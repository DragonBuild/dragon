...
- (void)enumerateRowsUidsAtLevel:(unsigned char)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)enumerateGroupsAtLevel:(unsigned char)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateAllGroupsWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateAggregatesAtLevel:(unsigned char)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateAggregates:(id /* CDUnknownBlockType */)arg1;
...
- (void)enumerateGroupingColumnsForColumn:(const UUIDData_5fbc143e )arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
