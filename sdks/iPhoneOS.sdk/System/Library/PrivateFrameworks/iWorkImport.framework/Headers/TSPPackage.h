...
- (void)copyComponent:(id)arg1 toPackageURL:(id)arg2 packageLocator:(id)arg3 zipFileWriter:(id)arg4 encryptionKey:(id)arg5 canLink:(BOOL)arg6 completion:(id /* CDUnknownBlockType */)arg7;
...
- (void)peformSynchronousAccessToZipArchive:(id /* CDUnknownBlockType */)arg1;
