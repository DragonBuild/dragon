...
- (void)iterateFormulasWithContext:(struct TSCEFormulaRewriteContext )arg1 shouldStop:(BOOL )arg2 block:(id /* CDUnknownBlockType */)arg3;
- (id)copyByRewritingWithContext:(struct TSCEFormulaRewriteContext )arg1 rewriteBlock:(id /* CDUnknownBlockType */)arg2;
