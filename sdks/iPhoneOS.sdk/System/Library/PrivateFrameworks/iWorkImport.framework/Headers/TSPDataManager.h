...
+ (void)readWithChannelImpl:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
+ (void)readWithChannel:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
+ (void)readWithURL:(id)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (id)dataWithStorage:(id)arg1 digest:(id)arg2 filename:(id)arg3 skipDocumentResourcesLookup:(BOOL)arg4 accessorBlock:(id /* CDUnknownBlockType */)arg5;
- (void)dataForDigest:(id)arg1 queue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)dataForDocumentResourceInfo:(id)arg1;
- (id)dataForDigest:(id)arg1;
- (id)preferredFilenameForDocumentResourceInfo:(id)arg1;
- (id)dataForDigestImpl:(id)arg1 documentResourceInfo:(id)arg2 skipDocumentResourcesLookup:(BOOL)arg3 expectedLength:(NSUInteger)arg4 accessorBlock:(id /* CDUnknownBlockType */)arg5;
...
- (void)findExistingDataForReadChannel:(id)arg1 dataURL:(id)arg2 dataURLType:(long long)arg3 readHandler:(id /* CDUnknownBlockType */)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)findExistingDataForReadChannel:(id)arg1 dataURL:(id)arg2 dataURLType:(long long)arg3 temporaryDataStorageURL:(id)arg4 keepTemporaryFileOnSuccess:(BOOL)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (id)dataForExistingData:(id)arg1 digest:(id)arg2 filename:(id)arg3 temporaryDataStorageURL:(id)arg4;
- (void)dataFromReadChannel:(id)arg1 filename:(id)arg2 dataURLOrNil:(id)arg3 canLink:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (void)dataFromFileURL:(id)arg1 filename:(id)arg2 context:(id)arg3 completionQueue:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
