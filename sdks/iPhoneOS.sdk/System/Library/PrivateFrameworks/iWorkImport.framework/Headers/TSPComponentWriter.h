...
- (id).cxx_construct;
// - (void).cxx_destruct;
- (void)analyzeCommandToModelReference:(id)arg1 isAnalyzingExternalComponent:(BOOL)arg2 archiver:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)writeObject:(id)arg1 archiver:(id)arg2 parentObject:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)writeWithArchiverAccessLockForObjects:(id)arg1 parentObject:(id)arg2 isCommandToModelReference:(BOOL)arg3 isAnalyzingExternalComponent:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)acquireArchiverAccessLockAndWriteObjects:(id)arg1 parentObject:(id)arg2 isCommandToModelReference:(BOOL)arg3 isAnalyzingExternalComponent:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (BOOL)shouldAnalyzeCommandToModelReference:(id)arg1 isAnalyzingExternalComponent:(BOOL)arg2;
- (BOOL)shouldWriteObject:(id)arg1;
- (void)writeWithCompletionQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)init;
