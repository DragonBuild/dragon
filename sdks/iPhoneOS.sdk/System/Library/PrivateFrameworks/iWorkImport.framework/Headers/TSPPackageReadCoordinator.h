...
- (id)context;
- (void)p_validateComponent:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)validateArchiveWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)readPackageMetadataWithComponent:(id)arg1 completionQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)p_readComponent:(id)arg1 additionalComponents:(id)arg2 requireUpgrade:(BOOL)arg3 completionQueue:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)p_readComponent:(id)arg1 completionQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
