...
- (void)processCustomFormatsWithBlock:(id /* CDUnknownBlockType */)arg1;
...
- (BOOL)hasEqualContentToCell:(id)arg1 usingRichTextStyleComparisonBlock:(id /* CDUnknownBlockType */)arg2;
