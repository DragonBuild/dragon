...
- (void)_beginImportWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)showProgressIfNeededForURL:(id)arg1;
- (void)retrievePassphraseForEncryptedDocumentWithImporter:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
