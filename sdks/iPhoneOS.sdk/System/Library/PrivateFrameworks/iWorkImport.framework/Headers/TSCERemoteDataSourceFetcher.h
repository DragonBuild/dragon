...
// - (void).cxx_destruct;
- (void)autoCompleteQuotesWithInput:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)fetchQuotesWithTickers:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
