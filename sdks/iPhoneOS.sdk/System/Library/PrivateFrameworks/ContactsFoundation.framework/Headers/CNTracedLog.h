...
// - (void).cxx_destruct;
- (id)resultString;
- (void)sendValue:(id)arg1 forKey:(id)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
- (void)enumerateCustomKeysAndValuesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateStandardKeysAndValuesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateStandardizedKeysAndValuesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)sendTrace;
- (id)init;
