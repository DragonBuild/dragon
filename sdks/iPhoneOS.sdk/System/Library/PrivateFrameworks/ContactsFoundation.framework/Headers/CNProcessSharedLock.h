...
- (BOOL)isValid;
- (void)invalidate;
- (BOOL)ensureFileIsLocal:(id /* CDUnknownBlockType */)arg1;
- (BOOL)openLockFile:(id /* CDUnknownBlockType */)arg1;
- (BOOL)ensureFileDescriptorIsInvalid:(id /* CDUnknownBlockType */)arg1;
- (BOOL)open:(id )arg1;
- (void)dealloc;
