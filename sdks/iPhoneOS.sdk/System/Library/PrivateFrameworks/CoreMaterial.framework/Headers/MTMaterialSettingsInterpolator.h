...
- (id)_colorWithGetterBlock:(id /* CDUnknownBlockType */)arg1;
- (double)_floatPropertyValueForProperty:(id)arg1;
- (double)_floatPropertyValueForProperty:(id)arg1 withTransformer:(id /* CDUnknownBlockType */)arg2;
- (id)_propertyValueForProperty:(id)arg1 withTransformer:(id /* CDUnknownBlockType */)arg2;
