...
+ (id /* CDUnknownBlockType */)likenessComparator;
+ (id /* CDUnknownBlockType */)configurationDistanceClassifierWithMetric:(id)arg1;
...
+ (id /* CDUnknownBlockType */)defaultTimeProvider;
+ (id /* CDUnknownBlockType */)defaultRecordTransformerForCoreModel:(id)arg1;
...
- (void)performClientWork:(id /* CDUnknownBlockType */)arg1;
- (id)initWithAggDClient:(id)arg1 dpRecorder:(id)arg2 serialQueueProvider:(id /* CDUnknownBlockType */)arg3 recordTransformer:(id /* CDUnknownBlockType */)arg4 avatarRecord:(id)arg5 defaultConfiguration:(id)arg6 timeProvider:(id /* CDUnknownBlockType */)arg7 configurationMetric:(id)arg8 logger:(id)arg9 aggDKeyBasePrefix:(id)arg10;
- (id)initWithSerialQueueProvider:(id /* CDUnknownBlockType */)arg1 recordTransformer:(id /* CDUnknownBlockType */)arg2 logger:(id)arg3;
