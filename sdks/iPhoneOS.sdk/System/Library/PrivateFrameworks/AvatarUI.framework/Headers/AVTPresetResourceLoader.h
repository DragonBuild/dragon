...
- (id)preLoadResourcesForPresetResourcesProvider:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)performSectionItemPreloadingTask:(id)arg1;
- (void)startSectionItemPreloadingTask:(id)arg1;
- (id)preLoadResourcesForSectionItem:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
