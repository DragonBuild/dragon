...
- (void)storeDidChange;
- (id)initWithWorkQueue:(id)arg1 managedObjectContextFactory:(id /* CDUnknownBlockType */)arg2 eventCoalescer:(id)arg3 logger:(id)arg4;
- (id)initWithEnvironment:(id)arg1 managedObjectContextFactory:(id /* CDUnknownBlockType */)arg2;
