...
@interface TSDCAAnimationCache : NSObject
{
    ...
    CGColor _borderColorInitialValue;
    double _borderWidthInitialValue;
    CGImage _contentsInitialValue;
...
@property(readonly, nonatomic) CGImage contentsInitialValue; // @synthesize contentsInitialValue=_contentsInitialValue;
...
@property(readonly, nonatomic) CGColor borderColorInitialValue; // @synthesize borderColorInitialValue=_borderColorInitialValue;
