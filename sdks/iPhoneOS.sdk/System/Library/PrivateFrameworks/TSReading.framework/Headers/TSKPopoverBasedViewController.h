...
- (void)presentInRect:(CGRect)arg1 inView:(id)arg2 animated:(BOOL)arg3 modal:(BOOL)arg4 closeBlock:(id /* CDUnknownBlockType */)arg5 animations:(id /* CDUnknownBlockType */)arg6;
- (void)presentInRect:(CGRect)arg1 inView:(id)arg2 animated:(BOOL)arg3 modal:(BOOL)arg4 closeBlock:(id /* CDUnknownBlockType */)arg5;
