...
- (void)deleteCallsWithPredicate:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (long long)deleteCallsWithPredicate:(id)arg1;
- (void)setRead:(BOOL)arg1 forCallsWithPredicate:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
