...
- (void)_fetchAuthorizationRecordsBySourceForType:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchDataSourcesForSampleType:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchOrderedSourcesForType:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
