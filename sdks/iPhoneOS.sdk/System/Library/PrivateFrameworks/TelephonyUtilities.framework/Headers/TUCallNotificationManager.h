...
- (void)deferNotificationsUntilAfterPerformingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)postNotificationsForCallContainer:(id)arg1 afterUpdatesInBlock:(id /* CDUnknownBlockType */)arg2;
- (void)postNotificationsForCall:(id)arg1 usingComparisonCall:(id)arg2 afterUpdatesInBlock:(id /* CDUnknownBlockType */)arg3;
- (void)postNotificationsForCall:(id)arg1 usingComparisonCall:(id)arg2;
- (void)postNotificationsForCall:(id)arg1 afterUpdatesInBlock:(id /* CDUnknownBlockType */)arg2;
