...
- (NSUInteger)filterStatusForAddresses:(id)arg1 forBundleIdentifier:(id)arg2;
...
- (oneway void)pullCallFromClientUsingHandoffActivityUserInfo:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (id)dialWithRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)requestCurrentStateWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)requestCurrentStateWithCompletionHandler:(id /* CDUnknownBlockType */)arg1 handleInitialState:(id /* CDUnknownBlockType */)arg2;
- (void)tearDownXPCConnection;
- (void)registerCall:(id)arg1;
- (void)performBlockOnQueue:(id /* CDUnknownBlockType */)arg1 andWait:(BOOL)arg2;
- (void)performBlockOnQueue:(id /* CDUnknownBlockType */)arg1;
