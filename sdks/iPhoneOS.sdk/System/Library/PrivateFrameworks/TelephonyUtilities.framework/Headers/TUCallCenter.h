...
- (void)pullCallFromClientUsingHandoffActivityUserInfo:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_preflightDisconnectForCalls:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (id)_dialWithRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)dialWithRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
