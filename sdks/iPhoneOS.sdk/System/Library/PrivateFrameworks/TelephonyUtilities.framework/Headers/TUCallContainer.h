...
- (BOOL)allCallsPassTest:(id /* CDUnknownBlockType */)arg1;
- (BOOL)anyCallPassesTest:(id /* CDUnknownBlockType */)arg1;
...
- (NSUInteger)countOfCallsPassingTest:(id /* CDUnknownBlockType */)arg1;
...
- (id)callPassingTest:(id /* CDUnknownBlockType */)arg1 sortedUsingComparator:(id /* CDUnknownBlockType */)arg2;
- (id)callPassingTest:(id /* CDUnknownBlockType */)arg1 withOptions:(NSUInteger)arg2;
- (id)callPassingTest:(id /* CDUnknownBlockType */)arg1;
...
- (id)callsPassingTest:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateCallsWithOptions:(NSUInteger)arg1 invokingBlock:(id /* CDUnknownBlockType */)arg2 forCallsPassingTest:(id /* CDUnknownBlockType */)arg3;
- (void)enumerateCallsInvokingBlock:(id /* CDUnknownBlockType */)arg1 forCallsPassingTest:(id /* CDUnknownBlockType */)arg2;
- (id)init;
