...
+ (id /* CDUnknownBlockType */)legacyAddressBookIdentifierToContactIdentifierTransformBlock;
+ (void)setLegacyAddressBookIdentifierToContactIdentifierTransformBlock:(id /* CDUnknownBlockType */)arg1;
+ (void)setCallProviderManagerGeneratorBlock:(id /* CDUnknownBlockType */)arg1;
+ (id /* CDUnknownBlockType */)callProviderManagerGeneratorBlock;
+ (id)contactStore;
