...
- (void)_sendEncryptedRequestID:(id)arg1 request:(id)arg2 xpcID:(unsigned int)arg3 options:(id)arg4 sendEntry:(id)arg5 responseHandler:(id /* CDUnknownBlockType */)arg6;
- (void)sendEncryptedRequestID:(id)arg1 request:(id)arg2 xpcID:(unsigned int)arg3 options:(id)arg4 responseHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_sendEncryptedEventID:(id)arg1 data:(id)arg2 xid:(unsigned int)arg3 options:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)sendEncryptedEventID:(id)arg1 event:(id)arg2 options:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)sendEncryptedEventID:(id)arg1 data:(id)arg2 xid:(unsigned int)arg3 options:(id)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)_processSends;
- (void)_serverStarted;
...
- (void)_clientPairSetupPromptWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2 handler:(id /* CDUnknownBlockType */)arg3;
