...
- (void)remoteDisplayReceivedRequestID:(id)arg1 request:(id)arg2 options:(id)arg3 responseHandler:(id /* CDUnknownBlockType */)arg4 sessionID:(id)arg5;
...
- (void)remoteDisplayStartServerSessionID:(id)arg1 device:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
