...
- (void)_familyMember:(id)arg1 rawImageAndCropRect:(id /* CDUnknownBlockType */)arg2;
- (id)_familyMemberPersonPicture:(id)arg1;
- (void)_meCardRawImageAndCropRect:(id /* CDUnknownBlockType */)arg1;
- (void)_decodeImageAndCropRectForContact:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)_meCardPicture;
- (void)_fetchProfilePictureForFamilyMemberFromServer:(id)arg1 serverCacheTag:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)_profilePictureForFamilyMemberWithoutMonogramFallback:(id)arg1;
- (void)_fetchProfilePictureWithRequest:(id)arg1 personID:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_fetchProfilePictureSupersetWithRequest:(id)arg1 personID:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_fetchProfilePictureForAccountOwnerFromServer:(id)arg1 serverCacheTag:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)_correctlySizedImageFromImage:(id)arg1;
- (void)_fetchAndCacheRawImageAndCropRectWithRequest:(id)arg1 personID:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)fetchRawImageAndCropRectForFamilyMember:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)fetchRawImageAndCropRectForAccountOwner:(id /* CDUnknownBlockType */)arg1;
- (void)fetchProfilePictureForFamilyMember:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)profilePictureForFamilyMember:(id)arg1;
- (void)setProfilePictureForAccountOwner:(id)arg1 cropRect:(id)arg2;
- (void)fetchProfilePictureForAccountOwner:(id /* CDUnknownBlockType */)arg1;
