...
- (void)enumerateBitmapIndexUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (id)externalTags;
...
- (void)enumerateKeysAndObjectsWithoutIgnoringUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (BOOL)enumerateKeysAndObjectsUsingBlock:(id /* CDUnknownBlockType */)arg1;
