...
- (CGColor )newColorByProcessingColor:(CGColor )arg1;
- (id)processedImageFromShapePath:(CGPath )arg1 inRect:(CGRect)arg2;
- (CGImage )newFlattenedImageFromShapeCGImage:(CGImage )arg1;
- (CGImage )newFlattenedImageFromCGImage:(CGImage )arg1 withScale:(double)arg2 ciContext:(id)arg3;
- (CGImage )newFlattenedImageFromShapeCGImage:(CGImage )arg1 withScale:(double)arg2 ciContext:(id)arg3;
- (CGImage )_newFlattenedImageFromShapeCGImage:(CGImage )arg1 withScale:(double)arg2 ciContext:(id)arg3 blendOverImage:(BOOL)arg4;
- (CGImage )newFlattenedImageFromShapeCGImage:(CGImage )arg1 withScale:(double)arg2 cache:(BOOL)arg3;
- (CGImage )newFlattenedImageFromShapeCGImage:(CGImage )arg1 withScale:(double)arg2;
...
- (void)applyCustomForegroundColor:(CGColor )arg1 tintEffectColors:(BOOL)arg2;
- (void)applyCustomForegroundColor:(CGColor )arg1;
