...
- (void)_loadSourceContentWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_updateAndLoadSourceContent:(id)arg1 withArchivedModelData:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)_setData:(id)arg1 withArchivedModelData:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_setFileURL:(id)arg1 withArchivedModelData:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
