...
- (void)_flattenVideoWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_commitPendingAdjustmentsUpdateAndWait:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)notifyOfChange:(id)arg1 shouldReloadBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)commitPendingUpdatesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_savePreviewPosterFrameImage:(CGImage )arg1;
