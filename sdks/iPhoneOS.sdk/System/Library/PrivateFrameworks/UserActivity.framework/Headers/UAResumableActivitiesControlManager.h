...
// - (void).cxx_destruct;
- (BOOL)getAdvertisedBytes:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)setLocalReflect:(BOOL)arg1;
- (void)synchronize;
- (void)replayCommands:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)getSysdiagnoseStringsIncludingPrivateData:(BOOL)arg1;
- (void)peerDevices:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)callWillSaveDelegate:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
