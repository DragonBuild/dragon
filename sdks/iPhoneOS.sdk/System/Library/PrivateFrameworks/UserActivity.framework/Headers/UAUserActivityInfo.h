...
- (void)clearPayload;
- (BOOL)wasResumedOnAnotherDeviceWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (BOOL)requestPayloadWithCompletionHandlerEvenIfClean:(BOOL)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchAllNearbyAppSuggestions:(id /* CDUnknownBlockType */)arg1;
- (BOOL)requestPayloadWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
