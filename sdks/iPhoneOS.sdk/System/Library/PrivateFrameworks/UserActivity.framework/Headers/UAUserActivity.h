...
+ (id)fetchUserActivityWithUUID:(id)arg1 intervalToWaitForDocumentSynchronizationToComplete:(double)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
+ (void)fetchUserActivityWithUUID:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
+ (id)registerForSuggestedActionNudgeOfType:(NSUInteger)arg1 withOptions:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
...
+ (void)deleteAllSavedUserActivitiesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
+ (void)deleteSavedUserActivitiesWithPersistentIdentifiers:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)pinUserActivityWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)prepareUserActivityForLaunchingWithOptions:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)decodeUserInfo:(id)arg1;
- (id)encodeUserInfo:(id)arg1;
- (id)encodeUserInfo:(id)arg1 error:(id )arg2;
- (BOOL)encodeUserInfo:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;
- (id)unarchiveURL:(id)arg1 error:(id )arg2;
- (BOOL)archiveURL:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)invalidate;
@property(readonly, getter=isInvalidated) BOOL invalidated; // @synthesize invalidated=_invalidated;
- (void)resignCurrent;
- (void)_resignCurrent;
- (void)becomeCurrent;
- (void)getContinuationStreamsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)willSynchronizeUserActivityWithHandler:(id /* CDUnknownBlockType */)arg1;
...
- (BOOL)createUserActivityDataWithSaving:(BOOL)arg1 options:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_encodeIntoUserActivityDataWithSave:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (BOOL)createUserActivityStringsWithSaving:(BOOL)arg1 options:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_encodeIntoUserActivityStringWithSave:(BOOL)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (id /* CDUnknownBlockType */)payloadUpdateBlockForIdentifier:(id)arg1;
- (void)setPayloadIdentifier:(id)arg1 object:(id)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
