...
- (void)fetchPasteboardStatus:(id /* CDUnknownBlockType */)arg1;
- (void)fetchPasteboardDataForProcess:(int)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)doClearLocalPasteboardInfo;
- (void)fetchPasteboardTypesForProcess:(int)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)pickupLocalChanges:(id)arg1 iterNumber:(long long)arg2 cloneDir:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)writeLocalPasteboardToFile:(id)arg1 itemDir:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
