...
- (id)_addShareOperationAfterStartupWithName:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
- (id)_addShareOperationWithName:(id)arg1 block:(id /* CDUnknownBlockType */)arg2;
