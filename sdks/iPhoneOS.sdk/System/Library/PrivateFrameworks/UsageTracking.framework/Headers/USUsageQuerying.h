...
// - (void).cxx_destruct;
- (void)_enumerateEvents:(id)arg1 intervalEndDate:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
...
- (void)_enumerateCurrentWebUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
...
- (void)_enumerateCurrentApplicationUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
...
- (void)_computeUncategorizedLocalWebUsageWithApplicationUsageEvents:(id)arg1 webUsageEvents:(id)arg2 uncategorizedDomains:(id)arg3 interval:(id)arg4 referenceDate:(id)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)queryForUncategorizedLocalWebUsageDuringInterval:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_computeUsageWithDisplayBacklitEvents:(id)arg1 applicationUsageEvents:(id)arg2 webUsageEvents:(id)arg3 nowPlayingEvents:(id)arg4 notificationEvents:(id)arg5 categoryByBundleIdentifier:(id)arg6 categoryByWebDomain:(id)arg7 interval:(id)arg8 partitionInterval:(double)arg9 referenceDate:(id)arg10 completionHandler:(id /* CDUnknownBlockType */)arg11;
- (void)queryUsageDuringInterval:(id)arg1 partitionInterval:(double)arg2 focalOnly:(BOOL)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)queryUsageDuringInterval:(id)arg1 partitionInterval:(double)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (id)init;
