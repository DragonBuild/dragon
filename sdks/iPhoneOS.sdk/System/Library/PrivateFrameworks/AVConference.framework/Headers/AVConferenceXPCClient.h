...
- (void)registerBlockForService:(char )arg1 block:(id /* CDUnknownBlockType */)arg2 queue:(id)arg3 eventLogLevel:(int)arg4;
- (void)registerBlockForService:(char )arg1 block:(id /* CDUnknownBlockType */)arg2 queue:(id)arg3;
- (void)registerBlockForService:(char )arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (void)sendMessageAsync:(char )arg1 arguments:(id)arg2 xpcArguments:(id)arg3 reply:(id /* CDUnknownBlockType */)arg4 queue:(id)arg5;
- (void)sendMessageAsync:(char )arg1 arguments:(id)arg2 xpcArguments:(id)arg3 reply:(id /* CDUnknownBlockType */)arg4;
- (void)sendMessageAsync:(char )arg1 arguments:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3 queue:(id)arg4;
- (void)sendMessageAsync:(char )arg1 arguments:(id)arg2 reply:(id /* CDUnknownBlockType */)arg3;
