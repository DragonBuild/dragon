...
- (id)description;
- (void)dealloc;
- (id)initWithDelegate:(id)arg1 sourceContext:(void )arg2 sourceProcess:(/* void * /* void * CDUnknownFunctionPointerType */ */)arg3 sinkContext:(void )arg4 sinkProcess:(/* void * /* void * CDUnknownFunctionPointerType */ */)arg5 clientPid:(int)arg6;
