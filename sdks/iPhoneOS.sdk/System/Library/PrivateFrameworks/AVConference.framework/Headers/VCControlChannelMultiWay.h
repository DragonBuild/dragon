...
- (void)scheduleAfter:(unsigned int)arg1 block:(id /* CDUnknownBlockType */)arg2;
...
- (BOOL)sendReliableMessage:(id)arg1 participantID:(NSUInteger)arg2 timeout:(unsigned int)arg3 completion:(id /* CDUnknownBlockType */)arg4;
