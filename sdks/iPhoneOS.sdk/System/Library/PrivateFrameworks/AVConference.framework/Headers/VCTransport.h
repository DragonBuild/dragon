...
- (void)setARPLHandler:(id /* CDUnknownBlockType */)arg1;
...
- (int)setupDTLSSecurity:(unsigned int)arg1 connectionResult:(struct tagCONNRESULT )arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)registerDataReceivedHandler:(id /* CDUnknownBlockType */)arg1 forCallID:(unsigned int)arg2;
...
- (void)registerICEBlockForCallID:(unsigned int)arg1 connectedBlock:(id /* CDUnknownBlockType */)arg2 newCandidatesBlock:(id /* CDUnknownBlockType */)arg3 newNominationBlock:(id /* CDUnknownBlockType */)arg4 removeIPPortBlock:(id /* CDUnknownBlockType */)arg5;
