...
- (void)connectionBlobForParticipantID:(id)arg1 callID:(unsigned int)arg2 block:(id /* CDUnknownBlockType */)arg3 queue:(id)arg4 caller:(id)arg5;
- (void)inviteDataForParticipantID:(id)arg1 callID:(unsigned int)arg2 remoteInviteData:(id)arg3 nonCellularCandidateTimeout:(NSUInteger)arg4 block:(id /* CDUnknownBlockType */)arg5 queue:(id)arg6 caller:(id)arg7;
- (void)cleanupQueues;
...
- (void)session:(id)arg1 stopAudioWithCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)session:(id)arg1 startAudioWithFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo )arg2 internalFormat:(struct AudioStreamBasicDescription)arg3 internalSamplesPerFrame:(unsigned int)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
