...
- (void)setCompeletionHandler:(id /* CDUnknownBlockType */)arg1 forTransactionID:(id)arg2;
...
- (void)endRecording:(id)arg1 timestamp:(unsigned int)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)startRecording:(unsigned char)arg1 transactionID:(id)arg2 timestamp:(unsigned int)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)getLivePhotoWithTransactionID:(id)arg1 timestamp:(unsigned int)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)getPhotoWithTransactionID:(id)arg1 timestamp:(unsigned int)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
