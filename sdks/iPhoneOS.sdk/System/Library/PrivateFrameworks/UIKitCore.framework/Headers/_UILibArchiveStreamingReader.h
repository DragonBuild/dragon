...
- (BOOL)_readItemsWithShouldVisitBlock:(id /* CDUnknownBlockType */)arg1 visitorBlock:(id /* CDUnknownBlockType */)arg2 error:(id )arg3;
- (BOOL)readLogicalItemsWithBlock:(id /* CDUnknownBlockType */)arg1 error:(id )arg2;
- (BOOL)readAllItemsWithBlock:(id /* CDUnknownBlockType */)arg1 error:(id )arg2;
- (void)close;
- (BOOL)open;
