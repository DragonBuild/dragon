...
- (void)activityContinuationManager:(id)arg1 hideProgressUIWithCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)activityContinuationManager:(id)arg1 configureProgressUIWithError:(id)arg2;
- (void)activityContinuationManager:(id)arg1 displayProgressUI:(id)arg2 dismissalHandler:(id /* CDUnknownBlockType */)arg3;
