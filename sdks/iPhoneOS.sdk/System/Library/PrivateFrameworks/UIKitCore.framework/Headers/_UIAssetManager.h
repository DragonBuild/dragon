...
+ (void)_executeUnitTestWithAssetManagerCache:(id /* CDUnknownBlockType */)arg1;
...
- (id)_lookUpObjectForTraitCollection:(id)arg1 withAccessorWithAppearanceName:(id /* CDUnknownBlockType */)arg2;
...
- (void)_performBlockWithAssetLock:(id /* CDUnknownBlockType */)arg1;
