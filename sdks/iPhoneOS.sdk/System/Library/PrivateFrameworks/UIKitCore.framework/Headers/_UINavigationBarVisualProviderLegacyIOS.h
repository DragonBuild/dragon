...
- (void)_completeNavigationTransitionWithIncomingViews:(id)arg1 outgoingViews:(id)arg2 transitionAssistant:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_startPopAnimationFromOldBackItem:(id)arg1 oldTopItem:(id)arg2 newBackItem:(id)arg3 newTopItem:(id)arg4 withTransitionAssistant:(id)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (void)_startPushAnimationFromOldBackItem:(id)arg1 oldTopItem:(id)arg2 newBackItem:(id)arg3 newTopItem:(id)arg4 withTransitionAssistant:(id)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)popAnimated:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)pushAnimated:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)prepareForPop;
- (void)prepareForPush;
- (void)layoutSubviews;
...
- (BOOL)gestureRecognizerShouldBegin:(id)arg1 defaultAnswer:(id /* CDUnknownBlockType */)arg2;
