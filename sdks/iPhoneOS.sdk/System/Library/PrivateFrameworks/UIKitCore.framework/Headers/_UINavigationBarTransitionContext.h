...
- (void)_animateAsTwoPartsWithoutOverlap:(id /* CDUnknownBlockType */)arg1 partTwo:(id /* CDUnknownBlockType */)arg2;
- (void)_animateAsTwoPartsWithOverlapIfNecessaryPartOne:(id /* CDUnknownBlockType */)arg1 partTwo:(id /* CDUnknownBlockType */)arg2;
- (void)_animateAsTwoPartsWithOverlap:(double)arg1 partOne:(id /* CDUnknownBlockType */)arg2 partTwo:(id /* CDUnknownBlockType */)arg3;
...
- (void)prepare;
- (void)recordUpdates:(id /* CDUnknownBlockType */)arg1;
- (id)description;
