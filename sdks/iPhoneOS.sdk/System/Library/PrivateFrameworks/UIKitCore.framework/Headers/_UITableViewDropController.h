...
// - (void).cxx_destruct;
- (BOOL)commitPlaceholderInsertionWithContext:(id)arg1 dataSourceUpdates:(id /* CDUnknownBlockType */)arg2;
- (BOOL)deletePlaceholder:(id)arg1;
- (void)insertPlaceholderAtIndexPath:(id)arg1 withContext:(id)arg2 previewParametersProvider:(id /* CDUnknownBlockType */)arg3;
