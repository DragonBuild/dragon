...
- (void)_layoutAttributesForElementsInRect:(CGRect)arg1 handler:(id /* CDUnknownBlockType */)arg2;
...
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 layoutAxis:(int)arg3 dataSourceSnapshot:(id)arg4 options:(id)arg5 sectionProvider:(id /* CDUnknownBlockType */)arg6;
