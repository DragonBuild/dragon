...
// - (void).cxx_destruct;
- (void)addTapHandler:(id /* CDUnknownBlockType */)arg1;
- (void)addDismissalCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)addDismissalAnimations:(id /* CDUnknownBlockType */)arg1;
- (void)dismiss;
