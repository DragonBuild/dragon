...
- (id /* CDUnknownBlockType */)animationCompletionHandler;
- (void)performSpringAnimations:(id /* CDUnknownBlockType */)arg1;
- (void)performTrackingAnimations:(id /* CDUnknownBlockType */)arg1;
