...
- (id)dropToPlaceholderInsertedAtIndexPath:(id)arg1 reuseIdentifier:(id)arg2 forDragItem:(id)arg3 cellUpdateHandler:(id /* CDUnknownBlockType */)arg4;
- (id)dropToPlaceholderCellAtIndexPath:(id)arg1 reuseIdentifier:(id)arg2 forDragItem:(id)arg3 cellUpdateHandler:(id /* CDUnknownBlockType */)arg4;
...
- (id)dropItem:(id)arg1 toPlaceholderInsertedAtIndexPath:(id)arg2 withReuseIdentifier:(id)arg3 cellUpdateHandler:(id /* CDUnknownBlockType */)arg4;
@property(readonly, nonatomic) NSArray *items;
- (void)_performCancelDropToIndexPath:(id)arg1 forDragItem:(id)arg2;
- (BOOL)placeholderContext:(id)arg1 didCommitInsertionWithDataSourceUpdates:(id /* CDUnknownBlockType */)arg2;
- (void)placeholderContextNeedsCellUpdate:(id)arg1;
- (id)placeholderContextDidDismiss:(id)arg1;
- (id)insertPlaceholderForItemAtIndexPath:(id)arg1 forDragItem:(id)arg2 reuseIdentifier:(id)arg3 cellUpdateHandler:(id /* CDUnknownBlockType */)arg4;
...
- (id /* CDUnknownBlockType */)endReordering;
- (id /* CDUnknownBlockType */)cancelReordering;
