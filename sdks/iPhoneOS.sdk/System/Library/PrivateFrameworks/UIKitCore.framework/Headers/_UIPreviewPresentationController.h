...
- (void)_dismissForHandledActionWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_dismissForSelectionQuickActionAnimated;
- (void)_restorePlatterToInitialStatePositionAnimatedWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)_dismissPresentationWithCompletion:(id /* CDUnknownBlockType */)arg1;
