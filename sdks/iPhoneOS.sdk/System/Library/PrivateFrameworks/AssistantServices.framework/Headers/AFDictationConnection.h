...
+ (void)getForcedOfflineDictationSupportedLanguagesWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)requestOfflineDictationSupportForLanguage:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)endSession;
- (float)peakPower;
- (float)averagePower;
...
- (id /* CDUnknownBlockType */)startRecordingForPendingDictationWithLanguageCode:(id)arg1 options:(id)arg2 speechOptions:(id)arg3;
...
- (id)_dictationServiceWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_dispatchAsync:(id /* CDUnknownBlockType */)arg1;
