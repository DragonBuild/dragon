...
- (void)getSpokenNotificationTemporarilyDisabledForApp:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)getSpokenNotificationTemporarilyDisabledStatusWithCompletion:(id /* CDUnknownBlockType */)arg1;
