...
- (void)_waitWiProxAndExecute:(id /* CDUnknownBlockType */)arg1;
- (void)_waitWiProx:(long long)arg1 andExecute:(id /* CDUnknownBlockType */)arg2;
...
- (void)_advertiseWith:(id)arg1 afterDelay:(float)arg2 maxInterval:(float)arg3 thenExecute:(id /* CDUnknownBlockType */)arg4;
...
- (void)_duringNextWindowExecute:(id /* CDUnknownBlockType */)arg1;
...
- (void)_startTimer:(id)arg1 for:(float)arg2 thenExecute:(id /* CDUnknownBlockType */)arg3;
- (void)_startListenTimer;
- (void)_CreateDispatchTimerForEvent:(id)arg1 toExecute:(id /* CDUnknownBlockType */)arg2;
