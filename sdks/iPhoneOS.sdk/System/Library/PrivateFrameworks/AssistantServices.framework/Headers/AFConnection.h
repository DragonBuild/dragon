...
- (void)beginUpdateOutputAudioPowerWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)stopAllAudioPlaybackRequests:(BOOL)arg1;
- (void)stopAudioPlaybackRequest:(id)arg1 immediately:(BOOL)arg2;
- (void)startAudioPlaybackRequest:(id)arg1 options:(NSUInteger)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)checkLanguageReady:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)clearContext;
- (void)getRemoteClockTimerSnapshotWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)getCachedObjectsWithIdentifiers:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)getDeferredObjectsWithIdentifiers:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)sendReplyCommand:(id)arg1;
- (void)sendGenericAceCommand:(id)arg1 turnIdentifier:(NSUUID )arg2 conflictHandler:(id /* CDUnknownBlockType */)arg3;
- (void)sendGenericAceCommand:(id)arg1 conflictHandler:(id /* CDUnknownBlockType */)arg2;
...
- (id /* CDUnknownBlockType */)startRecordingAndGetContinueBlockForPendingSpeechRequestWithOptions:(id)arg1;
- (void)startRecordingForPendingSpeechRequestWithOptions:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)forceAudioSessionInactiveWithOptions:(NSUInteger)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)forceAudioSessionInactive;
- (void)forceAudioSessionActiveWithOptions:(NSUInteger)arg1 reason:(long long)arg2 speechRequestOptions:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)forceAudioSessionActiveWithOptions:(NSUInteger)arg1 reason:(long long)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)forceAudioSessionActiveWithOptions:(NSUInteger)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)forceAudioSessionActive;
- (void)boostedPreheatWithStyle:(long long)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_handleInterstitialPhase:(long long)arg1 fromProvider:(id)arg2 displayText:(id)arg3 speakableText:(id)arg4 context:(id)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)_willStartRequestWithSpeech:(BOOL)arg1 speechRequestOptions:(id)arg2 requestInfo:(id)arg3 analyticsEventProvider:(id /* CDUnknownBlockType */)arg4;
...
- (void)interstitialProvider:(id)arg1 handlePhase:(long long)arg2 displayText:(id)arg3 speakableText:(id)arg4 context:(id)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)_tellSpeechDelegateToPerformTwoShotPromptWithType:(long long)arg1 reply:(id /* CDUnknownBlockType */)arg2;
...
- (void)_dispatchCallbackGroupBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)_tellDelegateWillProcessStartPlayback:(long long)arg1 intent:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)_dispatchCommand:(id)arg1 isInterstitial:(BOOL)arg2 reply:(id /* CDUnknownBlockType */)arg3;
- (void)_handleCommand:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
- (void)_startUIRequestWithText:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_requestDidEnd;
- (void)_requestWillBeginWithRequestClass:(id)arg1 isSpeechRequest:(BOOL)arg2 speechRequestOptions:(id)arg3 requestInfo:(id)arg4 isBackgroundRequest:(BOOL)arg5 analyticsEventProvider:(id /* CDUnknownBlockType */)arg6;
- (void)_requestWillBeginWithRequestClass:(id)arg1 isSpeechRequest:(BOOL)arg2 speechRequestOptions:(id)arg3 requestInfo:(id)arg4 analyticsEventProvider:(id /* CDUnknownBlockType */)arg5;
...
- (void)requestBarrier:(id /* CDUnknownBlockType */)arg1;
...
- (id)_cachedBulletins;
- (id)_clientServiceWithErrorHandler:(id /* CDUnknownBlockType */)arg1;
- (id)_clientService;
