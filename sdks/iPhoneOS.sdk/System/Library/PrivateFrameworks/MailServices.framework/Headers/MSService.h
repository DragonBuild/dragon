...
- (void)_callServicesMethod:(id)arg1 arguments:(id)arg2 replyHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_callServicesMethod:(id)arg1 arguments:(id)arg2 callback:(id /* CDUnknownBlockType */)arg3;
