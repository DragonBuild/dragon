...
+ (id)defaultOptions;
+ (id)textResultsForCGImage:(CGImage )arg1 numberOfCandidates:(long long)arg2 title:(id )arg3 error:(id )arg4;
+ (id)textResultsForCGImage:(CGImage )arg1 numberOfCandidates:(long long)arg2 title:(id )arg3;
+ (id)textResultsForCGImage:(CGImage )arg1 numberOfCandidates:(long long)arg2;
...
// - (void).cxx_destruct;
- (void)cancel;
- (id)textResultsForImage:(id)arg1 roi:(CGRect)arg2 options:(id)arg3 error:(id )arg4 withProgressHandler:(id /* CDUnknownBlockType */)arg5 title:(id )arg6;
...
- (id)textResultsForImage:(id)arg1 options:(id)arg2 withProgressHandler:(id /* CDUnknownBlockType */)arg3 title:(id )arg4;
- (id)textResultsForImage:(id)arg1 options:(id)arg2 title:(id )arg3;
- (id)textResultsForImage:(id)arg1 options:(id)arg2;
- (id)textResultsForImageAtURL:(id)arg1 options:(id)arg2 withProgressHandler:(id /* CDUnknownBlockType */)arg3;
...
- (id)resultsForPixelBuffer:(struct __CVBuffer )arg1 roi:(CGRect)arg2 options:(id)arg3 error:(id )arg4 withProgressHandler:(id /* CDUnknownBlockType */)arg5;
...
- (void)enumerateInputsForFeatures:(id)arg1 widthIndex:(long long)arg2 inImage:(id)arg3 options:(id)arg4 usingBlock:(id /* CDUnknownBlockType */)arg5;
- (id)mleTextRecognizerResultsForTextFeatures:(id)arg1 inImage:(id)arg2 options:(id)arg3 withProgressHandler:(id /* CDUnknownBlockType */)arg4 title:(id )arg5 error:(id )arg6;
...
- (struct __CVBuffer )pixelBufferFromCGImage:(CGImage )arg1 withScale:(double)arg2 paddedToSize:(CGSize)arg3;
- (struct __CVBuffer )pixelBufferFromCGImage:(CGImage )arg1 withScale:(float)arg2;
- (struct __CVBuffer )grayscalePixelBufferFromCGImage:(CGImage )arg1 withScale:(float)arg2;
- (id)mleTextDetectorResultsForImage:(id)arg1 options:(id)arg2 error:(id )arg3;
- (id)mleTextResultsInImage:(id)arg1 options:(id)arg2 withProgressHandler:(id /* CDUnknownBlockType */)arg3 title:(id )arg4 error:(id )arg5;
...
- (id)lfpTextResultsInImage:(id)arg1 options:(id)arg2 withProgressHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)fkcrEnumerateInputsForFeatures:(id)arg1 widthIndex:(long long)arg2 inImage:(id)arg3 options:(id)arg4 usingBlock:(id /* CDUnknownBlockType */)arg5;
- (id)fkcrTextRecognizerResultsForTextFeatures:(id)arg1 inImage:(id)arg2 options:(id)arg3 withProgressHandler:(id /* CDUnknownBlockType */)arg4 title:(id )arg5;
...
- (struct __CVBuffer )fkcrGrayscalePixelBufferFromCGImage:(CGImage )arg1 withScale:(float)arg2;
...
- (id)fkcrTextResultsInImage:(id)arg1 options:(id)arg2 withProgressHandler:(id /* CDUnknownBlockType */)arg3 title:(id )arg4;
