...
+ (void)presentAssistantEnableAlertForState:(BOOL)arg1 presentingViewController:(id)arg2 actionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)showAssistantConfirmationViewForSpecifier:(id)arg1 presentingViewController:(id)arg2 actionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)confirmDisableWithSpecifier:(id)arg1 pairedWatch:(BOOL)arg2 presentingViewController:(id)arg3 actionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)confirmDisableForMultiUserVoiceIdentificationWithSpecifier:(id)arg1 pairedWatch:(BOOL)arg2 presentingViewController:(id)arg3 actionHandler:(id /* CDUnknownBlockType */)arg4;
- (void)_setAssistantEnabled:(id)arg1 forSpecifier:(id)arg2 presentingViewController:(id)arg3 actionHandler:(id /* CDUnknownBlockType */)arg4;
