...
- (void)_onSerialQueue_sendRequest:(id)arg1 withInternalResponseHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_sendRequest:(id)arg1 withInternalResponseHandler:(id /* CDUnknownBlockType */)arg2;
- (unsigned int)_sapVersionForConnectionType;
- (void)_loadDatabaseWithInternalConnectionCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_continueFPSetupNegotiationWithData:(id)arg1 internalConnectionCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)checkForDatabaseUpdatesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
