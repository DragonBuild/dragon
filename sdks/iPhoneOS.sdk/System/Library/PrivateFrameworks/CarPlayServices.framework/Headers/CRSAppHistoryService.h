...
- (void)fetchSessionEchoContextStatesWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)fetchSessionUIContextStatesWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)fetchUIContextStatesWithCompletion:(id /* CDUnknownBlockType */)arg1;
