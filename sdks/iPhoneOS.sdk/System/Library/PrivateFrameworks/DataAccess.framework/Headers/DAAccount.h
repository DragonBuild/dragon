...
- (BOOL)canSaveWithAccountProvider:(id /* CDUnknownBlockType */)arg1;
- (BOOL)preflightSaveWithAccountProvider:(id /* CDUnknownBlockType */)arg1;
...
- (void)saveAccountPropertiesWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)performUsingAccountPersona:(id /* CDUnknownBlockType */)arg1;
...
- (void)dealloc;
- (BOOL)handleTrustChallenge:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (BOOL)handleTrustChallenge:(id)arg1;
- (id)getAppleIDSession;
- (void)removeFromCoreDAVLoggingDelegates;
- (void)addToCoreDAVLoggingDelegates;
- (void)handleValidationError:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)webLoginRequestedAtURL:(id)arg1 reasonString:(id)arg2 inQueue:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)_webLoginRequestedAtURL:(id)arg1 reasonString:(id)arg2 inQueue:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)dropAssertionsAndRenewCredentialsInQueue:(id)arg1 withHandler:(id /* CDUnknownBlockType */)arg2;
