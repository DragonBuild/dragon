...
- (BOOL)_sessionReceivedRequest:(id)arg1 flags:(unsigned int)arg2 responseHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_sendRequestWithFlags:(unsigned int)arg1 object:(id)arg2 responseHandler:(id /* CDUnknownBlockType */)arg3;
- (void)sendRequestWithFlags:(unsigned int)arg1 object:(id)arg2 responseHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)appleIDVerifyProof:(id)arg1 dispatchQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_appleIDAddProof:(id)arg1 error:(id )arg2;
- (void)appleIDAddProof:(id)arg1 dispatchQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
