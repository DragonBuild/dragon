...
- (void)unlockManagerWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)streamsForMessage:(id)arg1 withCompletionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)serviceManagerProxyForIdentifier:(id)arg1 client:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
