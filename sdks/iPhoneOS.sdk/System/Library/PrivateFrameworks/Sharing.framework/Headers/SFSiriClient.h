...
- (void)deviceSetupPlayGreetingID:(int)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)deviceSetupPrepareGreeting:(id /* CDUnknownBlockType */)arg1;
...
- (void)stopSpeaking;
- (void)_speakText:(id)arg1 languageCode:(id)arg2 flags:(unsigned int)arg3 rate:(double)arg4 delay:(double)arg5 startHandler:(id /* CDUnknownBlockType */)arg6 completion:(id /* CDUnknownBlockType */)arg7;
- (void)speakText:(id)arg1 flags:(unsigned int)arg2 rate:(double)arg3 delay:(double)arg4 startHandler:(id /* CDUnknownBlockType */)arg5 completion:(id /* CDUnknownBlockType */)arg6;
- (void)speakText:(id)arg1 languageCode:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)speakText:(id)arg1 rate:(double)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)speakText:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_speakPasscode:(id)arg1 instructions:(id)arg2 languageCode:(id)arg3 flags:(unsigned int)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)speakPasscode:(id)arg1 instructions:(id)arg2 languageCode:(id)arg3 flags:(unsigned int)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)speakDeviceSetupWelcomePhaseWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)preWarmDeviceSetupWelcomePhaseWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_invalidate;
