...
- (void)_siriGreetingStart:(id /* CDUnknownBlockType */)arg1;
- (void)_playReadyToSetupSound;
- (void)_handleSiriDialogIdentifier:(id)arg1;
- (void)_handleRawRequest:(id)arg1 flags:(unsigned int)arg2 responseHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_handlePreAuthRequest:(id)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_handlePlaySoundRequest:(id)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
- (BOOL)_handleFinishDone2Ready;
- (void)_handleFinishDone2:(unsigned int)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_handleFinishDone:(unsigned int)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_handleFinishApply:(id)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_handleAuthActionSiriStart:(id)arg1 response:(id)arg2 responseHandler:(id /* CDUnknownBlockType */)arg3;
- (void)_handleAuthActionSiriInit;
- (void)_handleAuthActionRequest:(id)arg1 responseHandler:(id /* CDUnknownBlockType */)arg2;
