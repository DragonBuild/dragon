...
- (void)getAutoDownloadedVoiceAssetsWithClientID:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
...
- (oneway void)cleanUnusedAssets:(id /* CDUnknownBlockType */)arg1;
...
- (void)estimateDurationWithRequest:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
