...
+ (id)imageForType:(int)arg1 dayTime:(BOOL)arg2 generation:(id /* CDUnknownBlockType */)arg3 ignoreCache:(BOOL)arg4;
+ (id)imageForType:(int)arg1 dayTime:(BOOL)arg2 generation:(id /* CDUnknownBlockType */)arg3;
