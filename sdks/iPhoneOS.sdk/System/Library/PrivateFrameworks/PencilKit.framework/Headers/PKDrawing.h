...
+ (id)_upgradeDrawingData:(id)arg1 queue:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)performSearchQuery:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (id)indexableContent;
...
- (void)updateStrokes:(id /* CDUnknownBlockType */)arg1;
- (void)setStrokeSubstrokes:(id)arg1;
- (id)updateStroke:(id)arg1 updater:(id /* CDUnknownBlockType */)arg2;
...
- (void)_updateStrokes:(id)arg1 updateBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)_imageInRect:(CGRect)arg1 scale:(double)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (id)_upgradeOnQueue:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
