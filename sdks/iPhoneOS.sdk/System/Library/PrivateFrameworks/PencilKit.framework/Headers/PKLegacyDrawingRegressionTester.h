...
+ (double)compareImage:(CGImage )arg1 with:(CGImage )arg2 drawing:(id)arg3;
...
+ (CGImage )createFilteredImageFromImage:(id)arg1 context:(id)arg2 filterRadius:(double)arg3;
