...
- (void)_updateCollectionViewWithUpdates:(id /* CDUnknownBlockType */)arg1;
...
- (void)_enumerateVisibleSectionsUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)_enumerateSectionContextsUsingBlock:(id /* CDUnknownBlockType */)arg1;
