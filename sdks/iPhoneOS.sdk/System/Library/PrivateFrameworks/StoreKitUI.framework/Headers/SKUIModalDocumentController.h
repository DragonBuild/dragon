...
- (void)_popPopoverStackItem:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_popOverlayStackItem:(id)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (BOOL)_popoverController:(id)arg1 containsStackItem:(id)arg2;
- (void)_popDocument:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
