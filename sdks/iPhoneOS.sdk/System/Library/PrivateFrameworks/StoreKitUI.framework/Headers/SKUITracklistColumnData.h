...
- (void)enumerateColumnsForTrack:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateColumnsForHeader:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
