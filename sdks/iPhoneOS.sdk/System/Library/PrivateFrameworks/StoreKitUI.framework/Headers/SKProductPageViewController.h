...
+ (void)_validateURL:(id)arg1 withURLBag:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
+ (id)_defaultClientIdentifier;
+ (id)_defaultClientInterface;
+ (void)getCanLoadWithURL:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
