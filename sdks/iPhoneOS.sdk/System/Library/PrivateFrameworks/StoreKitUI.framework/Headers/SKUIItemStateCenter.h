...
- (void)_performSoftwarePurchases:(id)arg1 withClientContext:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)_performPurchases:(id)arg1 hasBundlePurchase:(BOOL)arg2 withClientContext:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
...
- (void)_enumerateAvailableItemsForLibraryItems:(id)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)purchaseTone:(id)arg1 withProperties:(id)arg2 clientContext:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (id)gratisEligibleItemIdentifiers;
- (void)findLibraryItemsForContentIdentifiers:(id)arg1 options:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)reloadFromServerWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)reloadSoftwareUpdatesFromServerWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)performActionForLibraryItem:(id)arg1;
- (void)getUpdatesWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
- (void)getSoftwareUpdatesWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)purchaseItems:(id)arg1 withClientContext:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (void)purchaseItems:(id)arg1 withCompletionBlock:(id /* CDUnknownBlockType */)arg2;
- (void)purchaseSoftwareItem:(id)arg1 offer:(id)arg2 clientContext:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (void)purchaseItem:(id)arg1 offer:(id)arg2 clientContext:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (id)performActionForSoftwareItem:(id)arg1 offer:(id)arg2 clientContext:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (id)performActionForItem:(id)arg1 offer:(id)arg2 clientContext:(id)arg3 completionBlock:(id /* CDUnknownBlockType */)arg4;
- (id)performActionForItem:(id)arg1 clientContext:(id)arg2;
- (id)performActionForItem:(id)arg1 clientContext:(id)arg2 completionBlock:(id /* CDUnknownBlockType */)arg3;
- (id)performActionForItem:(id)arg1 withCompletionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)finishLoadingWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
