...
@property(readonly, nonatomic) _NSRange giftAmountRange; // @synthesize giftAmountRange=_giftAmountRange;
...
- (void)_finishLoadAccountInfoWithResponse:(id)arg1 error:(id)arg2 block:(id /* CDUnknownBlockType */)arg3;
