...
- (void)_handleiTunesResponseForBundleIdentifiers:(id)arg1 response:(id)arg2 data:(id)arg3 error:(id)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
- (void)_fetchAppStoreInfoAndNotifyWithBundleIdentifiers:(id)arg1 timeoutInterval:(double)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)fetchAppInfoForBundleIdentifiers:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)fetchAppInfoForBundleIdentifier:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
