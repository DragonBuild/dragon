...
- (void)importWorkflowAtURL:(id)arg1 withSuggestedName:(id)arg2 fromSourceApplication:(id)arg3 options:(NSUInteger)arg4 completion:(id /* CDUnknownBlockType */)arg5;
