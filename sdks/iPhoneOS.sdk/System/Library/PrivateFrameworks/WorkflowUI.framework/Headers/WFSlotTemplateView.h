...
- (BOOL)textAttachmentInteraction:(id)arg1 shouldRecognizeTapOnTextAttachment:(id)arg2 inCharacterRange:(_NSRange)arg3;
- (id)slotIdentifierForAttachmentInteraction:(id)arg1 characterRange:(_NSRange)arg2;
