...
+ (id)newWithAttributes:(const struct WFTagFieldAttributes )arg1 updateBlock:(id /* CDUnknownBlockType */)arg2 variableBlock:(id /* CDUnknownBlockType */)arg3 navigationContext:(id)arg4 size:(const struct CKComponentSize )arg5;
