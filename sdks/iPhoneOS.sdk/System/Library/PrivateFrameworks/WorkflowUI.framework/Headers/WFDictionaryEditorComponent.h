...
+ (id)newWithKeyValuePairs:(id)arg1 variableProvider:(id)arg2 variableUIDelegate:(id)arg3 navigationContext:(id)arg4 localizedNewItemTypeName:(id)arg5 variablesDisabled:(BOOL)arg6 allowedValueTypes:(id)arg7 allowedVariableTypes:(id)arg8 editable:(BOOL)arg9 updateBlock:(id /* CDUnknownBlockType */)arg10 size:(const struct CKComponentSize )arg11;
