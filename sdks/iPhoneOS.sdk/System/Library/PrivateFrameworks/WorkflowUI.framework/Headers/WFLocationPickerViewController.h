...
- (void)getPlacemarkFromLocation:(id)arg1 streetAddress:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
- (void)getMapItemFromRecentContact:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
