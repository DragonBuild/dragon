...
+ (id)newWithItems:(id)arg1 editable:(BOOL)arg2 variableProvider:(id)arg3 variableUIDelegate:(id)arg4 navigationContext:(id)arg5 variablesDisabled:(BOOL)arg6 allowedValueTypes:(id)arg7 allowedVariableTypes:(id)arg8 standaloneVariablesAsContentItems:(BOOL)arg9 updateBlock:(id /* CDUnknownBlockType */)arg10 confirmationAction:(CKTypedComponentAction_9dede3e0)arg11 size:(const struct CKComponentSize )arg12;
