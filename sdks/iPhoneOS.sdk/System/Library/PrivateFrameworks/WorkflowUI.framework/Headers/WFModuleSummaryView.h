...
+ (void)enumerateVariableAttachmentsInContents:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)slotTemplateView:(id)arg1 typingDidPasteWithOriginalBlock:(id /* CDUnknownBlockType */)arg2;
- (void)slotTemplateView:(id)arg1 typingDidCopyWithOriginalBlock:(id /* CDUnknownBlockType */)arg2;
- (void)slotTemplateView:(id)arg1 typingDidCutWithOriginalBlock:(id /* CDUnknownBlockType */)arg2;
