...
- (void)clearQuickLook;
- (void)updateQuickLookWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)stopWorkflow;
- (void)runWorkflowFromSource:(id)arg1 withInput:(id)arg2 currentState:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
...
- (void)dismissViewControllerWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
