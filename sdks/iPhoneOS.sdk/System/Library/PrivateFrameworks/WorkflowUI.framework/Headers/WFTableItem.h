...
+ (id)itemWithCellClass:(Class)arg1 representedObject:(id)arg2 configurationBlock:(id /* CDUnknownBlockType */)arg3;
+ (id)itemWithStyle:(long long)arg1 representedObject:(id)arg2 configurationBlock:(id /* CDUnknownBlockType */)arg3;
