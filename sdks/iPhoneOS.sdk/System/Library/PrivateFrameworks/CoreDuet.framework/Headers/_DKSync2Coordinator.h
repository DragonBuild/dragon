...
- (void)__finishSyncWithTransaction:(id)arg1 startDate:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)__performSyncWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_performSyncWithSyncType:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_synchronizeWithUrgency:(NSUInteger)arg1 client:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_performSyncWithForceSync:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
