...
- (id)addStatusChangeObserverWithBlock:(id /* CDUnknownBlockType */)arg1;
...
- (void)_modifyActiveTransportInPeer:(id)arg1 withNewTransportsBlock:(id /* CDUnknownBlockType */)arg2;
