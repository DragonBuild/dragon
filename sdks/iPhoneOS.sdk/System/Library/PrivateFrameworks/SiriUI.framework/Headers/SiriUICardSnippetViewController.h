...
- (BOOL)cardLoader:(id)arg1 loadCard:(id)arg2 withCompletionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_validateCardSectionForParsecFeedbackDelivery:(id)arg1 validHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_validateCardForParsecFeedbackDelivery:(id)arg1 validHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_beginMonitoringForNextCardWithBlock:(id /* CDUnknownBlockType */)arg1;
