...
- (void)siriViewController:(id)arg1 speakText:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)siriViewController:(id)arg1 openURL:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (BOOL)siriViewController:(id)arg1 openURL:(id)arg2;
- (void)siriViewController:(id)arg1 performAceCommands:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)siriViewController:(id)arg1 performAceCommands:(id)arg2;
- (double)siriSnippetViewControllerExpectedWidth:(id)arg1;
- (void)siriSnippetViewController:(id)arg1 setStatusBarHidden:(BOOL)arg2 animated:(BOOL)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)siriSnippetViewController:(id)arg1 requestPasscodeUnlockWithCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)siriSnippetViewController:(id)arg1 shouldPresentPicker:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
