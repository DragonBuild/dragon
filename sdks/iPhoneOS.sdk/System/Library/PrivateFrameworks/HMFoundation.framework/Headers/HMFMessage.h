...
+ (id)messageWithMessage:(id)arg1 messagePayload:(id)arg2 responseHandler:(id /* CDUnknownBlockType */)arg3;
+ (id)messageWithMessage:(id)arg1 messagePayload:(id)arg2;
+ (id)messageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;
+ (id)messageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(id /* CDUnknownBlockType */)arg3;
...
- (id)init;
- (id)initWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3 responseHandler:(id /* CDUnknownBlockType */)arg4;
