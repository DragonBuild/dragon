...
- (id)logIdentifier;
- (void)_reallyResolveWithTimeout:(double)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)confirmWithTimeout:(double)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)resolveWithTimeout:(double)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (id)bestAddress;
