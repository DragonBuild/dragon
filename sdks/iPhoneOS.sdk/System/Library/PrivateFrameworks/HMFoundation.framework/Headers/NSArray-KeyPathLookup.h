...
- (id)hmf_objectsWithOptions:(NSUInteger)arg1 passingTest:(id /* CDUnknownBlockType */)arg2;
- (id)hmf_objectsPassingTest:(id /* CDUnknownBlockType */)arg1;
- (id)hmf_objectWithOptions:(NSUInteger)arg1 passingTest:(id /* CDUnknownBlockType */)arg2;
- (id)hmf_objectPassingTest:(id /* CDUnknownBlockType */)arg1;
- (BOOL)hmf_objectsAreKindOfClass:(Class)arg1;
@property(readonly, getter=hmf_isEmpty) BOOL hmf_empty;
@property(readonly, copy) NSString *privateDescription;
@property(readonly, copy) NSString *shortDescription;
- (id)describeElements:(id /* CDUnknownBlockType */)arg1;
