...
+ (void)waitForFuturesToComplete:(id)arg1 withCallback:(id /* CDUnknownBlockType */)arg2;
...
+ (id)createAfter:(id)arg1 onCreate:(id /* CDUnknownBlockType */)arg2;
+ (id)futureForObject:(id)arg1 withKey:(void )arg2 onCreate:(id /* CDUnknownBlockType */)arg3;
...
- (id /* CDUnknownBlockType */)completer;
- (BOOL)completeWithResult:(id)arg1 error:(id)arg2;
- (BOOL)fail:(id)arg1;
- (BOOL)succeed:(id)arg1;
- (id)error;
- (id)result;
- (void)_wait:(id /* CDUnknownBlockType */)arg1 forSyncAPI:(BOOL)arg2;
- (void)wait:(id /* CDUnknownBlockType */)arg1;
- (id)wait;
