...
- (void)suggestionsFromMockData:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)isEventCandidateForURL:(id)arg1 andTitle:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (void)eventsForSchemas:(id)arg1 usingStore:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)keysForSchemas:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)updateMessages:(id)arg1 state:(NSUInteger)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)spotlightReimportFromIdentifier:(id)arg1 forPersonHandle:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (BOOL)spotlightReimportFromIdentifier:(id)arg1 forPersonHandle:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 error:(id )arg5;
- (void)addInteractions:(id)arg1 bundleId:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (BOOL)addInteractions:(id)arg1 bundleId:(id)arg2 error:(id )arg3;
- (void)_addSearchableItemMetadata:(id)arg1 htmlData:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)addSearchableItems:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)addSearchableItems:(id)arg1 error:(id )arg2;
- (void)predictedCCEmailAddressesWithToAddresses:(id)arg1 ccAddresses:(id)arg2 fromAddress:(id)arg3 date:(double)arg4 bounds:(id)arg5 withCompletion:(id /* CDUnknownBlockType */)arg6;
...
- (void)predictedToEmailAddressesWithToAddresses:(id)arg1 ccAddresses:(id)arg2 fromAddress:(id)arg3 date:(double)arg4 bounds:(id)arg5 withCompletion:(id /* CDUnknownBlockType */)arg6;
...
- (void)rejectCuratedContactDetail:(id)arg1 from:(id)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (BOOL)rejectCuratedContactDetail:(id)arg1 from:(id)arg2 error:(id )arg3;
- (void)rejectContactDetailRecord:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)rejectContactDetailRecord:(id)arg1 error:(id )arg2;
- (void)rejectRecord:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)rejectRecord:(id)arg1 error:(id )arg2;
- (void)rejectContact:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)rejectContact:(id)arg1 error:(id )arg2;
- (void)rejectEventByRecordId:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)rejectEventByRecordId:(id)arg1 error:(id )arg2;
- (void)confirmEventByRecordId:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)confirmEventByRecordId:(id)arg1 error:(id )arg2;
- (void)confirmContactDetailRecord:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)confirmContactDetailRecord:(id)arg1 error:(id )arg2;
- (void)confirmRecord:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)confirmRecord:(id)arg1 error:(id )arg2;
- (void)confirmContact:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)confirmContact:(id)arg1 error:(id )arg2;
- (void)rejectEvent:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)rejectEvent:(id)arg1 error:(id )arg2;
- (void)confirmEvent:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)confirmEvent:(id)arg1 error:(id )arg2;
- (void)originFromRecordId:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (id)originFromRecordId:(id)arg1 error:(id )arg2;
- (void)launchAppForSuggestedEventUsingLaunchInfo:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)launchAppForSuggestedEventUsingLaunchInfo:(id)arg1 error:(id )arg2;
- (void)launchInfoForSuggestedEventWithUniqueIdentifier:(id)arg1 sourceURL:(id)arg2 clientLocale:(id)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (id)launchInfoForSuggestedEventWithUniqueIdentifier:(id)arg1 sourceURL:(id)arg2 clientLocale:(id)arg3 error:(id )arg4;
- (void)eventFromUniqueId:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)namesForDetail:(id)arg1 limitTo:(NSUInteger)arg2 prependMaybe:(BOOL)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
...
- (void)reminderAlarmTriggeredForRecordId:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)reminderAlarmTriggeredForRecordId:(id)arg1 error:(id )arg2;
- (void)rejectRealtimeReminder:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)rejectRealtimeReminder:(id)arg1 error:(id )arg2;
- (void)rejectReminderByRecordId:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)rejectReminderByRecordId:(id)arg1 error:(id )arg2;
- (void)confirmRealtimeReminder:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (BOOL)confirmRealtimeReminder:(id)arg1 error:(id )arg2;
- (void)confirmReminderByRecordId:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)suggestEventsInFutureLimitTo:(NSUInteger)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (id)suggestEventsInFutureLimitTo:(NSUInteger)arg1 error:(id )arg2;
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (id)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 error:(id )arg5;
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 withCompletion:(id /* CDUnknownBlockType */)arg4;
- (id)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 error:(id )arg4;
- (void)suggestEventsInFutureLimitTo:(NSUInteger)arg1 options:(unsigned int)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (id)suggestEventsInFutureLimitTo:(NSUInteger)arg1 options:(unsigned int)arg2 error:(id )arg3;
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 options:(unsigned int)arg5 withCompletion:(id /* CDUnknownBlockType */)arg6;
...
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 options:(unsigned int)arg4 withCompletion:(id /* CDUnknownBlockType */)arg5;
- (id)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 options:(unsigned int)arg4 error:(id )arg5;
- (void)waitForEventWithIdentifier:(id)arg1 toAppearInEventStoreWithCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (id)registerEventsChangeObserver:(id /* CDUnknownBlockType */)arg1;
- (BOOL)deregisterContactsChangeObserverWithToken:(id)arg1;
- (id)registerContactsChangeObserver:(id /* CDUnknownBlockType */)arg1;
...
- (void)suggestContactMatchesWithMessagingPrefix:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
- (id)suggestContactMatchesWithMessagingPrefix:(id)arg1 limitTo:(NSUInteger)arg2 error:(id )arg3;
- (void)suggestContactMatchesWithFullTextSearch:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(id /* CDUnknownBlockType */)arg3;
...
- (void)resetConfirmationAndRejectionHistoryWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (BOOL)resetConfirmationAndRejectionHistory:(id )arg1;
- (void)prepareForRealtimeExtractionWithCompletion:(id /* CDUnknownBlockType */)arg1;
