...
// - (void).cxx_destruct;
- (void)playListenEndSound:(id /* CDUnknownBlockType */)arg1;
- (void)playListenSound:(id /* CDUnknownBlockType */)arg1;
- (void)_playSoundWithURL:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
