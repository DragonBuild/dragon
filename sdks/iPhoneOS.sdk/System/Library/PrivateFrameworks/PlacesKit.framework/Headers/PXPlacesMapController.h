...
- (void)_updateMapWithDataSource:(id)arg1 dataSourceChange:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)executePipeline:(id)arg1 dataSourceChange:(id)arg2 context:(id)arg3;
- (void)_updateMapWithDataSources:(id)arg1 dataSourceChangeTable:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_updateMapWithAllDataSources:(id /* CDUnknownBlockType */)arg1;
...
- (void)runPipelines;
- (void)resumePipelines:(id /* CDUnknownBlockType */)arg1;
