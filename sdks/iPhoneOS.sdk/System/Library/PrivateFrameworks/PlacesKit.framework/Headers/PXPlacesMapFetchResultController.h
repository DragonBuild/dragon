...
- (void)loadProvidedAssetStoreWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)loadFetchResult:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)loadFetchResults:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)reloadContentModeWithCompletion:(id /* CDUnknownBlockType */)arg1;
