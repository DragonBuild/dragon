...
- (void)wipeStoreAtNextOpeningWithReason:(id)arg1 completionBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)performBatchedWriteTransactionWithBlock:(id /* CDUnknownBlockType */)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_reallyPerformBatchedTransactionsLocked;
- (void)_scheduleBatchedTransactionsLocked;
- (id)performWriteTransactionWithBlock:(id /* CDUnknownBlockType */)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
- (void)_commitWriteTransaction:(id)arg1 commitError:(id)arg2;
- (void)writeTransactionDidFail;
- (void)writeTransactionDidSucceed;
- (id)performReadTransactionWithBlock:(id /* CDUnknownBlockType */)arg1;
- (void)openWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_performTransaction:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
