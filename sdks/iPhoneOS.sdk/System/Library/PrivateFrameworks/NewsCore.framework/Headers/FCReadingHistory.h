...
- (void)_modifyHistoryForArticleID:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)markArticleAsReadWithHeadline:(id)arg1 fromGroupType:(long long)arg2 swipedToArticle:(BOOL)arg3 onScreenChecker:(id /* CDUnknownBlockType */)arg4;
