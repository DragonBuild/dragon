...
- (void)_savePendingCommandsWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)_loadFromDisk;
...
- (void)_addCommand:(id)arg1 saveCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)addCommand:(id)arg1 saveCompletion:(id /* CDUnknownBlockType */)arg2;
