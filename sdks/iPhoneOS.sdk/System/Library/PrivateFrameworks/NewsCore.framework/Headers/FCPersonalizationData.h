...
- (void)enumerateAggregatesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (id)aggregatesForFeatureKeys:(id)arg1;
- (void)activityObservingApplicationDidEnterBackground;
- (void)_reloadTreatment;
- (void)_applicationDidEnterBackground;
- (void)_closeOpenChangeGroupFromInstance:(id)arg1;
- (void)_writeToLocalStoreWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)generateDerivedDataWithQualityOfService:(long long)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)d_allResults:(id /* CDUnknownBlockType */)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)prepareAggregatesForUseWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (void)updateFeatures:(id)arg1 withAction:(NSUInteger)arg2 displayRank:(long long)arg3 groupRank:(long long)arg4 individually:(BOOL)arg5 configurableValues:(id)arg6 featuresUpdatedBlock:(id /* CDUnknownBlockType */)arg7;
