...
- (id)_storefrontID;
- (void)_fetchRemoteMagazinesConfigurationIfNeededWithCompletionQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_fetchRemoteAppWidgetConfigurationIfNeededUseBackgroundRefreshRate:(BOOL)arg1 completionQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)_refreshAppConfigurationWithConfigurationSettings:(id)arg1 force:(BOOL)arg2 completionQueue:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_fetchAppConfigurationIfNeededWithCompletionQueue:(id)arg1 forceRefresh:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (void)removeObserver:(id)arg1;
- (void)addObserver:(id)arg1;
- (void)fetchConfigurationIfNeededWithCompletionQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)fetchConfigurationIfNeededWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)fetchTrendingSearchesIfNeededWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)fetchMagazinesConfigurationIfNeededWithCompletionQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)fetchAppWidgetConfigurationUseBackgroundRefreshRate:(BOOL)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)refreshAppConfigurationIfNeededWithCompletionQueue:(id)arg1 refreshCompletion:(id /* CDUnknownBlockType */)arg2;
- (void)fetchAppConfigurationIfNeededWithCompletionQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)fetchAppConfigurationIfNeededWithCompletion:(id /* CDUnknownBlockType */)arg1;
