...
- (void)_fetchDataProviderForAssetHandle:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)_populateRawFilePathForAssetHandle:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (id)operationToFetchDataProviderForAssetHandle:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
