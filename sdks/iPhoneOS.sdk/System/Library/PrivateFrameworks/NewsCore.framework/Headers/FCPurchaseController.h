...
- (void)submitWebAccessWithTagID:(id)arg1 purchaseID:(id)arg2 emailAddress:(id)arg3 purchaseReceipt:(id)arg4 serialCompletion:(id /* CDUnknownBlockType */)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)performHTTPRequestForVerifyAccessTokenWithURL:(id)arg1 accessToken:(id)arg2 consumedArticleCount:(NSUInteger)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)verifyAccessTokenWithTagID:(id)arg1 accessToken:(id)arg2 consumedArticleCount:(NSUInteger)arg3 serialCompletion:(id /* CDUnknownBlockType */)arg4 callbackQueue:(id)arg5 completion:(id /* CDUnknownBlockType */)arg6;
...
- (void)removeFromPurchasesDiscoveredList:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)fetchChannelIDsForPurchaseIDs:(id)arg1 callbackQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
- (id)fetchOperationForPurchaseLookupWithPurchaseIDs:(id)arg1;
- (void)addAppStoreDiscoveredChannelsToFavorites:(id)arg1;
- (void)_entitlementCheckWithIgnoreCache:(BOOL)arg1 restorableBundleIAPs:(id)arg2 callbackQueue:(id)arg3 completion:(id /* CDUnknownBlockType */)arg4 serialCompletion:(id /* CDUnknownBlockType */)arg5;
- (void)performEntitlementCheckWithIgnoreCache:(BOOL)arg1 callbackQueue:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)shouldShowiTunesSignedOutAlertWithiTunesAccountName:(id)arg1 iTunesAccountDSID:(id)arg2 isUserSignedIntoiTunes:(BOOL)arg3 isBundleSubscriber:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)shouldShowSignedInWithDifferentiTunesAccountAlertWithiTunesAccountName:(id)arg1 iTunesAccountDSID:(id)arg2 isUserSignedIntoiTunes:(BOOL)arg3 isBundleSubscriber:(BOOL)arg4 completion:(id /* CDUnknownBlockType */)arg5;
