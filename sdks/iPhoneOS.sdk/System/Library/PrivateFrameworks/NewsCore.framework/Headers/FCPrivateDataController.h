...
- (void)_serialSyncWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)saveWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)performFirstSyncWithCallbackQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)forceSyncWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)syncWithCallbackQueue:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)syncWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (void)_syncWithCondition:(id /* CDUnknownBlockType */)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)dealloc;
