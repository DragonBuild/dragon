...
+ (id /* CDUnknownBlockType */)_privateDatabaseDeprecatedRecordTestBlock;
...
- (id)_mapObjects:(id)arg1 withRecordMiddlewareBlock:(id /* CDUnknownBlockType */)arg2;
...
- (void)t_performStartUpWithCompletion:(id /* CDUnknownBlockType */)arg1;
...
- (void)enumerateActiveDestinationsWithOptions:(long long)arg1 handler:(id /* CDUnknownBlockType */)arg2;
- (void)enumeratePayloadsWithRecordIDs:(id)arg1 records:(id)arg2 zoneIDs:(id)arg3 zones:(id)arg4 options:(long long)arg5 payloadHandler:(id /* CDUnknownBlockType */)arg6;
...
- (void)fetchSecureDatabaseSupportedWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)fetchChangesForRecordZoneID:(id)arg1 changeToken:(id)arg2 desiredKeys:(id)arg3 fetchAllChanges:(BOOL)arg4 qualityOfService:(long long)arg5 completionHandler:(id /* CDUnknownBlockType */)arg6;
- (void)fetchAllDatabaseChangesWithServerChangeToken:(id)arg1 qualityOfService:(long long)arg2 completionQueue:(id)arg3 completionHandler:(id /* CDUnknownBlockType */)arg4;
