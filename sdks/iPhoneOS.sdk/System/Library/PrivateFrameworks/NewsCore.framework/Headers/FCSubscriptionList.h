...
- (void)_assignOrderToTagSubscriptions:(id)arg1 withCompletion:(id /* CDUnknownBlockType */)arg2;
...
- (void)removeSubscriptionsForTagIDs:(id)arg1 typeProvider:(id /* CDUnknownBlockType */)arg2 eventInitiationLevel:(long long)arg3 completion:(id /* CDUnknownBlockType */)arg4;
...
- (void)addSubscriptionsForTagIDs:(id)arg1 typeProvider:(id /* CDUnknownBlockType */)arg2 originProvider:(id /* CDUnknownBlockType */)arg3 eventInitiationLevelProvider:(id /* CDUnknownBlockType */)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
- (void)addSubscriptionsForTagIDs:(id)arg1 typeProvider:(id /* CDUnknownBlockType */)arg2 originProvider:(id /* CDUnknownBlockType */)arg3 groupID:(id)arg4 notificationsEnabled:(BOOL)arg5 eventInitiationLevelProvider:(id /* CDUnknownBlockType */)arg6 completion:(id /* CDUnknownBlockType */)arg7;
