...
- (void)_walkRecordChainStartingWithRecordIDs:(id)arg1 visitedRecordIDs:(id)arg2 recordsLookupBlock:(id /* CDUnknownBlockType */)arg3 visitorBlock:(id /* CDUnknownBlockType */)arg4;
