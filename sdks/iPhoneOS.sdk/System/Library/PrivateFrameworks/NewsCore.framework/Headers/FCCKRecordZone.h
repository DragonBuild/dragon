...
// - (void).cxx_destruct;
- (id)description;
- (void)fetchChangesWithChangeToken:(id)arg1 desiredKeys:(id)arg2 fetchAllChanges:(BOOL)arg3 qualityOfService:(long long)arg4 completion:(id /* CDUnknownBlockType */)arg5;
- (void)performActionWithRecordZone:(id /* CDUnknownBlockType */)arg1;
