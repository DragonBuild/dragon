...
- (id)fetchRecordsWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)fetchConfigWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)determineAppropriateFetchStepsWithCompletion:(id /* CDUnknownBlockType */)arg1;
