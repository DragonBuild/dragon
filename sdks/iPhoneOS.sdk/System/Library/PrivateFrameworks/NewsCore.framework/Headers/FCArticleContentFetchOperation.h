...
- (id)fetchFlintResourcesWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)fetchFlintDocumentWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)fetchWebArchiveWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)fetchWebExcerptWithCompletion:(id /* CDUnknownBlockType */)arg1;
- (id)fetchContentManifestWithCompletion:(id /* CDUnknownBlockType */)arg1;
