...
// - (void).cxx_destruct;
- (void)calculateScoreWithTopicScoreProvider:(id /* CDUnknownBlockType */)arg1;
- (void)calculateNonLeafScoresWithTopicProvider:(id /* CDUnknownBlockType */)arg1;
- (id)calculateLeafScoresWithTopicScoreProvider:(id /* CDUnknownBlockType */)arg1;
- (double)individualScoreWithTopicScoreProvider:(id /* CDUnknownBlockType */)arg1;
@property(nonatomic) double score;
- (id)leaves;
- (id)description;
- (void)considerEdge:(id)arg1 withNodeScorer:(id /* CDUnknownBlockType */)arg2;
