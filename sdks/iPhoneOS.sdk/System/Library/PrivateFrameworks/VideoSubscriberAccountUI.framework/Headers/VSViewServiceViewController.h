...
- (void)_determinePreAuthAppIsAuthorized:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
- (void)_presentWelcomeMessageForIdentityProvider:(id)arg1 withLogoCacheURL:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
