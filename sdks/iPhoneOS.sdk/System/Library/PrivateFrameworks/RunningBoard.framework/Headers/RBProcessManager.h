...
- (void)_executeLifecycleEventForIdentity:(id)arg1 sync:(BOOL)arg2 withBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)didUpdateProcessStates:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
