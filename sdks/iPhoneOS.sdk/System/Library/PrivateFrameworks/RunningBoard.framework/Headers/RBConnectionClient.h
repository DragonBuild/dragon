...
- (void)inheritanceManager:(id)arg1 didChangeInheritances:(id)arg2 completion:(id /* CDUnknownBlockType */)arg3;
...
- (void)requestPluginHoldForIdentity:(id)arg1 terminate:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
